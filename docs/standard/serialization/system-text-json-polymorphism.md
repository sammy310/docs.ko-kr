...
* [<span data-ttu-id="9a411-140">순환 참조 보존</span><span class="sxs-lookup"><span data-stu-id="9a411-140">Preserve circular references</span></span>](system-text-json-preserve-references.md)
