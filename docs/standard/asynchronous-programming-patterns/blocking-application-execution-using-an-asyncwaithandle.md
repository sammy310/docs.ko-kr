...
- 비동기 작업의 <xref:System.IAsyncResult.AsyncWaitHandle%2A>Begin<xref:System.IAsyncResult>**OperationName** 메서드에 의해 반환된 _의_  속성을 사용합니다. 이 항목에서 이 방법을 설명합니다.  
