...
전체 코드 예제를 보려면 [MetadataLoadContext를 사용하여 어셈블리 콘텐츠 검사](https://docs.microsoft.com/samples/dotnet/samples/inspect-assembly-contents-using-metadataloadcontext/)를 참조하세요.
