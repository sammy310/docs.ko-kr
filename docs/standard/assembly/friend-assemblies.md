...
*friend 어셈블리*는 다른 어셈블리의 [내부](../../csharp/language-reference/keywords/internal.md)(C#로 작성됨 또는 Visual Basic으로 작성된 [Friend](../../visual-basic/language-reference/modifiers/friend.md)) 유형 및 멤버에 액세스할 수 있는 어셈블리입니다. 어셈블리를 friend 어셈블리로 식별하는 경우 다른 어셈블리에서 액세스할 수 있도록 하기 위해 더 이상 형식 및 멤버를 public으로 표시할 필요가 없습니다. 다음과 같은 시나리오에서 특히 편리합니다.
...
friend로 명시적으로 지정하는 어셈블리만 `internal`(C#으로 작성됨 또는Visual Basic으로 작성된 `Friend`) 형식 및 멤버에 액세스할 수 있습니다. 예를 들어 어셈블리 B가 어셈블리 A 및 어셈블리 C 참조 어셈블리 B의 friend인 경우 C는 A의 `internal`(C#으로 작성됨 또는 Visual Basic으로 작성된 `Friend`) 형식에 액세스할 수 없습니다.
...
- 어셈블리 *A*에 강력한 이름을 지정하지 않은 경우 friend 어셈블리 이름은 어셈블리 이름만으로 구성되어야 합니다. 자세한 내용은 [방법: 서명되지 않은 Friend 어셈블리(C#)](../../csharp/programming-guide/concepts/assemblies-gac/how-to-create-unsigned-friend-assemblies.md) 만들기 또는 [방법: 서명되지 않은 Friend 어셈블리(Visual Basic) 만들기](../../visual-basic/programming-guide/concepts/assemblies-gac/how-to-create-unsigned-friend-assemblies.md).

- 어셈블리 *B*에 강력한 이름을 지정하는 경우 프로젝트 설정이나 명령줄 `/keyfile` 컴파일러 옵션을 사용하여 어셈블리 *B*에 강력한 이름 키를 지정해야 합니다. 자세한 내용은 [방법: 서명된 Friend 어셈블리(C#)](../../csharp/programming-guide/concepts/assemblies-gac/how-to-create-signed-friend-assemblies.md) 만들기 또는 [방법: 서명된 Friend 어셈블리(Visual Basic) 만들기](../../visual-basic/programming-guide/concepts/assemblies-gac/how-to-create-signed-friend-assemblies.md).
...
- <xref:System.Security.Permissions.StrongNameIdentityPermission>을 사용하는 경우 공유하려는 형식을 public으로 선언해야 합니다. friend 어셈블리를 사용하는 경우 공유 유형은 `internal`(C#으로 작성 또는 Visual Basic으로 작성된 `Friend`)로 선언됩니다.

모듈 파일(확장자가 .netmodule인 파일)에서 어셈블리의 `internal`(C#으로 작성됨 또는 Visual Basic으로 작성된 `Friend`) 형식 및 메서드에 액세스하는 방법에 관한 내용은 [/moduleassemblyname(C#)](../../csharp/language-reference/compiler-options/moduleassemblyname-compiler-option.md) 또는 [/moduleassemblyname(Visual Basic)](../../visual-basic/reference/command-line-compiler/moduleassemblyname.md)을 참조하세요.
...
- [방법: 서명되지 않은 Friend 어셈블리(Visual Basic) 만들기](../../visual-basic/programming-guide/concepts/assemblies-gac/how-to-create-unsigned-friend-assemblies.md)
- [방법: 서명된 Friend 어셈블리 만들기(C#)](../../csharp/programming-guide/concepts/assemblies-gac/how-to-create-signed-friend-assemblies.md)
- [방법: 서명된 Friend 어셈블리(Visual Basic) 만들기](../../visual-basic/programming-guide/concepts/assemblies-gac/how-to-create-signed-friend-assemblies.md)
- [.NET 어셈블리](index.md)
