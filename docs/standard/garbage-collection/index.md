...
|제목|설명|  
|-----------|-----------------|  
|[가비지 컬렉션 기본 사항](../../../docs/standard/garbage-collection/fundamentals.md)|가비지 수집이 작동하는 방법, 관리되는 힙에 개체를 할당하는 방법 및 기타 핵심 개념에 대해 설명합니다.|  
...
|[도출된 컬렉션](../../../docs/standard/garbage-collection/induced.md)|가비지 수집을 발생시키는 방법에 대해 설명합니다.|  
