...
**✓ DO** 적용 된 <xref:System.FlagsAttribute?displayProperty=nameWithType> 플래그 열거형에 있습니다. 단순 열거형에는이 특성을 적용 하지 마십시오.
...
**✓ DO** 0 플래그 열거형의 값 이름을 `None`합니다. 플래그 열거형의 경우 값은 항상 "모든 플래그가 지워졌습니다."을 의미 해야 합니다.
