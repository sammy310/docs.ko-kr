 ...
 **✓ CONSIDER** 성능에 미치는 영향 예외를 throw 합니다. 초당 100를 초과 하는 Throw 요금은 대부분의 응용 프로그램 성능에 큰 영향을 미칠 수 있습니다.  
 ...
 **X AVOID** 명시적으로 finally 블록에서 예외를 throw 합니다. Throw 되는 메서드를 호출 하 여 발생 하는 예외를 암시적으로 throw 합니다.  
