...
### <a name="example-1-replace-substrings"></a>예제 1: 하위 문자열 바꾸기  
...
### <a name="example-2-identify-duplicated-words"></a>예제 2: 중복된 단어 식별  
...
|[Visual Studio에서 정규식 사용](/visualstudio/ide/using-regular-expressions-in-visual-studio)||
