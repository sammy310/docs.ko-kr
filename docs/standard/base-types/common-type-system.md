---
title: 공용 형식 시스템
description: .NET의 형식 시스템에 대해 알아봅니다.
ms.date: 03/30/2017
...
### <a name="inherit-override-and-hide-members"></a>멤버 상속, 재정의 및 숨기기  
