...
## <a name="day-d-format-specifier"></a>일 “d” 형식 지정자
...
### <a name="the-k-custom-format-specifier"></a><a name="KSpecifier"></a> “K” 사용자 지정 형식 지정자
...
### <a name="the-t-custom-format-specifier"></a><a name="tSpecifier"></a> “t” 사용자 지정 형식 지정자
