...
- <xref:System.IO.WindowsRuntimeStreamExtensions.AsStreamForWrite%2A?displayProperty=nameWithType>은 Windows 런타임의 출력 스트림을 UWP용 .NET 앱의 관리형 스트림으로 변환합니다.
