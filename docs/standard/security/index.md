...
ms.locfileid: "61860557"
---
# <a name="security-in-net"></a>.NET의 보안
공용 언어 런타임 및.NET에는 많은 유용한 클래스 및 서비스 개발자가 쉽게 안전한 코드를 작성 하 고 시스템 관리자가 액세스할 수 있도록 코드에 부여 된 사용 권한 사용자 지정 하는 보호 된 리소스를 제공 합니다. 또한 런타임 및.NET 유용한 클래스 및 암호화 및 역할 기반 보안을 사용할 수 있는 서비스를 제공 합니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 신뢰할 수 있는.NET 응용 프로그램을 만드는 모범 사례를 설명 합니다. 이 섹션은 개발자에게 유용합니다.  
 ...
 애플리케이션에서 클레임 기반 ID를 구현하는 방법을 설명합니다.  
