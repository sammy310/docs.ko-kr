...
**추가 정보** 엔터프라이즈 애플리케이션 및 마이크로서비스 아키텍처에 대한 자세한 내용을 알아보려면 <https://aka.ms/MicroservicesEbook>에서 다운로드할 수도 있는 [NET 마이크로서비스: 컨테이너화된 .NET 애플리케이션을 위한 아키텍처](../../microservices-architecture/index.md)를 참조하세요.
