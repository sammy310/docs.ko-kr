...
> **표 1-1입니다.** 기존 .NET 애플리케이션 및 서비스의 현대화 경로 이점 및 당면 과제
...
> **그림 1-2입니다.** 기존 .NET 웹 애플리케이션 현대화의 각 완성도에 해당하는 주요 기술
...
> **그림 1-3입니다.** 각 현대화 완성도에 해당하는 내부 기술
...
> **그림 1-5입니다.** IaaS, DevOps 및 컨테이너화 자산에 데이터베이스가 있는 "고르고 선택" 시나리오 예
...
> **그림 1 ~ 6입니다.** Windows 컨테이너 및 관리 되는 서비스를 사용 하 여 예제 클라우드 최적화 앱 시나리오
...
> **그림 1-7입니다.** 클라우드 네이티브가이 가이드에서는 다루지 않습니다.
