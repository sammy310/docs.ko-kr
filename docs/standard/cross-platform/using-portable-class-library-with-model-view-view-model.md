...
## <a name="classes-that-support-mvvm"></a>MVVM를 지 원하는 클래스
 이식 가능한 클래스 라이브러리 프로젝트에 대 한 .NET Framework 4.5, [!INCLUDE[net_win8_profile](../../../includes/net-win8-profile-md.md)], Silverlight 또는 Windows Phone 7.5를 대상으로 하는 경우 MVVM 패턴을 구현 하는 데 다음 클래스를 사용할 수 있습니다.
