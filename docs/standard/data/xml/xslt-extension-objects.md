...
> [!NOTE]
> <xref:System.Xml.Xsl.XsltArgumentList.AddExtensionObject%2A> 메서드를 호출하려면 FullTrust 권한 집합이 필요합니다. 자세한 내용은 [코드 액세스 보안](../../../framework/misc/code-access-security.md) 및 [명명된 권한 세트](/previous-versions/dotnet/netframework-4.0/4652tyx7(v=vs.100))를 참조하세요.  
