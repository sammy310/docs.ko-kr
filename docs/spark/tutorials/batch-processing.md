...
1. <span data-ttu-id="d6b8b-158">`spark.Stop()`을 호출하여 SparkSession을 종료합니다.</span><span class="sxs-lookup"><span data-stu-id="d6b8b-158">Call `spark.Stop()` to end the SparkSession.</span></span>
