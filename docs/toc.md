...
### [메모리<T> 및 범위<T> 사용 지침](standard/memory-and-spans/memory-t-usage-guidelines.md)
## [기본 상호 운용성](standard/native-interop/index.md)
### [P/Invoke](standard/native-interop/pinvoke.md)
### [형식 마샬링](standard/native-interop/type-marshalling.md)
### [구조 마샬링 사용자 지정](standard/native-interop/customize-struct-marshalling.md)
### [매개 변수 마샬링 사용자 지정](standard/native-interop/customize-parameter-marshalling.md)
### [Interop 지침](standard/native-interop/best-practices.md)
### [문자 세트 및 마샬링](standard/native-interop/charset.md)
...
### [애플리케이션 도메인 및 어셈블리](framework/app-domains/)
...
### [Windows 서비스 애플리케이션](framework/windows-services/)
### [64비트 애플리케이션](framework/64-bit-apps.md)
### [ASP.NET을 사용하여 개발한 웹 애플리케이션](framework/develop-web-apps-with-aspnet.md)
...
### [패턴 일치를 사용하여 데이터 기능 확장](csharp/tutorials/pattern-matching.md)
...
### [특성 사용](csharp/tutorials/attributes.md)
...
### [nullable 참조 형식](csharp/nullable-references.md)
...
## [애플리케이션 개발](visual-basic/developing-apps/index.md)
...
#### [튜플](visual-basic/programming-guide/language-features/data-types/tuples.md)
...
#### [요청한 작업을 수행할 수 없습니다(BC35000)](visual-basic/language-reference/error-messages/bc35000.md).
...
## [샘플 애플리케이션](visual-basic/sample-applications.md)
...
## 개요
### [ML.NET이란?](machine-learning/what-is-mldotnet.md)
### [모델 학습 개념](machine-learning/basic-concepts-model-training-in-mldotnet.md)
...
### [동영상 권장 사항(권장 사항)](machine-learning/tutorials/movie-recommmendation.md)
## [방법 가이드](machine-learning/how-to-guides/index.md)
### 데이터 준비
#### [범주 기능 엔지니어링 적용](machine-learning/how-to-guides/train-model-categorical-ml-net.md)
#### [텍스트 기능 엔지니어링 적용](machine-learning/how-to-guides/train-model-textual-ml-net.md)
#### [많은 열을 포함하는 데이터 로드](machine-learning/how-to-guides/load-data-from-mult-column-csv-ml-net.md)
#### [여러 파일에서 데이터 로드](machine-learning/how-to-guides/load-data-from-multiple-files-ml-net.md)
...
## 참조
### [API 참조](https://docs.microsoft.com/dotnet/api/?view=ml-dotnet)
