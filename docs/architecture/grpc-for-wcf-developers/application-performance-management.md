...
요청, 예외 등을 둘러싼 많은 로그 메시지는 ASP.NET Core 및 gRPC 프레임 워크 구성 요소에서 제공 됩니다. 사용자 고유의 로그 메시지를 추가 하 여 하위 수준의 문제 보다는 응용 프로그램 논리에 대 한 세부 정보 및 컨텍스트를 제공 합니다.
