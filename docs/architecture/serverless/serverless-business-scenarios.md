...
[빅 데이터 처리: Azure에서 서버리스 MapReduce](https://docs.microsoft.com/samples/azure-samples/durablefunctions-mapreduce-dotnet/big-data-processing-serverless-mapreduce-on-azure/)
...
[서버리스 애플리케이션 만들기](https://docs.microsoft.com/learn/paths/create-serverless-applications/)
...
[Cognitive Services로 고객 리뷰 앱](https://docs.microsoft.com/samples/azure-samples/functions-customer-reviews/customer-reviews-cognitive-services/)
...
[Linux에서 Azure Functions](https://docs.microsoft.com/samples/azure-samples/functions-linux-custom-image/azure-functions-on-linux-custom-image-tutorial-sample-project/)
...
[Azure Functions, Logic Apps 및 Durable Functions를 사용하여 파일 처리 및 유효성 검사](https://docs.microsoft.com/samples/azure-samples/serverless-file-validation/file-processing-and-validation-using-azure-functions-logic-apps-and-durable-functions/)
...
[편집기 내 게임 원격 분석 시각화](https://docs.microsoft.com/samples/azure-samples/gaming-in-editor-telemetry/in-editor-telemetry-visualization/)
...
[IoT 안정적인 에지 릴레이](https://docs.microsoft.com/samples/azure-samples/iot-reliable-edge-relay/iot-reliable-edge-relay/)
...
[서버리스 마이크로서비스 참조 아키텍처](https://docs.microsoft.com/samples/azure-samples/serverless-microservices-reference-architecture/serverless-microservices-reference-architecture/)
...
[Azure Functions에서 콘솔 앱 실행](https://docs.microsoft.com/samples/azure-samples/functions-dotnet-migrating-console-apps/run-console-apps-on-azure-functions/)
...
[Azure Functions를 사용하여 Service Bus, Event Hubs 및 Storage 큐를 통해 메시지 생성 및 사용](https://docs.microsoft.com/samples/azure-samples/durable-functions-producer-consumer/product-consume-messages-az-functions/)
