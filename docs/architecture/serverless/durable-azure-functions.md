...
- [지속성 함수](https://docs.microsoft.com/azure/azure-functions/durable-functions-overview)
- [Durable Functions의 바인딩](https://docs.microsoft.com/azure/azure-functions/durable-functions-bindings)
