...
Microsoft 도구입니다. 개발/설계 작업의 경우: Windows, Visual Studio 및 Visual Studio Code, .NET Core, Azure Kubernetes 서비스용 Docker 엔진입니다. 빌드/테스트/배송 작업의 경우: Azure DevOps, Team Foundation Server, Docker CLI, Azure Kubernetes Service. 실행/모니터링/관리 작업의 경우: Azure Monitor, Azure Portal Azure Kubernetes Services, Service Fabric, 기타 오케스트레이터.
:::image-end:::
