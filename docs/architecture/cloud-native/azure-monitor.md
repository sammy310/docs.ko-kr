...
[Kusto 쿼리를 시험해](https://dataexplorer.azure.com/clusters/help/databases/Samples) 볼 수 있는 방법이 있습니다. [예제 쿼리](https://docs.microsoft.com/azure/kusto/query/samples) 읽기가 유용할 수도 있습니다.
