...
| -- |------------------------|--------------------------|-----------------------------|-------------------------|
| 창 | [Get started with Visual Studio](get-started-visual-studio.md) | [Visual Studio Code 시작하기](get-started-vscode.md) | [Get started with the .NET Core CLI](get-started-command-line.md) |
| macOS | [Get started with VS for Mac](get-started-with-visual-studio-for-mac.md) | [Visual Studio Code 시작하기](get-started-vscode.md) | [Get started with the .NET Core CLI](get-started-command-line.md) |
| Linux | 해당 사항 없음 | [Visual Studio Code 시작하기](get-started-vscode.md) | [Get started with the .NET Core CLI](get-started-command-line.md) |
