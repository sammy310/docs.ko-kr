...
부동 소수점 및 부호 있는 정수 값 F# , 측정 단위 길이, 볼륨, 질량 등 나타내며 일반적으로 사용 되는 연결 될 수 있습니다. 한지 확인 하려면 산술 관계 올바른 단위를 방지할 수 있는 컴파일러를 사용 하면 수량 단위를 사용 하 여 오류를 프로그래밍 합니다.
...
## <a name="units-of-measure-in-the-f-core-library"></a>측정 단위는 F# 핵심 라이브러리
