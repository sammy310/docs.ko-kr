...
>[!WARNING]
>.NET Framework 네임 스페이스 `System.ComponentModel` 동일한 이름을 가진 특성을 포함 합니다. 이 특성에 대한 자세한 내용은 `System.ComponentModel.DefaultValueAttribute`를 참조하세요.
