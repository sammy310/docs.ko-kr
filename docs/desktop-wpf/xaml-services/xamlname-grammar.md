...
XAML은 속성 및 이벤트 정규화 된 참조와 연결 된 멤버에 사용 되는 두 번째 문법 인 DottedXamlName를 정의 합니다. 자세한 내용은 <xref:System.Windows.DependencyProperty> 및 [XAML 개요 (WPF)](../fundamentals/xaml.md)를 참조 하세요.
...
전체 사양은 [ \[ MS-XAML \] ](/previous-versions/msp-n-p/ff650760(v=pandp.10))을 참조 하세요.
