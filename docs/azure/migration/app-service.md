...
IIS5 호환 모드는 지원되지 않습니다. Azure App Service에서 각 웹앱과 그 아래의 모든 애플리케이션은 특정 [애플리케이션 풀](https://technet.microsoft.com/library/cc735247(v=WS.10).aspx) 세트로 동일한 작업자 프로세스에서 실행됩니다.
