...
Visual Studio 2019 버전 16.3에서는 이러한 워크로드 중 하나가 설치된 후 기본적으로 .NET Core 3.0 SDK를 사용합니다.
...
예를 들어 Visual Studio 2017 버전 15.9에서는 워크로드가 설치된 후 기본적으로 .NET Core 2.1 SDK를 사용합니다.
