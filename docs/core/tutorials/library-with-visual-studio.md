...
---
# <a name="build-a-net-standard-library-with-c-and-the-net-core-sdk-in-visual-studio-2017"></a>Visual Studio 2017에서 C# 및 .NET Core SDK를 사용하여 .NET Standard 라이브러리 빌드
