...
이 자습서에서는 .NET Core 애플리케이션을 포함하는 Docker 이미지를 빌드하는 방법에 대해 설명합니다. 이미지를 사용하여 로컬 개발 환경이나 사설 클라우드 또는 공용 클라우드용 컨테이너를 생성할 수 있습니다.

이 자습서에서는 다음과 같은 작업을 수행하는 방법을 알아봅니다.

> [!div class="checklist"]
> * Dockerfile 만들기
> * Microsoft .NET Core Docker 기본 이미지 풀하기
> * 앱 사용자 지정 및 이미지에 배포
> * 컨테이너 만들기 및 실행
> * Azure에 배포
