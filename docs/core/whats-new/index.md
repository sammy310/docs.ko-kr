---
title: .NET Core의 새로운 기능
description: 각 .NET Core 버전의 새로운 기능에 대해 알아봅니다.
author: rpetrusha
ms.author: ronpet
ms.date: 02/04/2019
ms.custom: seodec18
...
ms.locfileid: "61646776"
---
# <a name="whats-new-in-net-core"></a>.NET Core의 새로운 기능

이 페이지는 .NET Core 2.0부터 .NET Core의 각 릴리스에 있는 새로운 기능에 대한 요약을 제공합니다. 다음 링크는 각 릴리스에 추가된 주요 기능에 대한 자세한 정보를 제공합니다.

- [.NET Core 3.0(미리 보기 2)](dotnet-core-3-0.md)
