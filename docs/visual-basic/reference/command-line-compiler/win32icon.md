...
## <a name="remarks"></a>설명  
 ...
 .NET Framework 리소스 파일 또는 [-resource (Visual Basic)](../../../visual-basic/reference/command-line-compiler/resource.md)를 참조하여 .NET Framework 리소스 파일을 연결하려면 [-linkresource(Visual Basic)](../../../visual-basic/reference/command-line-compiler/linkresource.md)를 참조하세요. .res 파일을 가져오려면 [-win32resource](../../../visual-basic/reference/command-line-compiler/win32resource.md)를 참조하세요.  
