...
Visual Basic 명령줄 컴파일러는 Visual Studio 통합된 개발 환경 (IDE) 내에서 프로그램을 컴파일하는 대신을 제공 합니다. 이 섹션에서는 Visual Basic 컴파일러 옵션에 대해 설명 합니다.
...
Visual Studio IDE 내에서 프로그램을 컴파일하는 대신 제공 되는 Visual Basic 명령줄 컴파일러를 설명 합니다.
