...
## <a name="arguments"></a>인수  
 `version`  
 필수 요소. The language version to be used during the compilation. Accepted values are `9`, `10`, `11`, `12`, `14`, `15`, `15.3`, `15.5`, `default` and `latest`.
...
## <a name="remarks"></a>주의  
 ...
 You can set `-langversion` directly only by using the command line. 자세한 내용은 [특정 대상 .NET Framework 버전 지정](/visualstudio/ide/visual-studio-multi-targeting-overview)을 참조하세요.  
