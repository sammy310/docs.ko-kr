...
---
# <a name="type-of-variablename-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>루프 경계와 단계 변수가 동일한 유형으로 확장되지 않기 때문에 '변수\<이름>'의 유형이 모호합니다.
