...
---
# <a name="type-of-variablename-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>루프 범위와 단계 변수가 동일한 형식으로 확장 되지 않으므로 ' \<variablename > '의 형식이 모호 합니다.
