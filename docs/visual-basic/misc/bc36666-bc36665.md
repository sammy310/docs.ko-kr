...
---
# <a name="methodname-is-not-accessible-in-this-context-because-the-return-type-is-not-accessible"></a>반환 형식에 액세스할 수 없으므로 ' \<methodname > '은 (는)이 컨텍스트에서 액세스할 수 없습니다.
