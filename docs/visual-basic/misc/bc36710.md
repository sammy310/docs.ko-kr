...
---
# <a name="extension-method-methodname-defined-in-modulename-does-not-have-a-signature-compatible-with-delegate-delegatename"></a>확장 메서드 '\<methodname >'에 정의 된 '\<modulename >' 대리자와 호환 되는 서명 되지 않은 '\<delegatename >'
