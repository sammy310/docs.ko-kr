...
---
# <a name="elementname-refers-to-type-typename-in-project-projectname-but-type-typename-was-not-found-in-project-projectname"></a>'\<elementname >' 형식을 참조 '\<typename >' 프로젝트의 '\<projectname >'에 형식이 '\<typename >' 프로젝트에서 찾을 수 없습니다 '\<projectname >'
