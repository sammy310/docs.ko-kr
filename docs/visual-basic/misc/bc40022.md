...
ms.locfileid: "61794214"
---
# <a name="member-membername1-implicitly-declares-implicitmembername-which-conflicts-with-a-member-in-the-base-class-baseclassname"></a>멤버 '\<membername1 >'를 암시적으로 선언 '\<implicitmembername > ', 기본 클래스의 멤버와 충돌 하 는'\<baseclassname >'
멤버 '\<membername1 >'를 암시적으로 선언 '\<implicitmembername > ', 기본 클래스의 멤버와 충돌 하 는'\<baseclassname >', 이므로 멤버를 선언할 수 없습니다 '오버 로드'  
