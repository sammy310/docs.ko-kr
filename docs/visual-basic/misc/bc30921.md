...
---
# <a name="derivedtypename-cannot-inherit-from-type-constructedbasetypename-because-it-expands-the-access-of-type-internaltypename-to-region-regionname"></a>'\<derivedtypename > '은 (는) '\<internaltypename > ' 형식에 대 한 액세스를\<지역 > ' \<영역 이름 > '으로 확장 하므로 \<형식 > '\<constructedbasetypename > '에서 상속할 수 없습니다.
