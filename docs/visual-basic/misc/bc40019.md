...
---
# <a name="keyword-accessor-of-propertyname-is-obsolete-errormessage-visual-basic-warning"></a>'\<키워드 >' 접근자는 '\<propertyname >'는 사용 되지 않습니다. '\<errormessage >' (Visual Basic 경고)
