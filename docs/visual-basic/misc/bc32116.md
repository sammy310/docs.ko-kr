...
---
# <a name="type-argument-inference-failed-for-type-parameter-typeparametername1-of-genericproceduresignature"></a>' @No__t-1genericproceduresignature > '의 형식 매개 변수 ' \<typeparametername1 > ' 형식 매개 변수에 대 한 형식 인수를 유추 하지 못했습니다.
' @No__t-1genericproceduresignature > '의 형식 매개 변수 ' \<typeparametername1 > ' 형식 매개 변수에 대 한 형식 인수를 유추 하지 못했습니다. ' @No__t-0parametername1 > ' 매개 변수에 전달 된 인수에서 유추 된 형식 인수가 ' \<parametername2 > ' 매개 변수에 전달 된 인수에서 유추 된 형식 인수와 충돌 합니다.  
