...
---
# <a name="type-argument-inference-failed-for-type-parameter-typeparametername1-of-genericproceduresignature"></a>' '의 형식 매개 변수 ' '에 대 한 형식 인수를 유추 하지 못했습니다. \<typeparametername1> \<genericproceduresignature>

' '의 형식 매개 변수 ' '에 대 한 형식 인수를 유추 하지 못했습니다 \<typeparametername1> \<genericproceduresignature> . 매개 변수 ' '에 전달 된 인수에서 유추 된 형식 인수가 \<parametername1> ' ' 매개 변수에 전달 된 인수에서 유추 된 형식 인수와 충돌 합니다 \<parametername2> .  
