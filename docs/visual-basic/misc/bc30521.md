...
---
# <a name="overload-resolution-failed-because-no-accessible-method-is-most-specific-for-these-argumentserror"></a>오버 로드 확인에 실패 했습니다 액세스 가능한 '\<메서드 >'이 인수에만 한정 되:\<오류 >
...
- [프로시저 오버로드에서 고려해야 할 사항](../../visual-basic/programming-guide/language-features/procedures/considerations-in-overloading-procedures.md)
