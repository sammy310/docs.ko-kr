...
---
# <a name="return-and-parameter-types-of-logicaloperator-must-be-typename-to-be-used-in-a-shortcircuitoperator-expression"></a>반환 및 매개 변수 형식은 '\<logicaloperator >' 이어야 합니다 '\<typename >'에서 사용할 수는 '\<shortcircuitoperator >' 식
