...
- [방법: Visual Basic에서 디렉터리 이동](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/ct88d1f1(v=vs.100))
- [방법: 파일 이름 바꾸기](../../visual-basic/developing-apps/programming/drives-directories-files/how-to-rename-a-file.md)
- [방법: Visual Basic에서 디렉터리 이름 바꾸기](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/45we914z(v=vs.100))
