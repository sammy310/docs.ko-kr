...
---
# <a name="data-types-of-the-type-parameters-in-extension-method-methodname-defined-in-typename-cannot-be-inferred-from-these-arguments-because-more-than-one-type-is-possible"></a>확장 메서드에서 형식 매개 변수의 데이터 형식을 '\<methodname >'에 정의 된 '\<typename >' 둘 이상의 형식이 가능 하므로이 인수에서 유추할 수 없습니다.
