...
---
# <a name="baseinterfacenamemembername-from-implements-derivedinterfacename-is-already-implemented-by-the-base-class-baseclassname-re-implementation-of-type-assumed"></a>'\<baseinterfacename > 합니다. membername > ' from ' implements \<derivedinterfacename > '은 (는) 기본 클래스 '\<a m e > '에 의해 이미 구현 되었습니다. \< 형식 > 다시 구현 \<하는 것으로 가정 합니다.
