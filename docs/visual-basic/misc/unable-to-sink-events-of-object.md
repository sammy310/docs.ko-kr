---
description: '에 대 한 자세한 정보: 개체에서 지 원하는 최대 이벤트 수신기 수로 이벤트를 이미 발생 시키고 있으므로 개체의 이벤트를 싱크할 수 없습니다.'
...
- [방법: COM 싱크에서 처리하는 이벤트 발생](/previous-versions/dotnet/netframework-4.0/dd8bf0x3(v=vs.100))
- [연습: 이벤트 처리](../programming-guide/language-features/events/walkthrough-handling-events.md)
