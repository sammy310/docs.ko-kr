...
---
# <a name="type-argument-typeargumentname-does-not-satisfy-the-structure-constraint-for-type-parameter-typeparametername"></a>형식 인수 ' \<typeargumentname> '이 (가) 형식 매개 변수 ' '에 대 한 ' Structure ' 제약 조건을 만족 하지 않습니다. \<typeparametername>
