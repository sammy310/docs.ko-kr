---
description: '자세히 알아보기: <number> 현재 구분 기호를 사용 하 여 줄을 구문 분석할 수 없습니다.'
title: 현재 구분 기호를 사용하여 줄 <number>의 구문을 분석할 수 없습니다.
ms.date: 07/20/2015
f1_keywords:
...
ms.locfileid: "100430185"
---
# <a name="line-number-cannot-be-parsed-using-the-current-delimiters"></a>현재 구분 기호를 사용하여 줄 \<number>의 구문을 분석할 수 없습니다.
