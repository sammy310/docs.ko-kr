...
---
# <a name="derivedtypename-cannot-inherit-from-type-constructedbasetypename-because-it-expands-the-access-of-type-internaltypename-outside-the-assembly"></a>'\<derivedtypename >'에서 상속할 수 없습니다 \<유형 > '\<constructedbasetypename >' 형식에 대 한 액세스를 확장 하기 때문에 '\<internaltypename >' 어셈블리 외부에서
