...
## <a name="remarks"></a>주의  
 ...
 특성이 다음 요소 뿐만 아니라 전체 어셈블리에만 관련 되는 경우 특성 블록을 소스 파일의 시작 부분에 놓고 `Assembly` 키워드를 사용 하 여 특성을 식별 합니다. 현재 어셈블리 모듈에 적용 되는 경우 [module](../../../visual-basic/language-reference/modifiers/module-keyword.md) 키워드를 사용 합니다.  
