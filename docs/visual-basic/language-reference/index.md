...
## <a name="in-this-section"></a>섹션 내용  
 ...
 키워드, 자리 표시자 및 언어의 다른 요소는 Visual Basic 설명서에서 형식이 지정 되는 방법은 요약 되어 있습니다.  
 ...
 Visual Basic에서 사용할 수 있는 특성을 설명합니다.  
  
 [상수 및 열거형](../../visual-basic/language-reference/constants-and-enumerations.md)  
 상수 및 Visual Basic에서 사용할 수 있는 열거형을 설명합니다.  
  
 [데이터 형식](../../visual-basic/language-reference/data-types/index.md)  
 Visual Basic에서 사용할 수 있는 데이터 형식에 설명 합니다.  
 ...
 Visual Basic에서 사용 가능한 런타임 함수를 설명합니다.  
 ...
 IntelliSense는 Visual Basic 코드 편집기에서 제공 되는 문서 주석을 설명 합니다.  
 ...
 처리 하는 방법에 Visual Basic 컴파일러 및 런타임 오류 메시지 및 도움말의 목록을 제공 합니다.  
...
## <a name="related-sections"></a>관련 단원  
 ...
 Visual Studio 통합된 개발 환경 (IDE) 내에서 프로그램을 컴파일하는 대신 명령줄 컴파일러를 사용 하는 방법에 설명 합니다.
