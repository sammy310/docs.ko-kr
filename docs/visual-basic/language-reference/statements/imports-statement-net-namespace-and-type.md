...
|용어|정의|
|---|---|
|`aliasname`|선택 사항입니다. 코드에서 전체 한정 문자열 대신 `namespace` 참조할 수 있는 *가져오기 별칭* 또는 이름입니다. [Declared Element Names](../../programming-guide/language-features/declared-elements/declared-element-names.md)을 참조하세요.|
