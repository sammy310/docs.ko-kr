...
- `Shared`
  ...
  선택 사항입니다. [공유](../../../visual-basic/language-reference/modifiers/shared.md)를 참조 하세요.

- `Shadows`

  선택 사항입니다. [그림자](../../../visual-basic/language-reference/modifiers/shadows.md)를 참조 하세요.

- `Static`

  선택 사항입니다. [Static](../../../visual-basic/language-reference/modifiers/static.md)을 참조 하세요.

- `ReadOnly`

  선택 사항입니다. [ReadOnly](../../../visual-basic/language-reference/modifiers/readonly.md)를 참조 하세요.

- `WithEvents`

선택 사항입니다. 이러한 개체 변수가 이벤트를 발생 시킬 수 있는 클래스의 인스턴스를 참조 하도록 지정 합니다. [WithEvents](../../../visual-basic/language-reference/modifiers/withevents.md)를 참조 하세요.
...
- `variablelist`
  ...
  |`New`|선택 사항입니다. `Dim` 문이 실행 될 때 클래스의 새 인스턴스를 만듭니다.|
...
`Option Explicit` on (기본값) 이면 컴파일러에서 사용 하는 모든 변수에 대 한 선언이 필요 합니다. 자세한 내용은 [Option Explicit 문](../../../visual-basic/language-reference/statements/option-explicit-statement.md)을 참조 하세요.
...
프로시저 내의 지역 변수가 아니라 멤버 변수에 대해서만 `WithEvents` 지정할 수 있습니다. `WithEvents`지정 하는 경우 변수의 데이터 형식은 `Object`이 아닌 특정 클래스 형식 이어야 합니다. `WithEvents`를 사용 하 여 배열을 선언할 수 없습니다. 이벤트에 대 한 자세한 내용은 [이벤트](../../../visual-basic/programming-guide/language-features/events/index.md)를 참조 하세요.
...
`Using` 문은 리소스를 확보 하 고, 문 집합을 실행 한 다음 리소스를 삭제 하는 프로세스를 자동화 합니다. 그러나 리소스는 <xref:System.IDisposable> 인터페이스를 구현 해야 합니다. 자세한 내용은 [using 문](../../../visual-basic/language-reference/statements/using-statement.md)을 참조하세요.
