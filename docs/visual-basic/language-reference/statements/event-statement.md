...
|`delegatesignature`|필수 요소. `delegatename` 대리자에 필요한 매개 변수와 일치하는 매개 변수 목록입니다. [매개 변수 목록을](../../../visual-basic/language-reference/statements/parameter-list.md) 괄호로 묶어야 합니다.|  
