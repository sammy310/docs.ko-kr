...
|Convert to lowercase or uppercase.|<xref:Microsoft.VisualBasic.Strings.Format%2A>에서 <xref:Microsoft.VisualBasic.Strings.LCase%2A>에서 <xref:Microsoft.VisualBasic.Strings.UCase%2A>|  
