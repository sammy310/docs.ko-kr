...
|문자열을 구문 분석 합니다.|<xref:Microsoft.VisualBasic.Strings.InStrRev%2A>, <xref:Microsoft.VisualBasic.Strings.StrReverse%2A>|  
...
|문자를 반복 하는 문자열을 만듭니다.|<xref:Microsoft.VisualBasic.Strings.Space%2A>, <xref:Microsoft.VisualBasic.Strings.StrDup%2A>|  
|문자열의 길이 찾습니다.|<xref:Microsoft.VisualBasic.Strings.Len%2A>|  
...
|ASCII 및 ANSI 값을 사용 합니다.|<xref:Microsoft.VisualBasic.Strings.Asc%2A>, <xref:Microsoft.VisualBasic.Strings.AscW%2A>, <xref:Microsoft.VisualBasic.Strings.Chr%2A>, <xref:Microsoft.VisualBasic.Strings.ChrW%2A>|  
...
|부분 문자열의 지정된 된 수를 반환 합니다.|<xref:Microsoft.VisualBasic.Strings.Split%2A>, <xref:Microsoft.VisualBasic.Strings.Join%2A>|  
