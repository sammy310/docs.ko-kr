...
|Set or get file attributes.|<xref:Microsoft.VisualBasic.FileSystem.FileAttr%2A>에서 <xref:Microsoft.VisualBasic.FileSystem.GetAttr%2A>에서 <xref:Microsoft.VisualBasic.FileSystem.SetAttr%2A>|  
