...
---
# <a name="classname-is-not-cls-compliant-because-the-interface-interfacename-it-implements-is-not-cls-compliant"></a>'\<classname>' 인터페이스가 CLS 규격이 아니므로 이 인터페이스에서 상속된 '\<interfacename>'은(는) CLS 규격이 아닙니다.
