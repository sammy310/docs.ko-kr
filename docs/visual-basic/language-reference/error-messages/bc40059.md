...
---
# <a name="a-reference-was-created-to-embedded-interop-assembly-assembly1-because-of-an-indirect-reference-to-that-assembly-from-assembly-assembly2"></a>' @No__t-1assembly2 > ' 어셈블리의 해당 어셈블리에 대 한 간접 참조로 인해 포함 된 interop 어셈블리 ' \<assembly1 > '에 대 한 참조가 생성 되었습니다.
