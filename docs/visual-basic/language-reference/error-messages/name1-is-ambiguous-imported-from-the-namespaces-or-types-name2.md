...
---
# <a name="name1-is-ambiguous-imported-from-the-namespaces-or-types-name2"></a>'\<name1>' 네임스페이스 또는 형식에서 가져온 '\<name2>'은(는) 모호합니다.
...
1. 네임 스페이스 가져오기를 제거 하 여 이름을 명확 하 게 구분 합니다.  
