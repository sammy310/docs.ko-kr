...
---
# <a name="comparison-operators-visual-basic"></a>Comparison Operators (Visual Basic)
...
## <a name="parts"></a>요소
 `result`  
 필수 요소. A `Boolean` value representing the result of the comparison.

 `expression1`, `expression2`  
 필수 요소. Any expression.

 `comparisonoperator`  
 필수 요소. Any relational comparison operator.

 `object1`, `object2`  
 필수 요소. Any reference object names.

 `string`  
 필수 요소. 임의의 `String` 식입니다.

 `pattern`  
 필수 요소. Any `String` expression or range of characters.
