...
|용어|정의|  
|---|---|  
|`result`|필수 요소. 임의의 `Boolean` 식입니다. The result is the `Boolean` result of comparison of the two expressions.|  
