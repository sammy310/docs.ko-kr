...
## <a name="parts"></a>요소  
 ...
 `expression2`  
 Required unless the `–` operator is calculating a negative value. 임의의 숫자 식입니다.  
