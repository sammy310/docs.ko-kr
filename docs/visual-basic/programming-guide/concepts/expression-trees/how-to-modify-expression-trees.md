...
---
# <a name="how-to-modify-expression-trees-visual-basic"></a>방법: 수정 식 트리 (Visual Basic)
...
2. 추가 `Imports` 문을 파일에 `System.Linq.Expressions` 네임 스페이스입니다.  
...
4. 추가 `Imports` 문을 파일에 `System.Linq.Expressions` 네임 스페이스입니다.  
  
5. 코드를 추가 하는 `Main` 식 트리를 만들고이 메서드에 전달 하는 Module1.vb 파일의 메서드를 수정 합니다.  
