...
---
# <a name="accessing-attributes-by-using-reflection-visual-basic"></a>리플렉션을 사용 하 여 특성 액세스 (Visual Basic)
...
아래는 완성된 예제입니다. 사용자 지정 특성이 정의되고 여러 엔터티에 적용되고 리플렉션을 통해 검색됩니다.
