...
Visual Basic에서는 대리자 형식을 지정 하지 않고 variant 인터페이스에서 이벤트를 선언할 수 없습니다. 또한 variant 인터페이스에는 중첩 된 클래스, 열거형 또는 구조체를 사용할 수 없지만 중첩 된 인터페이스가 있을 수 있습니다. 이는 다음 코드에 설명되어 있습니다.
