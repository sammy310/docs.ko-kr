...
---
# <a name="serializing-xml-trees-visual-basic"></a>XML 트리 serialize (Visual Basic)
...
|[XML 선언으로 serialize (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/serializing-with-an-xml-declaration.md)|XML 선언이 포함된 XML 트리를 serialize하는 방법에 대해 설명합니다.|  
...
|[XmlReader로 serialize (XSLT 호출) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/serializing-to-an-xmlreader-invoking-xslt.md)|다른 모듈에서 XML 트리의 내용을 읽을 수 있도록 하는 <xref:System.Xml.XmlReader>를 만드는 방법에 대해 설명합니다.|  
