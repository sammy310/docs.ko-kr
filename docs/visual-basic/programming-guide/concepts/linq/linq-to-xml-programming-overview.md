...
|[방법: 빌드 LINQ to XML 예제 (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-build-linq-to-xml-examples.md)|LINQ to XML 예제를 빌드하는 데 필요한 `Imports` 문을 포함 합니다.|  
