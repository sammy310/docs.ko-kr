...
## <a name="example"></a>예제  
 ...
 이 예제가 작동 하는 방식을 설명 하는 자세한 자습서는 [XML의 순수 함수 변환 (Visual Basic)](pure-functional-transformations-of-xml.md)을 참조 하세요.  
...
```  
 ...
 [원본 Office OPEN Xml 문서 만들기 (Visual Basic)](creating-the-source-office-open-xml-document.md)에 설명 된 샘플 Open xml 문서를 사용 하 여 실행 하는 경우이 예제는 다음과 같은 출력을 생성 합니다.  
