...
---
# <a name="how-to-retrieve-a-single-child-element-linq-to-xml-visual-basic"></a>방법: 단일 자식 요소 검색 (LINQ to XML) (Visual Basic)
...
## <a name="example"></a>예제  
 다음 예제에서는 네임스페이스에 있는 XML에 대한 동일한 코드를 보여 줍니다. 자세한 내용은 [네임 스페이스 개요 (LINQ to XML) (Visual Basic)](namespaces-overview-linq-to-xml.md)를 참조 하세요.  
