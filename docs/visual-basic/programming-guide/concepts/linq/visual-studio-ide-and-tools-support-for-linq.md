...
---
# <a name="visual-studio-ide-and-tools-support-for-linq-visual-basic"></a>LINQ에 대 한 Visual Studio IDE 및 도구 지원 (Visual Basic)
Visual Studio IDE(통합 개발 환경)는 LINQ 애플리케이션 개발을 지원하는 다음과 같은 기능을 제공합니다.  
  
## <a name="object-relational-designer"></a>개체 관계형 디자이너  
