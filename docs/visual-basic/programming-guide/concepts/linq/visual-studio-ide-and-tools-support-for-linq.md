...
## <a name="object-relational-designer"></a>Object Relational Designer  
 개체 관계형 디자이너는 시각적 디자인 도구에서 사용할 수 있는 [LINQ to SQL](../../../../framework/data/adonet/sql/linq/index.md) 기본 데이터베이스의 관계형 데이터를 나타내는 응용 프로그램을 Visual Basic에서 클래스를 생성 합니다. 자세한 내용은 [Visual Studio의 LINQ to SQL 도구](/visualstudio/data-tools/linq-to-sql-tools-in-visual-studio2)를 참조하세요.  
...
## <a name="linq-aware-code-editor"></a>LINQ 인식 코드 편집기  
 Visual Basic 코드 편집기는 IntelliSense 및 서식 지정 기능으로 광범위 하 게 LINQ를 지원 합니다.  
