...
### <a name="xml-functional-transformational-technologies"></a>XML 함수 변환 기술  
 ...
 XSLT는 소스 문서의 구조가 불규칙적인 경우 문서 중심적인 변환에 권장되는 도구입니다. 그러나 LINQ to XML도 문서 중심적 변환을 수행할 수 있습니다. 자세한 내용은 [방법: XSLT 스타일에서 주석을 사용 하 여 LINQ to XML 트리 변환 (Visual Basic)](how-to-use-annotation-trees-to-transform-linq-to-xml-trees-in-an-xslt-style.md)을 참조 하세요.  
  
## <a name="see-also"></a>참조

- [순수 함수 변환 소개 (Visual Basic)](introduction-to-pure-functional-transformations.md)
- [LINQ to XML과 비교 기타 XML 기술 비교](linq-to-xml-vs-other-xml-technologies.md)
