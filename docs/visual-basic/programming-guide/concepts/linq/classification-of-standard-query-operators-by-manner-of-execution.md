...
ms.locfileid: "74345712"
---
# <a name="classification-of-standard-query-operators-by-manner-of-execution-visual-basic"></a>실행 방식에 따라 표준 쿼리 연산자 분류 (Visual Basic)
...
|표준 쿼리 연산자|반환 유형|즉시 실행|지연된 스트리밍 실행|지연된 비스트리밍 실행|  
|-----------------------------|-----------------|-------------------------|----------------------------------|---------------------------------------|  
