...
ms.locfileid: "84413325"
---
# <a name="sample-xml-file-customers-and-orders-linq-to-xml"></a><span data-ttu-id="921b7-102">샘플 XML 파일: Customers 및 Orders(LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="921b7-102">Sample XML File: Customers and Orders (LINQ to XML)</span></span>
<span data-ttu-id="921b7-103">다음 XML 파일은 [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] 설명서의 다양한 예제에서 사용됩니다.</span><span class="sxs-lookup"><span data-stu-id="921b7-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="921b7-104">이 파일에는 고객과 주문이 포함되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="921b7-104">This file contains customers and orders.</span></span>  
  
 <span data-ttu-id="921b7-105">[샘플 XSD 파일: Customers 및 Orders](sample-xsd-file-customers-and-orders.md) 항목에는 이 문서의 유효성을 검사하는 데 사용할 수 있는 XSD가 포함되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="921b7-105">The topic [Sample XSD File: Customers and Orders](sample-xsd-file-customers-and-orders.md) contains an XSD that can be used to validate this document.</span></span> <span data-ttu-id="921b7-106">이 항목에서는 XSD의 `xs:key` 및 `xs:keyref` 기능을 사용하여 `CustomerID` 요소의 `Customer` 특성을 키로 설정하고 각 `CustomerID` 요소의 `Order` 요소와 각 `CustomerID` 요소의 `Customer` 특성 간 관계를 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="921b7-106">It uses the `xs:key` and `xs:keyref` features of XSD to establish that the `CustomerID` attribute of the `Customer` element is a key, and to establish a relationship between the `CustomerID` element in each `Order` element and the `CustomerID` attribute in each `Customer` element.</span></span>  
  
 <span data-ttu-id="921b7-107">절을 사용 하 여이 관계를 활용 하는 LINQ 쿼리를 작성 하는 예제는 `Join` [방법: 두 컬렉션 조인 (LINQ to XML) (Visual Basic)](how-to-join-two-collections-linq-to-xml.md)을 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="921b7-107">For an example of writing LINQ queries that take advantage of this relationship using the `Join` clause, see [How to: Join Two Collections (LINQ to XML) (Visual Basic)](how-to-join-two-collections-linq-to-xml.md).</span></span>  
  
## <a name="customersordersxml"></a><span data-ttu-id="921b7-108">CustomersOrders.xml</span><span class="sxs-lookup"><span data-stu-id="921b7-108">CustomersOrders.xml</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="921b7-109">참고 항목</span><span class="sxs-lookup"><span data-stu-id="921b7-109">See also</span></span>

- [<span data-ttu-id="921b7-110">샘플 XML 문서(LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="921b7-110">Sample XML Documents (LINQ to XML)</span></span>](sample-xml-documents-linq-to-xml.md)
