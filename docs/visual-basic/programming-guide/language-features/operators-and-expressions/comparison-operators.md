...
## <a name="comparing-strings"></a>문자열 비교  
 ...
 If one string is a prefix of another, such as "aa" and "aaa", the longer string is considered to be greater than the shorter string. 다음은 이에 대한 예입니다.  
...
## <a name="comparing-objects"></a>Comparing Objects  
 ...
 When you want to test for two objects not pointing to the same instance, the `IsNot` operator lets you avoid a grammatically clumsy combination of `Not` and `Is`. 다음은 이에 대한 예입니다.  
