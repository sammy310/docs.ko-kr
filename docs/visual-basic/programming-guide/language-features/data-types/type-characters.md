...
|Identifier type character|데이터 형식|예제|  
|-------------------------------|---------------|-------------|  
|`%`|`Integer`|`Dim L%`|  
|`&`|`Long`|`Dim M&`|  
...
|Textual form of literal|Default data type|예제|  
|-----------------------------|-----------------------|-------------|  
...
|Literal type character|데이터 형식|예제|  
|----------------------------|---------------|-------------|  
|`S`|`Short`|`I = 347S`|
|`I`|`Integer`|`J = 347I`|
|`L`|`Long`|`K = 347L`|
...
|Number base|접두사|Valid digit values|예제|
|-----------------|------------|------------------------|-------------|
|16진수|`&H`|0-9 and A-F|`&HFFFF`|
