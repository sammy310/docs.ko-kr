...
### <a name="data-type"></a><span data-ttu-id="d5eca-123">데이터 형식</span><span class="sxs-lookup"><span data-stu-id="d5eca-123">Data Type</span></span>
