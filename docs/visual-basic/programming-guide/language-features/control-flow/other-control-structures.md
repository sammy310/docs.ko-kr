...
## <a name="usingend-using-construction"></a>Using ... 생성 사용 종료  
 ...
 `Using...End Using`생성은 SQL 연결과 같은 리소스를 사용 하는 문 블록을 설정 합니다. 필요에 따라 문을 사용 하 여 리소스를 가져올 수 있습니다 `Using` . 블록을 종료 하면 `Using` Visual Basic 다른 코드에서 사용할 수 있도록 리소스를 자동으로 삭제 합니다. 리소스는 로컬 이며 삭제 가능 해야 합니다. 자세한 내용은 [using 문](../../../language-reference/statements/using-statement.md)을 참조하세요.  
