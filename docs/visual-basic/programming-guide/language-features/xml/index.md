...
Visual Basic는 [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)]와 상호 작용할 수 있도록 하는 통합 언어 지원을 제공 합니다.  
...
|항목|설명|  
|-----------|-----------------|  
|[Visual Basic의 LINQ to XML 개요](../../../../visual-basic/programming-guide/language-features/xml/overview-of-linq-to-xml.md)|Visual Basic에서 [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)]를 지 원하는 방법을 설명 합니다.|  
