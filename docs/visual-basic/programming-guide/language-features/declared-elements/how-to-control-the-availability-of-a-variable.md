...
2. @No__t_1 문에 [Public](../../../../visual-basic/language-reference/modifiers/public.md) 키워드를 포함 합니다.  
...
2. @No__t_1 문에는 `Public` 키워드를 포함 하지 마십시오.  
...
2. @No__t_1 문에 [Protected](../../../../visual-basic/language-reference/modifiers/protected.md) 키워드를 포함 합니다.  
...
## <a name="example"></a>예제  
 다음 예에서는 `Public`, `Protected`, `Friend`, `Protected Friend` 및 `Private` 액세스 수준을 사용 하 여 변수 선언을 보여 줍니다. @No__t_0 문이 액세스 수준을 지정 하는 경우 `Dim` 키워드를 포함할 필요가 없습니다.  
