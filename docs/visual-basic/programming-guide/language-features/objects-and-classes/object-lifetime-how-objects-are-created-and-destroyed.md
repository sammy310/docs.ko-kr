...
생성자와 소멸자는 개체 만들기 및 소멸을 제어합니다. 의 `Sub New` 및 `Sub Finalize` 프로시저 `Class_Terminate` 는`Class_Initialize` 개체를 초기화 및 제거 Visual Basic Visual Basic 6.0 이전 버전에서 사용 되는 및 메서드를 대체 합니다.
