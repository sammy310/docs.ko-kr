...
---
# <a name="walkthrough-creating-com-objects-with-visual-basic"></a>Walkthrough: Creating COM Objects with Visual Basic
...
> [!NOTE]
> Although you can also expose a class created in Visual Basic as a COM object for unmanaged code to use, it is not a true COM object and cannot be used by Visual Basic. 자세한 내용은 [.NET Framework 애플리케이션의 COM 상호 운용성](../../../visual-basic/programming-guide/com-interop/com-interoperability-in-net-framework-applications.md)합니다.  
...
3. Select **Add New Item** from the **Project** menu. **새 항목 추가** 대화 상자가 표시됩니다.  
...
3. **솔루션 탐색기**에서 프로젝트를 오른쪽 마우스 단추로 클릭하고 **속성**을 클릭합니다. The **Project Designer** is displayed.  
