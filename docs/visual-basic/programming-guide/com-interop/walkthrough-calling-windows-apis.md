...
2. Open a new Windows Application project by clicking **New** on the **File** menu, and then clicking **Project**. **새 프로젝트** 대화 상자가 나타납니다.  
...
3. Add equivalent `Const` statements to your class or module to make these constants available to your application. 예를 들어 다음과 같은 가치를 제공해야 합니다.  
...
1. Open a new Windows Application project by clicking **New** on the **File** menu, and then clicking **Project**. **새 프로젝트** 대화 상자가 나타납니다.  
...
11. F5 키를 눌러 애플리케이션을 시작합니다. The main form appears.  
