...
1. 에 **도구** 메뉴에서 클릭 **도구 상자 항목 선택**합니다.  
  
     합니다 **도구 상자 선택** 대화 상자가 나타납니다.  
  
2. 클릭 합니다 **COM 구성 요소** 탭 합니다.  
  
3. ActiveX 컨트롤을 사용 하 고 클릭 하려는 옆의 확인란을 선택 **확인**합니다.  
  
     새 컨트롤의 다른 도구를 사용 하 여 표시 되는 **도구 상자**합니다.  
  
    > [!NOTE]
    >  ActiveX 컨트롤에 대 한 interop 어셈블리를 수동으로 만들려면 Aximp 유틸리티를 사용할 수 있습니다. 자세한 내용은 [Aximp.exe (Windows Forms ActiveX 컨트롤 가져오기)](../../../framework/tools/aximp-exe-windows-forms-activex-control-importer.md)합니다.  
