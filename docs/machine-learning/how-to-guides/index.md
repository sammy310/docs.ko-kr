...
* [파일 및 SQL 데이터베이스에서 데이터를 로드합니다.](load-data-ml-net.md)
...
* [교차 유효성 검사를 사용하여 기계 학습 모델을 학습합니다.](train-machine-learning-model-cross-validation-ml-net.md)
...
* [학습된 기계 학습 모델을 로드합니다.](save-load-machine-learning-models-ml-net.md)

* [학습된 모델로 예측합니다.](machine-learning-model-predictions-ml-net.md)
