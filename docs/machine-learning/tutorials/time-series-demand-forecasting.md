...
> [!NOTE]
> 이 자습서에서는 DatabaseLoader의 미리 보기 버전을 사용합니다.
...
1. **Microsoft.ML** 버전 **1.4.0-preview2** NuGet 패키지를 설치합니다.
    ...
    1. **System.Data.SqlClient** 버전 **4.7.0**, **Microsoft.ML.Experimental** 버전 **0.16.0-preview2**, **Microsoft.ML.TimeSeries** 버전 **1.4.0-preview2**에 대해 이러한 단계를 반복합니다.
...
1. 절대 평균 오차 및 제곱 평균 오차 값을 계산하여 성능을 측정합니다.
    ...
    - **제곱 평균 오차**: 모델에서 오류를 요약합니다. 이 값의 범위는 0과 무한대 사이입니다. 0에 가까울수록 모델의 품질이 좋습니다.
