...
이 항목에서는 하나의 리소스(또는 여러 리소스)가 트랜잭션에 참여할 수 있는 방법과 여러 인리스트먼트 유형에 대해 설명합니다. 합니다 [단일 단계 및 다단계 트랜잭션 커밋](../../../../docs/framework/data/transactions/committing-a-transaction-in-single-phase-and-multi-phase.md) 트랜잭션 커밋을 조정 참여 하는 리소스 간에 수 있는 방법을 다룹니다.
