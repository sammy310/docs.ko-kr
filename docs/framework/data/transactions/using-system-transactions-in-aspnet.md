...
```  
 ...
 ASP.NET 보안 정책에 대 한 자세한 내용은 참조 하십시오 [securityPolicy 요소 (ASP.NET 설정 스키마)](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/zhs35b56(v=vs.100))합니다.  
