...
## <a name="linq-to-sql"></a>LINQ to SQL  
 ...
 [!INCLUDE[vbtecdlinq](../../../../includes/vbtecdlinq-md.md)]를 사용 하면 개발자는 XML과 같은 다른 데이터 원본 외에도 메모리 내 컬렉션과 <xref:System.Data.DataSet>같은 LINQ 프로그래밍 패턴을 사용 하 여 저장소 스키마에 대해 직접 코드를 작성할 수 있습니다. 자세한 내용은 [LINQ to SQL](./sql/linq/index.md)을 참조하세요.  
