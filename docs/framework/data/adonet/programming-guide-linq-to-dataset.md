...
이 섹션에서는 데이터 집합에 LINQ 사용한 프로그래밍에 대 한 개념 정보 및 예제를 제공 합니다.  
  
## <a name="in-this-section"></a>섹션 내용  
 [LINQ to DataSet의 쿼리](../../../../docs/framework/data/adonet/queries-in-linq-to-dataset.md)  
 LINQ to DataSet 쿼리 작성 하는 방법에 대 한 정보를 제공 합니다.  
 ...
 만들기에 대 한 정보를 제공 된 <xref:System.Data.DataTable> linq to DataSet 쿼리에서 사용 하 여를 <xref:System.Data.DataTableExtensions.CopyToDataTable%2A> 메서드.  
  
 [방법: 위치에서 CopyToDataTable 구현\<T >는 제네릭 형식 T가 DataRow 없습니다](../../../../docs/framework/data/adonet/implement-copytodatatable-where-type-not-a-datarow.md)  
 ...
 디버깅 및 LINQ to DataSet 쿼리 문제 해결에 대 한 정보를 제공 합니다.  
  
 [보안](../../../../docs/framework/data/adonet/security-linq-to-dataset.md)  
 LINQ to DataSet의에서 보안 문제를 설명합니다.  
