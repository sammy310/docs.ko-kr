...
- [속성](property.md)형식의 데이터입니다. (선택 사항)  
  
- [연결](association-type.md) 의 한 [end](association-end.md) 에서 다른 end로의 탐색을 허용 하는 [탐색 속성](navigation-property.md) 입니다. 이 매개 변수는 선택 사항입니다.  
