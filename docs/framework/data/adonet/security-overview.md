...
## <a name="design-for-security"></a>보안을 위한 디자인
 ...
 마지막 분 보안 구현에서는 새로운 제한에서 소프트웨어 중단이 발생 하거나 예기치 않은 기능을 수용 하기 위해 다시 작성 해야 하므로 더 많은 버그가 발생 합니다. 코드 한 줄을 수정할 때마다 새로운 버그가 발생할 가능성이 있습니다. 따라서 개발 프로세스 초기에 보안을 고려하여 새로운 기능 개발과 함께 진행할 수 있도록 해야 합니다.
