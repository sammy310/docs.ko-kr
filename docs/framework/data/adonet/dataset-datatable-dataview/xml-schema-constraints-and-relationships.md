 ...
 **Msdata: Relationship** 주석을 지정 하는 대신 XML 스키마 매핑 프로세스에서 제약 조건 뿐만 아니라 **데이터 집합**의 관계를 생성 하는 데 사용 되는 key 및 keyref 제약 조건을 지정할 수 있습니다. 그러나 **keyref** 요소에 `msdata:ConstraintOnly="true"`를 지정 하는 경우 **데이터 집합** 에 제약 조건만 포함 되며 관계는 포함 되지 않습니다.  
