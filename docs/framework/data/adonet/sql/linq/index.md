...
ms.locfileid: "67743267"
---
# <a name="linq-to-sql"></a>LINQ to SQL
[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] .NET framework 버전 3.5 관계형 데이터를 개체로 관리 하기 위한 런타임 인프라를 제공 하는 구성 요소가입니다.  
...
>  관계형 데이터는 테이블 간에 서로 관계된 공통 열이 있는 이차원 테이블(*관계* 또는 *플랫 파일*)의 컬렉션으로 표시됩니다. [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]을 효율적으로 사용하려면 관계형 데이터베이스의 기본 원리에 대해 조금은 알고 있어야 합니다.  
 ...
 개발자가 일반적으로 Visual Studio를 사용 하 여 다양 한 기능의 구현에 대 한 사용자 인터페이스를 제공 하는 개체 관계형 디자이너를 사용 하 여 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]입니다.  
...
## <a name="related-sections"></a>관련 단원  
 ...
 에 대해 설명 하는 방법을 <xref:System.Web.UI.WebControls.LinqDataSource> 노출 제어 [!INCLUDE[vbteclinqext](../../../../../../includes/vbteclinqext-md.md)] ASP.NET 데이터 소스 컨트롤 아키텍처를 통해 웹 개발자에 게 합니다.
