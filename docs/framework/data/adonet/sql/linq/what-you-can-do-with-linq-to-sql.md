...
## <a name="selecting"></a>선택  
 사용자 고유의 프로그래밍 언어로 LINQ 쿼리를 작성 한 다음 해당 쿼리를 실행 하 여 결과를 검색 하기만 하면 (*프로젝션*)를 선택할 수 있습니다. 필요한 모든 작업은[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 를 통해 사용자에게 익숙한 필수 SQL 작업으로 변환됩니다. 자세한 내용은 [LINQ to SQL](index.md)을 참조하십시오.  
