...
- 특정 문제에 대 한 Microsoft 문서 문서를 검색합니다.  
  
- [LINQ 포럼에](https://social.msdn.microsoft.com/forums/home?forum=linqtosql)참여하여 전문가와 보다 복잡한 주제에 대해 자세히 논의할 수 있습니다.  
  
- Visual Basic 및 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] C# 코드 예제를 통해 기술에 대해 자세히 설명한 백서를 연구합니다. 자세한 내용은 [LINQ에서 SQL로: 관계형 데이터에 대한 .NET 언어 통합 쿼리를](https://docs.microsoft.com/previous-versions/dotnet/articles/bb425822(v=msdn.10))참조하십시오.  
  
## <a name="in-this-section"></a>섹션 내용  
 [ADO.NET 및 LINQ to SQL](ado-net-and-linq-to-sql.md)  
 ADO.NET 및 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]의 관계를 설명합니다.  
 ...
 LINQ의 쿼리와 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 다른 쿼리의 측면을 설명합니다.  
