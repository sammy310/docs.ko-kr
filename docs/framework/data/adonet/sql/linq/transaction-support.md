...
## <a name="explicit-distributable-transaction"></a>명시적 배포 가능 트랜잭션  
 활성 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]의 범위에서 <xref:System.Data.Linq.DataContext.SubmitChanges%2A> API(<xref:System.Transactions.Transaction>를 포함하지만 여기에 제한되지는 않음)를 호출할 수 있습니다. [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 있는지 검색 하 여 호출 트랜잭션의 범위 내에 새 트랜잭션을 만들지 않습니다. [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 또한이 경우 연결이 닫히지 방지 합니다. 이러한 트랜잭션의 컨텍스트에서 쿼리 및 <xref:System.Data.Linq.DataContext.SubmitChanges%2A> 실행을 수행할 수 있습니다.  
