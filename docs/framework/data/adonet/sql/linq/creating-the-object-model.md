...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [방법: DBML 파일을 수정 하 여 사용자 지정된 코드를 생성 합니다.](../../../../../../docs/framework/data/adonet/sql/linq/how-to-generate-customized-code-by-modifying-a-dbml-file.md)  
 Visual Basic을 생성 하는 방법에 설명 합니다. 또는 C# DBML 메타 데이터 파일의 코드입니다.  
