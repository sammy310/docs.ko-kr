...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [방법: DBML 파일을 수정 하 여 사용자 지정 코드 생성](how-to-generate-customized-code-by-modifying-a-dbml-file.md)  
 DBML 메타 데이터 파일에서 Visual Basic C# 또는 코드를 생성 하는 방법에 대해 설명 합니다.  
