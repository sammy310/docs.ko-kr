...
## <a name="creating-queries"></a>쿼리 작성  
 [!INCLUDE[esql](../../../../../includes/esql-md.md)] 언어는 개념적 엔터티 스키마와 직접 작동 하 고 상속 및 관계와 같은 엔터티 데이터 모델 개념을 지 원하는 SQL 저장소에 독립적인 언어입니다. <xref:System.Data.EntityClient.EntityCommand> 클래스는 엔터티 모델에 대해 [!INCLUDE[esql](../../../../../includes/esql-md.md)] 명령을 실행하는 데 사용됩니다. <xref:System.Data.EntityClient.EntityCommand> 개체를 생성할 때는 저장 프로시저 이름이나 쿼리 텍스트를 지정할 수 있습니다. [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)]는 스토리지별 데이터 공급자와 함께 작업하여 일반 [!INCLUDE[esql](../../../../../includes/esql-md.md)]을 스토리지별 쿼리로 변환합니다. 쓰기에 대 한 자세한 내용은 [!INCLUDE[esql](../../../../../includes/esql-md.md)] 쿼리를 참조 하세요 [Entity SQL 언어](../../../../../docs/framework/data/adonet/ef/language-reference/entity-sql-language.md)합니다.  
  
 다음 예제는 <xref:System.Data.EntityClient.EntityCommand> 할당 및 개체를 [!INCLUDE[esql](../../../../../includes/esql-md.md)] 쿼리 텍스트를 해당 <xref:System.Data.EntityClient.EntityCommand.CommandText%2A?displayProperty=nameWithType> 속성. 이 [!INCLUDE[esql](../../../../../includes/esql-md.md)] 쿼리는 개념적 모델에서 가격에 따라 정렬 하는 제품을 요청 합니다. 다음 코드에는 스토리지 모델에 대한 정보가 없습니다.  
