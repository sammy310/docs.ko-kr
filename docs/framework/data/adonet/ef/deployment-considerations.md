...
이 항목에서는 데이터 액세스를 위해 ADO.NET Entity Framework를 사용하는 응용 프로그램 배포에 대한 정보를 제공합니다. Entity Framework에 대 한 자세한 내용은 참조 하세요. [Getting Started](../../../../../docs/framework/data/adonet/ef/getting-started.md)합니다.  
 ...
 Entity Framework에서는 Visual Studio에서 개발을 용이하게 하는 통합된 도구 집합을 제공합니다. 자세한 내용은 [ADO.NET 엔터티 데이터 모델 도구](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/bb399249(v=vs.100))합니다. 이 항목에서 Entity Framework 기반 응용 프로그램을 배포하기 위해 특정 기술을 사용하는 방법을 설명하지는 않습니다.  
  
 Visual Studio에서는 ClickOnce 배포와 같은 응용 프로그램 배포에 대한 기능을 제공합니다. 자세한 내용은 [응용 프로그램 배포 및 구성 요소](/visualstudio/deployment/deploying-applications-services-and-components) Visual Studio 설명서에서.  
