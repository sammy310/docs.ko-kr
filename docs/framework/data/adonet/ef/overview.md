...
## <a name="give-life-to-models"></a>모델을 사용 하 여 수명 게
 ...
 [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] 개발자가 엔터티를 쿼리 및 도메인 모델에서 관계를 사용 하 여 모델에서는 (호출을 *개념적* 모델를 [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)])에 의존 하는 동안를 [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] 해당 변환 데이터 소스 관련 명령에 대 한 작업입니다. 이렇게 하면 응용 프로그램이 하드 코딩 방식으로 특정 데이터 소스에 종속되지 않습니다.
