...
## <a name="in-this-section"></a>섹션 내용  
 ...
 EntityClient 데이터 공급자에 대해 설명합니다. 이 공급자는 데이터 모델에 대한 쿼리를 정식 명령 트리로 변형합니다. 그런 다음 [!INCLUDE[dnprdnshort](../../../../../includes/dnprdnshort-md.md)]용 [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] 데이터 공급자에서 이 명령 트리를 사용할 수 있습니다.  
