...
- [쿼리 식 구문 예제: 주](../../../../../../docs/framework/data/adonet/ef/language-reference/query-expression-syntax-examples-ordering.md)  
...
- [쿼리 식 구문 예제: 파티션은](../../../../../../docs/framework/data/adonet/ef/language-reference/query-expression-syntax-examples-partitioning.md)  
...
- [쿼리 식 구문 예제: 묶어서](../../../../../../docs/framework/data/adonet/ef/language-reference/query-expression-syntax-examples-grouping.md)  
...
- [메서드 기반 쿼리 구문 예제: 주](../../../../../../docs/framework/data/adonet/ef/language-reference/method-based-query-syntax-examples-ordering.md)  
...
- [메서드 기반 쿼리 구문 예제: 파티션은](../../../../../../docs/framework/data/adonet/ef/language-reference/method-based-query-syntax-examples-partitioning.md)  
  
- [메서드 기반 쿼리 구문 예제: 변환할](../../../../../../docs/framework/data/adonet/ef/language-reference/method-based-query-syntax-examples-conversion.md)  
...
- [메서드 기반 쿼리 구문 예제: 묶어서](../../../../../../docs/framework/data/adonet/ef/language-reference/method-based-query-syntax-examples-grouping.md)  
