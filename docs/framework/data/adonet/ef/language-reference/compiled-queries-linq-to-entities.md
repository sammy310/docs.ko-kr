...
## <a name="example"></a>예제  
 다음 예제에서는 <xref:System.String> 입력 매개 변수를 허용 하는 쿼리를 컴파일 한 `Contact` 다음 지정된 문자열로 시작 하는 전자 메일 주소를 반환 합니다.  
