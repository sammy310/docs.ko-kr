...
## <a name="use-windows-authentication"></a>Windows 인증 사용  
 ...
 Windows 인증을 사용할 수 없는 상황에서는 사용자 자격 증명이 연결 문자열에 노출되므로 각별히 유의해야 합니다. ASP.NET 응용 프로그램에서 Windows 계정을 고정 ID로 구성하여 데이터베이스 및 기타 네트워크 리소스에 연결하는 데 사용할 수 있습니다. id 요소에 가장을 사용 합니다 **web.config** 파일 및 사용자 이름 및 암호를 지정 합니다.  
