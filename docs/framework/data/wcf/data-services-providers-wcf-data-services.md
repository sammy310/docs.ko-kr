...
ms.locfileid: "73975351"
---
# <a name="data-services-providers-wcf-data-services"></a>Data Services 공급자 (WCF Data Services)
[!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]는 OData (Open Data Protocol) 피드로 데이터를 노출 하기 위한 여러 공급자 모델을 지원 합니다. 이 항목에서 제공하는 정보를 통해 데이터 소스에 가장 적합한 [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] 공급자를 선택할 수 있습니다.  
