...
ms.locfileid: "73975262"
---
# <a name="getting-started-with-wcf-data-services"></a>WCF Data Services로 시작
이 섹션의 항목에서는 OData (Open Data Protocol) 및 [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]를 사용 하 여 기본 기술을 설명 하 여 OData 피드를 노출 하 고 사용 하는 방법을 신속 하 게 이해 하는 데 도움이 됩니다. 이 섹션에서는 개념 콘텐츠와 [빠른](quickstart-wcf-data-services.md) 시작 자습서를 모두 제공 합니다.  
...
## <a name="in-this-section"></a>단원 내용  
 ...
 [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]에서 지 원하는 OData 시나리오의 핵심 집합을 강조 표시 합니다.  
  
 [리소스](wcf-data-services-resources.md)  
 [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] 및 OData 리소스에 대 한 링크를 제공 합니다.  
