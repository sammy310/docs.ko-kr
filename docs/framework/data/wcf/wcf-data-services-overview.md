...
- [데이터 서비스 리소스 (WCF Data Services)에 액세스](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/dd728283(v=vs.100))
