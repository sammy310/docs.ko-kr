...
-   [<span data-ttu-id="8e690-110">고정 길이 문자열 버퍼</span><span class="sxs-lookup"><span data-stu-id="8e690-110">Fixed-Length String Buffers</span></span>](#cpcondefaultmarshalingforstringsanchor3)  
