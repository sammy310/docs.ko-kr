...
|컨트롤 패턴|고객 지원팀|노트|  
|---------------------|-------------|-----------|  
|<xref:System.Windows.Automation.Provider.IToggleProvider>|필요한 공간|확인란이 프로그래밍 방식으로 내부 상태를 순환하도록 합니다.|  
...
|<xref:System.Windows.Automation.TogglePatternIdentifiers.ToggleStateProperty> 속성 변경 이벤트.|필요한 공간|없음|  
