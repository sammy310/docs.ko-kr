...
|컨트롤 뷰|콘텐츠 뷰|  
|------------------|------------------|  
|헤더<br /><br /> -HeaderItem (1 또는 그 이상)|없음|  
...
|---------------------------------------------------------------------------------|-------------|-----------|  
|<xref:System.Windows.Automation.AutomationElement.BoundingRectangleProperty> 속성 변경 이벤트입니다.|필수|없음|  
|<xref:System.Windows.Automation.AutomationElement.IsOffscreenProperty> 속성 변경 이벤트입니다.|필수|없음|  
|<xref:System.Windows.Automation.AutomationElement.IsEnabledProperty> 속성 변경 이벤트입니다.|필수|없음|  
