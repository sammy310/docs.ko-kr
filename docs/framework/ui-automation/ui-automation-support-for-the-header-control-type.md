...
|컨트롤 뷰|콘텐츠 뷰|  
|------------------|------------------|  
|Header<br /><br /> -   HeaderItem (1 or more)|없음|  
...
|---------------------------------------------------------------------------------|-------------|-----------|  
|<xref:System.Windows.Automation.AutomationElement.BoundingRectangleProperty> 속성 변경 이벤트.|필요한 공간|없음|  
|<xref:System.Windows.Automation.AutomationElement.IsOffscreenProperty> 속성 변경 이벤트.|필요한 공간|없음|  
|<xref:System.Windows.Automation.AutomationElement.IsEnabledProperty> 속성 변경 이벤트.|필요한 공간|없음|  
|<xref:System.Windows.Automation.AutomationElement.AutomationFocusChangedEvent>|필요한 공간|없음|  
|<xref:System.Windows.Automation.AutomationElement.StructureChangedEvent>|필요한 공간|없음|  
