...
메뉴 항목 컨트롤의 컨트롤 보기에는 위에 표시된 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 트리 구조가 있습니다. 합니다 **도움말** 메뉴 항목을 일반적인 메뉴에서 하위 메뉴 계층 구조 이해를 돕기 위해 포함 됩니다.
