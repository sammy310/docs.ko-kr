...
>  이 설명서는 <xref:System.Windows.Automation> 네임스페이스에 정의된 관리되는 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 클래스를 사용하려는 .NET Framework 개발자를 위한 것입니다. 에 대 한 최신 정보에 대 한 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]를 참조 하세요 [Windows Automation API: UI 자동화](https://go.microsoft.com/fwlink/?LinkID=156746)합니다.  
 ...
 [!INCLUDE[TLA#tla_aa](../../../includes/tlasharptla-aa-md.md)] 내게 필요한 옵션이 응용 프로그램에 대 한 이전 솔루션이 이었습니다. [!INCLUDE[TLA#tla_uiautomation](../../../includes/tlasharptla-uiautomation-md.md)] 에 대 한 새로운 접근성 모델로 [!INCLUDE[TLA#tla_win](../../../includes/tlasharptla-win-md.md)] 보조 기술 제품의 요구를 해결 하기 위해 및 자동화 된 테스트 도구입니다. [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 많은 향상 된 기능에 비해 [!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)]합니다.  
...
## <a name="support-in-windows-presentation-foundation"></a>Windows Presentation Foundation에서의 지원  
 Windows Presentation Foundation (WPF)은 사용자 인터페이스를 만들기 위한 새 모델입니다. [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] 요소에 대 한 기본 지원을 포함 하지 [!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)]하지만 지 마십시오 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]합니다 브리징에 대 한 지원이 포함 된 [!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] 클라이언트. [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 에 대해 특별히 작성된 클라이언트만 [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)]의 접근성 기능(예: 다양한 텍스트 지원)을 활용할 수 있습니다.  
...
## <a name="ui-elements"></a>UI 요소  
 [!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] 표시 [!INCLUDE[TLA2#tla_ui](../../../includes/tla2sharptla-ui-md.md)] 요소 하나로 `IAccessible` 인터페이스 또는 자식 식별자입니다. 두 `IAccessible` 포인터를 비교하여 동일한 요소를 참조하는지 확인하기는 어렵습니다.  
...
## <a name="roles-and-control-types"></a>역할 및 컨트롤 형식  
 ...
 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 로 식별 되는 사용자 지정 컨트롤을 지원 합니다 <xref:System.Windows.Automation.ControlType.Custom> 속성으로 설명할 수는 <xref:System.Windows.Automation.AutomationElement.LocalizedControlTypeProperty> 속성입니다.  
...
|[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] 역할(Role)|[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 컨트롤 형식|  
|----------------------------------------------------------------------|----------------------------------------------------------------------------------------|  
...
|-----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|-------------|  
|`get_accKeyboardShortcut`|<xref:System.Windows.Automation.AutomationElement.AccessKeyProperty> 또는 <xref:System.Windows.Automation.AutomationElement.AcceleratorKeyProperty>|`AccessKeyProperty` 둘 다 있는 경우 우선 합니다.|  
...
|`get_accDescription`|지원 되지 않습니다. [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|`accDescription` 이 속성에 다양 한 정보를 배치 하는 공급자에서 발생 한은 MSAA 내에서 명확한 사양이 없습니다.|  
|`get_accHelpTopic`|지원 되지 않습니다. [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]||  
...
|[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] state|[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 속성|상태 변경 트리거 여부|  
|-----------------------------------------------------------------------|------------------------------------------------------------------------------------|----------------------------|  
|STATE_SYSTEM_CHECKED|확인란 <xref:System.Windows.Automation.TogglePattern.ToggleStateProperty><br /><br /> 라디오 단추의 경우, <xref:System.Windows.Automation.SelectionItemPattern.IsSelectedProperty>|Y|  
...
|STATE_SYSTEM_HASPOPUP|<xref:System.Windows.Automation.ExpandCollapsePattern> 메뉴 항목|N|  
|STATE_SYSTEM_INVISIBLE|<xref:System.Windows.Automation.AutomationElement.IsOffscreenProperty> = True 및 <xref:System.Windows.Automation.AutomationElement.GetClickablePoint%2A> 하면 <xref:System.Windows.Automation.NoClickablePointException>|N|  
...
|STATE_SYSTEM_SELECTABLE|<xref:System.Windows.Automation.SelectionItemPattern> 지원|N|  
...
|[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] state|설명|  
|-----------------------------------------------------------------------|-------------|  
|STATE_SYSTEM_BUSY|사용할 수 없음 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
|STATE_SYSTEM_DEFAULT|사용할 수 없음 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
|STATE_SYSTEM_ANIMATED|사용할 수 없음 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
...
|STATE_SYSTEM_TRAVERSED|사용할 수 없음 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
...
|STATE_SYSTEM_HOTTRACKED|사용할 수 없음 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
|STATE_SYSTEM_PRESSED|사용할 수 없음 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
...
|EVENT_OBJECT_CONTENTSCROLLED|<xref:System.Windows.Automation.ScrollPattern.VerticalScrollPercentProperty> 또는 <xref:System.Windows.Automation.ScrollPattern.HorizontalScrollPercentProperty> 연결된 된 스크롤 막대의 속성 변경|  
...
|EVENT_SYSTEM_SCROLLINGEND|<xref:System.Windows.Automation.ScrollPattern.VerticalScrollPercentProperty> 또는 <xref:System.Windows.Automation.ScrollPattern.HorizontalScrollPercentProperty> 속성 변경|  
|EVENT_SYSTEM_SCROLLINGSTART|<xref:System.Windows.Automation.ScrollPattern.VerticalScrollPercentProperty> 또는 <xref:System.Windows.Automation.ScrollPattern.HorizontalScrollPercentProperty> 속성 변경|  
...
|동일한 요소 없음|<xref:System.Windows.Automation.AutomationElement.AsyncContentLoadedEvent> 이벤트(event)|  
