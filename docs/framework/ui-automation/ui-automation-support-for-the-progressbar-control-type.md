...
|<xref:System.Windows.Automation.Provider.IRangeValueProvider>|종속|숫자 범위를 사용 하는 진행률 표시줄 컨트롤을 구현 해야 합니다. <xref:System.Windows.Automation.Provider.IRangeValueProvider>|  
