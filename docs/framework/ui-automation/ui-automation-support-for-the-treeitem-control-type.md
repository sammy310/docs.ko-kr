...
|컨트롤 뷰|콘텐츠 뷰|  
|------------------|------------------|  
|TreeItem<br /><br /> -확인란 (0 또는 1)<br />-이미지 (0 또는 1)<br />-Button (0 또는 1)<br />-TreeItem (0 개 이상)|TreeItem<br /><br /> -TreeItem (0 개 이상)|  
...
|<xref:System.Windows.Automation.ExpandCollapsePatternIdentifiers.ExpandCollapseStateProperty> 속성 변경 이벤트입니다.|필수|없음|  
