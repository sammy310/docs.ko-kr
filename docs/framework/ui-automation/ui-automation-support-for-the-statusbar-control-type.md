...
|컨트롤 뷰|콘텐츠 뷰|  
|------------------|------------------|  
|StatusBar<br /><br /> -Edit (0 이상)<br />-(0 개 또는 여러) 진행률 표시줄<br />-이미지 (0 개 또는 여러)<br />단추 (0 개 또는 여러)|StatusBar<br /><br /> -Edit (0 이상)<br />-ProgressBar (0 개 또는 여러)<br />-이미지 (0 개 또는 여러)<br />단추 (0 개 또는 여러)|  
