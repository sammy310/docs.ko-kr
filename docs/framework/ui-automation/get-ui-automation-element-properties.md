...
1. 가져올 속성의 <xref:System.Windows.Automation.AutomationElement>을 가져옵니다.  
...
1. 가져올 속성의 <xref:System.Windows.Automation.AutomationElement>을 가져옵니다. 속성은 <xref:System.Windows.Automation.CacheRequest>에 지정 되어 있어야 합니다.  
...
## <a name="example"></a>예제  
 다음 예제에서는 <xref:System.Windows.Automation.AutomationElement>의 현재 속성을 검색 하는 다양 한 방법을 보여 줍니다.  
