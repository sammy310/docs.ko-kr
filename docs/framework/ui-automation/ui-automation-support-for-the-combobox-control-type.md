...
|컨트롤 뷰|콘텐츠 뷰|  
|------------------|------------------|  
|ComboBox<br /><br /> -Edit (0 또는 1)<br />목록 (1)<br />-목록 항목 (목록의 자식, 0 개 이상)<br />-단추 (1)|ComboBox<br /><br /> 목록 항목 (0 개 이상)|  
...
|<xref:System.Windows.Automation.ValuePatternIdentifiers.ValueProperty> 속성 변경 이벤트입니다.|종속|컨트롤이 Value 패턴을 지원하는 경우 이 이벤트를 지원해야 합니다.|  
