...
- <xref:System.Windows.Automation.SelectionItemPattern.Select%2A>, <xref:System.Windows.Automation.SelectionItemPattern.AddToSelection%2A>또는 <xref:System.Windows.Automation.SelectionItemPattern.RemoveFromSelection%2A>의 결과가 선택한 단일 항목인 경우 <xref:System.Windows.Automation.SelectionItemPatternIdentifiers.ElementSelectedEvent> 발생 해야 합니다. 그렇지 않으면 <xref:System.Windows.Automation.SelectionItemPatternIdentifiers.ElementAddedToSelectionEvent>/ <xref:System.Windows.Automation.SelectionItemPatternIdentifiers.ElementRemovedFromSelectionEvent>를 적절 하 게 보냅니다.  
