...
|<xref:System.Windows.Automation.TogglePatternIdentifiers.ToggleStateProperty> 속성 변경 이벤트입니다.|종속|컨트롤이 Toggle 컨트롤 패턴을 지원하는 경우 이 이벤트를 지원해야 합니다.|  
