...
|앱 형식|참조|  
|--------------|---------|  
|모든 플랫폼용 .NET Framework 앱|[가비지 수집 및 성능](../../standard/garbage-collection/performance.md)<br /><br /> [성능 팁](../../../docs/framework/performance/performance-tips.md)|  
