...
|AppDomainFlags|win:UInt32|0x1: 기본 도메인.<br /><br /> 0x2: 실행 파일.<br /><br /> 0x4: 애플리케이션 도메인, 비트 28-31: 이 도메인의 정책 공유.<br /><br /> 0: 공유 도메인.|  
...
|어셈블리 이름|win:UnicodeString|정규화된 어셈블리 이름입니다.|  
|ClrInstanceID|win:UInt16|CLR 또는 CoreCLR 인스턴스에 대한 고유 ID입니다.|   
