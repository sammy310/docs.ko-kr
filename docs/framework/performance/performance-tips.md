...
## <a name="strings"></a>문자열  
 예를 들어 연속 루프에서 다수의 문자열 변수를 연결하는 경우 C# <xref:System.Text.StringBuilder?displayProperty=nameWithType>+ 연산자[ 또는 Visual Basic ](../../csharp/language-reference/operators/addition-operator.md)연결 연산자[가 아니라 ](../../visual-basic/language-reference/operators/concatenation-operators.md)를 대신 사용합니다. 자세한 내용은 [Visual Basic에서](../../visual-basic/programming-guide/language-features/operators-and-expressions/concatenation-operators.md)여러 문자열 및 연결 연산자를 [연결 하는 방법](../../csharp/how-to/concatenate-multiple-strings.md) 을 참조 하세요.  
