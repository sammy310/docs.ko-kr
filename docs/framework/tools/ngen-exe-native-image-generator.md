...
|인수|설명|  
|--------------|-----------------|  
|`assemblyName`|어셈블리의 전체 표시 이름입니다. 예를 들어 `"myAssembly, Version=2.0.0.0, Culture=neutral, PublicKeyToken=0038abc9deabfle5"`과 같은 형식입니다. **참고:**  `myAssembly` 및 `display` 작업의 경우 `uninstall`와 같은 부분 어셈블리 이름을 제공할 수 있습니다. <br /><br /> Ngen.exe 명령줄 당 어셈블리를 하나만 지정할 수 있습니다.|  
...
|---------------|----------------------|----------------------|  
|NET Framework NGEN v4.0.30319|적용|적용|  
|NET Framework NGEN v4.0.30319 64|아니요|적용|  
