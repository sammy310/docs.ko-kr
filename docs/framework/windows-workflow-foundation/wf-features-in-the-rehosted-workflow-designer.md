---
description: '자세한 정보: Rehosted 워크플로 디자이너의 새로운 Workflow Foundation 4.5 기능 지원'
...
> [!NOTE]
> .NET Framework 4.5에 도입 된 모든 WF (Windows Workflow Foundation) 기능 목록 (designer 재호스팅와 관련이 없는 기능 포함)에 대해서는 [.NET Framework 4.5의 Windows Workflow Foundation에 있는 새로운](whats-new-in-wf-in-dotnet.md)기능을 참조 하세요.

## <a name="activities"></a>활동

 기본 제공 활동 라이브러리에는 새로운 활동과 기존 활동의 새로운 기능이 들어 있습니다. 이러한 모든 새 활동은 재호스트된 디자이너에서 지원됩니다. 이러한 새 활동에 대 한 자세한 내용은 [Windows Workflow Foundation의 새로운 기능에서 .NET Framework 4.5](whats-new-in-wf-in-dotnet.md)의 [작업](whats-new-in-wf-in-dotnet.md#BKMK_NewActivities) 섹션을 참조 하세요.
