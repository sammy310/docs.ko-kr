...
- [!INCLUDE[wf1](../../../../includes/wf1-md.md)]다른 클라이언트 (ASP.NET 웹 응용 프로그램 및 WinForms 응용 프로그램)에서 호스팅.
...
1. X라는 회사의 직원이 RFP(제안 요청서)를 만듭니다.  
    ...
    2. 직원은 제안을 제출 하기 위해 초대 하려는 공급 업체를 선택 합니다.  
