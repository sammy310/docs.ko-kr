...
## <a name="sample-details"></a>샘플 세부 정보
 ...
 `UseLocationExpression`특성은에서 `OutArgument` 식이 l-value ("left value" 또는 "location value") 식 이어야 함을 지정 하는 데 사용 됩니다. 대부분의 경우 L-value 식은 반환되는 `OutArgument`가 변수인지 인수 이름인지를 나타내는 데 사용되는 유효한 Visual Basic 식별자입니다.
