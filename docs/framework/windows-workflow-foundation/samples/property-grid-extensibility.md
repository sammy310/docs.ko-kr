...
2. WPF 데이터 템플릿을 사용 하 여 생성자의 <xref:System.Activities.Presentation.PropertyEditing.PropertyValueEditor.InlineEditorTemplate%2A> 값을 설정 합니다. 이 값을 XAML로 만들 수 있지만 이 샘플에서는 코드로 만듭니다.
