...
## <a name="demonstrates"></a>세부 항목
 <xref:System.ServiceModel.WorkflowServiceHost> 사용 하 여 <xref:System.ServiceModel.Activities.Description.WorkflowUnhandledExceptionBehavior> 고 <xref:System.ServiceModel.Activities.WorkflowControlEndpoint> Windows WF (Workflow Foundation)에 있습니다.
