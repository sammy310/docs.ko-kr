...
## <a name="definition-and-usage"></a>정의 및 사용  
 ...
 기본 활동 클래스에서 상속 하 고 [기본 제공 활동 라이브러리](net-framework-4-5-built-in-activity-library.md)의 활동을 사용 하 여 새 활동을 작성 하 여 워크플로를 작성 합니다. 활동을 사용하려면 활동 작성자가 정의의 각 구성 요소에 대한 표시 유형을 구성해야 합니다.  
