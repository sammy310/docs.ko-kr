...
|[115 - WorkflowInstanceAbortedRecordWithId](115-workflowinstanceabortedrecordwithid.md)|경고|TrackRecord = WorkflowInstanceAbortedRecord, InstanceID = %1, RecordNumber = %2, EventTime = %3, ActivityDefinitionId = %4, 이유 %5, Annotations = %6, ProfileName = %7, WorkflowDefinitionIdentity = %8 =|HealthMonitoring, WFTracking|  
...
|[440 - StartSignpostEvent1](440-startsignpostevent.md)|정보|동작 경계입니다.|WFServices 문제 해결|  
|[441- StopSignpostEvent1](441-stopsignpostevent.md)|정보|동작 경계입니다.|WFServices 문제 해결|  
...
|[1006 - WorkflowApplicationUnhandledException](1006-workflowapplicationunhandledexception.md)|Error|WorkflowInstance Id: '%1'에 처리 되지 않은 예외가 발생 했습니다.  작업 '%2', DisplayName에서에서 발생 한 예외: '%3'.  다음 작업이 수행 됩니다. %4입니다.|WFRuntime|  
...
|[1014 - ScheduleCompletionWorkItem](1014-schedulecompletionworkitem.md)|자세히|CompletionWorkItem이 예약 된 부모 작업 '%1', DisplayName: '%2', InstanceId: '%3'.  작업 '%4', DisplayName: '%5', InstanceId: '%6'이(가) 완료되었습니다.|WFRuntime|  
...
|[1020 - CreateBookmark](1020-createbookmark.md)|자세히|작업 '%1', DisplayName에 대 한 책갈피를 만들었습니다. '%2', InstanceId: '%3'.  BookmarkName: %4, BookmarkScope: %5.|WFRuntime|  
|[1021 - ScheduleBookmarkWorkItem](1021-schedulebookmarkworkitem.md)|자세히|작업 '%1', DisplayName에 대해 BookmarkWorkItem이 예약 되었습니다. '%2', InstanceId: '%3'.  BookmarkName: %4, BookmarkScope: %5.|WFRuntime|  
|[1022 - StartBookmarkWorkItem](1022-startbookmarkworkitem.md)|자세히|작업 '%1', DisplayName에 대해 BookmarkWorkItem의 실행을 시작 합니다. '%2', InstanceId: '%3'.  BookmarkName: %4, BookmarkScope: %5.|WFRuntime|  
...
|[1029 - ScheduleFaultWorkItem](1029-schedulefaultworkitem.md)|자세히|FaultWorkItem이 예약 된 작업 '%1', DisplayName: '%2', InstanceId: '%3'.  작업 '%4', DisplayName: '%5', InstanceId: '%6'에서 예외가 전파되었습니다.|WFRuntime|  
|[1030 - StartFaultWorkItem](1030-startfaultworkitem.md)|자세히|작업 '%1', DisplayName에 대해 FaultWorkItem의 실행을 시작 합니다. '%2', InstanceId: '%3'.  작업 '%4', DisplayName: '%5', InstanceId: '%6'에서 예외가 전파되었습니다.|WFRuntime|  
...
|[1035 - RuntimeTransactionSet](1035-runtimetransactionset.md)|자세히|런타임 트랜잭션이 설정한 작업 '%1', DisplayName: '%2', InstanceId: '%3'.  실행 격리 작업 '%4', DisplayName: '%5', InstanceId: '%6'.|WFRuntime|  
...
|[1041 - WorkflowApplicationPersistableIdle](1041-workflowapplicationpersistableidle.md)|정보|WorkflowApplication Id: '%1'은 유휴 상태 이며 지속 가능 합니다.  다음 작업이 수행 됩니다. %2.|WFRuntime|  
...
|[3552 - MaxPendingMessagesPerChannelExceeded](3552-maxpendingmessagesperchannelexceeded.md)|경고|스로틀 'MaxPendingMessagesPerChannel ' 한도 '%1'에 도달 했습니다. 이 한도를 늘리려면 BufferedReceiveServiceBehavior에서 MaxPendingMessagesPerChannel 속성을 조정하세요.|할당량 WFServices|  
...
|[4212 - LockRetryTimeout](4212-lockretrytimeout.md)|경고|인스턴스 잠금을 획득 하려고 하는 데 시간이 초과 되었습니다.  할당된 시간 제한인 %1 내에 작업을 완료하지 못했습니다. 이 작업에 할당된 시간은 더 긴 시간 제한의 일부였을 수 있습니다.|WFInstanceStore|  
