...
5. **Sequence** 활동을 선택 합니다. 속성 창에서 ... **구현 된 Edcontract** 속성의 단추입니다. 표시 되는 **형식 컬렉션 편집기** 창에서 **형식** 드롭다운을 클릭 하 고 **형식 찾아보기** ...를 선택 합니다. 엔트리의. **.Net 형식 찾아보기 및 선택** 대화 상자의  **\<현재 프로젝트 >** 아래에서 모든 하위 노드를 열고 **ibookservice**를 선택 합니다. **확인**을 클릭합니다. **형식 컬렉션 편집기** 대화 상자에서 **확인**을 클릭 합니다.  
