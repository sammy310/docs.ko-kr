...
이 섹션에는 마이그레이션를 처리 하는 항목이 포함 되어 있습니다. 이전 버전의 Windows WF (Workflow Foundation) 워크플로.
...
Interop 활동을 사용 하는.NET Framework 4.6.1 워크플로 내에서.NET Framework 3.5 활동을 포함 하는 방법에 대 한 정보를 포함 합니다.
