...
8. [수준 2 투명도](https://aka.ms/Level2Transparency) 를 사용 하는 단일 어셈블리는 .NET Framework 4, [!INCLUDE[netfx_current_short](../../../includes/netfx-current-short-md.md)] 완전 신뢰 및 부분 신뢰에서 사용할 수 없습니다 [!INCLUDE[netfx_current_short](../../../includes/netfx-current-short-md.md)] .
