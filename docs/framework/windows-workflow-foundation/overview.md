...
## <a name="interaction-between-workflow-components"></a>워크플로 구성 요소 간의 상호 작용  
 ...
 ![워크플로 상호 작용](./media/workflowinteraction.gif "WorkflowInteraction")  
