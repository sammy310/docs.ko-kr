...
## <a name="using-the-formattedtext-object"></a>FormattedText 개체 사용  
 ...
 ![FormattedText 개체를 사용 하 여 표시 되는 텍스트](./media/formattedtext02.png "FormattedText02")  
...
스트로크와 강조 표시에 적용된 이미지 브러시의 예  
 ...
 ![텍스트의 pathgeometry를 따르는 구](./media/textpathgeometry01.gif "TextPathGeometry01")  
텍스트의 PathGeometry를 따르는 구  
 ...
 ![텍스트의 pathgeometry에 비디오 표시](./media/videotextdemo01.png "VideoTextDemo01")  
