 ...
 **참고** 간단히 하기 위해 위의 예제에서는 파일이 xps 임을 테스트 하 \*는 데 사용 되는 .xps 확장명의 존재를 사용 합니다. 그러나 XPS 파일에는이 확장이 필요 하지 않습니다. [Isxps (Isxps 규칙 도구)](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/aa348104(v=vs.100)) 는 파일에서 XPS 유효성을 검사 하는 한 가지 방법입니다.  
