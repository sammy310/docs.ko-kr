...
## <a name="highlights"></a>강조 표시  
 사람들은 종이 문서에 표시할 때 밑줄 긋기, 강조 표시, 문장에 포함된 단어에 동그라미 표시, 여백에 표식이나 주석 그리기 등의 창조적인 방법으로 관심 있는 항목에 주의를 끌도록 합니다.  Microsoft 주석 프레임 워크의 주석 강조 표시는 WPF 문서 보기 컨트롤에 표시 되는 정보를 표시 하는 유사한 기능을 제공 합니다.  
  
 다음 그림에서는 강조 표시 주석의 예를 보여 줍니다.  
  
 ![주석 강조 표시](./media/caf-callouts.png "CAF_Callouts")  
