...
```  
 ...
 일부 XAML 판독기에서이 특성을 인식 하므로 것을 사용 하는 합니다 [mc: Ignorable 특성](mc-ignorable-attribute.md) 표시는 `Presentation:Freeze` 특성을 무시할 수:  
...
```  
 ...
 자세한 내용은 참조는 [mc: Ignorable 특성](mc-ignorable-attribute.md) 페이지입니다.  
