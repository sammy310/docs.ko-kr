...
## <a name="example"></a>예제  
 ...
 마지막으로, <xref:System.Windows.Input.CommandBinding>은 라우팅된 이벤트 처리기를 <xref:System.Windows.Input.ApplicationCommands.Open%2A> 명령에 연결하는 애플리케이션의 <xref:System.Windows.Window> 루트에 만들어집니다.  
