...
## <a name="remarks"></a>설명  
 ...
 `http://schemas.openxmlformats.org/markup-compatibility/2006` 네임 스페이스는 SDK의이 영역에 문서화 되지 않은 다른 요소와 특성을 정의 합니다. 자세한 내용은 [XML 태그 호환성 사양](https://docs.microsoft.com/office/open-xml/introduction-to-markup-compatibility#markup-compatibility-in-the-open-xml-file-formats-specification)을 참조 하세요.  
