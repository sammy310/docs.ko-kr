...
ms.locfileid: "61776183"
---
# <a name="how-to-drag-and-drop-ink"></a><span data-ttu-id="0784b-102">방법: 잉크 끌어서 놓기</span><span class="sxs-lookup"><span data-stu-id="0784b-102">How to: Drag and Drop Ink</span></span>
## <a name="example"></a><span data-ttu-id="0784b-103">예제</span><span class="sxs-lookup"><span data-stu-id="0784b-103">Example</span></span>  
 <span data-ttu-id="0784b-104">다음 예제에서는 응용 프로그램 하나에서 선택된 된 스트로크를 끌어서 놓을 수 있도록 <xref:System.Windows.Controls.InkCanvas> 다른 합니다.</span><span class="sxs-lookup"><span data-stu-id="0784b-104">The following example creates an application that enables the user to drag selected strokes from one <xref:System.Windows.Controls.InkCanvas> to the other.</span></span>  
