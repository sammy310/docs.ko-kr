...
## <a name="example"></a>예제  
 ...
 다음 XAML은 <xref:System.Windows.Controls.StackPanel>, <xref:System.Windows.Controls.TextBlock>및 <xref:System.Windows.Controls.TextBox>구성 되는 사용자 인터페이스를 만듭니다.  
  
 [!code-xaml[keydown#KeyDownUI](~/samples/snippets/csharp/VS_Snippets_Wpf/KeyDown/CSharp/Window1.xaml#keydownui)]  
  
 다음 코드는 <xref:System.Windows.UIElement.KeyDown> 이벤트 처리기를 만듭니다.  누른 키가 <xref:System.Windows.Input.Key.Enter> 키 이면 메시지가 <xref:System.Windows.Controls.TextBlock>에 표시 됩니다.  
