 ...
 **FlowDirection를 보여 주는 그래픽**  
 ...
 ![TextBlock 맞춤](./media/lefttorightrighttoleft.PNG "LefttoRightRighttoLeft")  
 ...
 **지정된 FlowDirection을 명시적으로 보여 주는 그래픽**  
 ...
 ![흐름 방향 설명](./media/flowdir.PNG "FlowDir")  
 ...
 **Span 요소를 사용하여 설명하는 그래픽**  
 ...
 ![오른쪽에서 왼쪽으로 진행되는 문서](./media/flowdocument.PNG "FlowDocument")  
 ...
 **Span 요소에 포함된 Run 요소를 사용하여 설명하는 그래픽**  
 ...
 ![XamlPad 스크린 샷](./media/runspan.PNG "RunSpan")  
 ...
 **여러 TextBlock 요소로 FlowDirection을 보여주는 그래픽**  
 ...
 ![흐름 방향이 다른 텍스트 블록](./media/span.PNG "범위")  
 ...
 **FlowDirection만을 사용하여 숫자를 표시하는 그래픽**  
 ...
 ![오른쪽에서 왼쪽으로 진행되는 숫자](./media/langattribute.PNG "LangAttribute")  
 ...
 **xml: lang 특성을 사용하여 설명하는 그래픽**  
 ...
 ![오른쪽에서 왼쪽으로 진행되는 아랍어 숫자](./media/langattribute2.PNG "LangAttribute2")  
 ...
 **그라데이션이 왼쪽에서 오른쪽인 도구 모음을 표시하는 그래픽**  
 ...
 ![그라데이션 스크린 샷](./media/gradient.PNG "그라데이션")  
 ...
 **그라데이션이 오른쪽에서 왼쪽인 도구 모음을 표시하는 그래픽**  
 ...
 ![오른쪽에서 왼쪽으로 진행되는 그라데이션](./media/gradient2-wpf.PNG "Gradient2_WPF")  
 ...
 **대칭 이동된 이미지를 보여주는 그래픽**  
 ...
 ![XamlPad 스크린 샷](./media/image.PNG "이미지")  
 ...
 **표시되는 아랍어 및 영어 숫자를 표시하는 그래픽**  
 ...
 ![숫자가 있는 XamlPad 스크린 샷](./media/numbers.PNG "번호")  
 ...
 **아랍어 숫자를 표시하는 그래픽**  
 ...
 ![아랍어 숫자](./media/numbers2.PNG "Numbers2")  
