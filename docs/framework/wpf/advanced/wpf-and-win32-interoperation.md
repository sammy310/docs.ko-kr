...
- 모든 [!INCLUDE[TLA2#tla_dll](../../../../includes/tla2sharptla-dll-md.md)] C# [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] 페이지를 컴파일된 어셈블리로 포함 하는 DLL을 만든 다음 C++ 실행 파일에 참조로 포함 되도록 합니다.  
  
- [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 콘텐츠에 대 C# 한 실행 파일을 만들고 [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] 콘텐츠를 포함 하는 C++ [!INCLUDE[TLA2#tla_dll](../../../../includes/tla2sharptla-dll-md.md)] 을 참조 하도록 합니다.  
