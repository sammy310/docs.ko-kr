...
---
# <a name="build-and-deploy-how-to-topics"></a>빌드 및 배포 방법 도움말 항목

다음 항목에서는 다양 한 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 응용 프로그램 유형에 대 한 프로젝트 파일을 만드는 방법을 보여 줍니다.
...
- [설치 된 WPF 버전 확인 (.NET Framework 3.5)](https://docs.microsoft.com/previous-versions/dotnet/netframework-3.5/aa349641(v=vs.90))
