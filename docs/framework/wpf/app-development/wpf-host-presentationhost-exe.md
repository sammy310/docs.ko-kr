...
-   [!INCLUDE[TLA#tla_xbap](../../../../includes/tlasharptla-xbap-md.md)] (.xbap)입니다.  
...
|-launchApplication \<url>|지정된 URL에서 독립 실행형 [!INCLUDE[ndptecclick](../../../../includes/ndptecclick-md.md)] 애플리케이션을 실행합니다. [!INCLUDE[TLA2#tla_iegeneric](../../../../includes/tla2sharptla-iegeneric-md.md)] 및.NET 응용 프로그램에 관한 WinINet 보안 정책이 적용 됩니다.|  
