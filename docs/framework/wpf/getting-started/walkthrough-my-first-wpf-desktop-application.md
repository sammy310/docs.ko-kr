...
*Expensereportpage.xaml* 는 **`ExpenseItHome`** 페이지에서 선택한 사용자에 대 한 경비 보고서를 표시 합니다. 이 섹션에서는 **expensereportpage.xaml**에 대 한 UI를 만듭니다. 또한 다양 한 UI 요소에 배경 및 채우기 색을 추가 합니다.
