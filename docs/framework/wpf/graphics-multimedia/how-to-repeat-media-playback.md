...
ms.locfileid: "57371054"
---
# <a name="how-to-repeat-media-playback"></a>방법: 미디어 재생 반복
이 예제에서는 미디어를 무기한 재생하는 방법, 즉 무한 루프로 재생되도록 설정하는 방법을 보여 줍니다.  
  
## <a name="example"></a>예제  
 다음 예제에서는 <xref:System.Windows.Controls.MediaElement> 및 <xref:System.Windows.Media.MediaTimeline> 에 <xref:System.Windows.Media.Animation.Storyboard> 미디어 클립을 무한 루프로 재생 합니다.  
