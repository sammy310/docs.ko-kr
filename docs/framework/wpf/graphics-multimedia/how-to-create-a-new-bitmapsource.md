...
이 예제를 사용 하는 방법에 설명 합니다 <xref:System.Windows.Media.Imaging.BitmapSource.Create%2A> 메서드의 <xref:System.Windows.Media.Imaging.BitmapSource> 새 <xref:System.Windows.Media.Imaging.BitmapSource> 개체입니다.  
