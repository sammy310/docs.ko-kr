...
ms.locfileid: "61910015"
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="b51d4-102">방법: BitmapSource를 인덱싱된 픽셀 형식으로 변환</span><span class="sxs-lookup"><span data-stu-id="b51d4-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="b51d4-103">변환 하는 방법을 보여 주는이 예제는 <xref:System.Windows.Media.Imaging.BitmapSource> 인덱싱된 픽셀 형식입니다.</span><span class="sxs-lookup"><span data-stu-id="b51d4-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="b51d4-104">예제</span><span class="sxs-lookup"><span data-stu-id="b51d4-104">Example</span></span>  
