...
- **금지 api**: 소스 코드를 검색 하 여와 `strcpy`같은 보안 문제를 일으킬 수 있는 잘 알려진 함수를 실수로 사용 하는지 확인 합니다. 이러한 함수는 식별 된 후 보다 안전한 대체 항목으로 바뀝니다.  
...
- **다른 제품의 보안 문제 몇 개입니까**: 해당 하는 경우 관련 제품의 보안 문제를 테스트 합니다. 예를 들어 Internet Explorer에 대 한 약 60 보안 문제의 적절 한 변형이 식별 되 고에 [!INCLUDE[TLA2#tla_winclient](../../../includes/tla2sharptla-winclient-md.md)]대 한 적용이 적용 됩니다.  
