...
이 항목에서는 <xref:System.Windows.Controls.DatePicker> 컨트롤의 스타일 및 템플릿에 대해 설명 합니다. 기본 <xref:System.Windows.Controls.ControlTemplate>를 수정 하 여 컨트롤에 고유한 모양을 제공할 수 있습니다. 자세한 내용은 [컨트롤에 대 한 템플릿 만들기](../../../desktop-wpf/themes/how-to-create-apply-template.md)를 참조 하세요.  
...
|사용 안 함|CommonStates|<xref:System.Windows.Controls.DatePicker> 사용 하지 않도록 설정 되었습니다.|  
...
|-|-|-|  
|보통|CommonStates|기본 상태입니다.|  
|사용 안 함|CommonStates|<xref:System.Windows.Controls.Primitives.DatePickerTextBox> 사용 하지 않도록 설정 되었습니다.|  
|MouseOver|CommonStates|마우스 포인터가 <xref:System.Windows.Controls.Primitives.DatePickerTextBox>위에 배치 됩니다.|  
|읽기 전용|CommonStates|사용자는 <xref:System.Windows.Controls.Primitives.DatePickerTextBox>의 텍스트를 변경할 수 없습니다.|  
