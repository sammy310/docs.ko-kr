...
## <a name="example"></a>예제  
 다음 예제에서는 <xref:System.Windows.Controls.Canvas>의 <xref:System.Windows.Controls.Panel.Background%2A> 속성을 <xref:System.Windows.Controls.Primitives.Selector.SelectedItem%2A>에 바인딩하는 방법을 보여 줍니다.<xref:System.Windows.Controls.ContentControl.Content%2A> <xref:System.Windows.Controls.ComboBox>의 속성:  
