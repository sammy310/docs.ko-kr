...
[!INCLUDE[net_security_note](../../../includes/net-security-note-md.md)]  
 ...
 투명도를 통해 개발자는 부분적으로 신뢰할 수 있는 코드에 기능을 노출하는 더 안전한 .NET Framework 라이브러리를 작성할 수 있습니다. 수준 1 투명도는 .NET Framework 버전 2.0에서 새로 추가되었고 주로 Microsoft 내에서만 사용됩니다. .NET Framework 4부터 [수준 2 투명도](security-transparent-code-level-2.md)를 사용할 수 있습니다. 그러나 이전 보안 규칙과 함께 실행되어야 하는 레거시 코드를 식별할 수 있도록 수준 1 투명도가 유지되었습니다.  
