...
|E_ CORPROF_E_CALLBACK3_REQUIRED|프로파일러가 분리 작업을 지원 하기 위해 구현 해야 하는 [ICorProfilerCallback3](../../../../docs/framework/unmanaged-api/profiling/icorprofilercallback3-interface.md) 인터페이스에 대 한 [IUnknown:: QueryInterface](https://go.microsoft.com/fwlink/?LinkID=144867) 시도에 실패 했습니다. 분리가 시도되지 않았습니다.|  
