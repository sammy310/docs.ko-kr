...
## <a name="remarks"></a>설명  
 ...
 FunctionID 값의 대안은 [](functionenter3withinfo-function.md) [FunctionLeave3WithInfo](icorprofilerinfo3-setenterleavefunctionhooks3-method.md) 또는 [FunctionTailcall3WithInfo](icorprofilerinfo3-setenterleavefunctionhooks3withinfo-method.md) 메서드에서 지정 하는 프로파일러의 함수 진입/종료 후크 ([FunctionEnter3](functionenter3-function.md), [](functionleave3withinfo-function.md) [FunctionLeave3](functionleave3-function.md), and [SetEnterLeaveFunctionHooks3](functiontailcall3withinfo-function.md))에 전달 됩니다. [](functiontailcall3-function.md)  
