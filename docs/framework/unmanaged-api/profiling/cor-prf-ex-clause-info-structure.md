...
## <a name="remarks"></a>주의  
 예외 알림이 수신 되 면 [ICorProfilerInfo2:: GetNotifiedExceptionClauseInfo](icorprofilerinfo2-getnotifiedexceptionclauseinfo-method.md) 를 사용 하 여 실행 되거나 방금 실행 된 예외 절 (`catch`/`finally`/tfilter)의 기본 주소 및 프레임 정보를 가져올 수 있습니다.  
