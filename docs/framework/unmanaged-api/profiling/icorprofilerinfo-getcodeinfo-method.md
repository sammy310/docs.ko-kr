...
지정된 함수 ID와 연결된 네이티브 코드의 범위를 가져옵니다.  
 ...
 이 메서드는 사용되지 않습니다. Use the [ICorProfilerInfo2::GetCodeInfo2](../../../../docs/framework/unmanaged-api/profiling/icorprofilerinfo2-getcodeinfo2-method.md) method instead.  
