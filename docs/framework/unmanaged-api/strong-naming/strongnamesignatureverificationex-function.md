...
## <a name="remarks"></a>설명  
 ...
 `StrongNameSignatureVerificationEx`[StrongNameSignatureVerification](strongnamesignatureverification-function.md) 함수와 비슷한 기능을 제공 합니다. 그러나에 대 한 두 번째 입력 매개 변수 및 출력 매개 변수는 `StrongNameSignatureVerificationEx` 대신 형식입니다 `BOOLEAN` `DWORD` .  
