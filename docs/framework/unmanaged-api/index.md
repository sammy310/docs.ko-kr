...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [사용자 지정 인터페이스 특성](/previous-versions/dotnet/netframework-4.0/ms231946(v=vs.100))  
 ...
 [진단 기호 저장소](./diagnostics/index.md)  
