...
## <a name="remarks"></a>주의  
 ...
 이 [ICorPublish](icorpublish-interface.md) 인스턴스에서 `EnumProcesses` 메서드를 두 번 이상 호출 하 여 새로운 최신 프로세스 컬렉션을 만들 수 있습니다. 기존 컬렉션은 `EnumProcesses` 메서드에 대 한 후속 호출의 영향을 받지 않습니다.  
