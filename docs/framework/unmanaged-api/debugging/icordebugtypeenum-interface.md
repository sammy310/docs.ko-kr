...
|메서드|설명|  
|------------|-----------------|  
|[Next 메서드](../../../../docs/framework/unmanaged-api/debugging/icordebugtypeenum-next-method.md)|현재 위치에서 시작 하 `ICorDebugType` 여 열거형에서 지정 된 수의 인스턴스를 가져옵니다.|  
