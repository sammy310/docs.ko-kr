...
## <a name="parameters"></a>매개 변수  
 `imageBaseAddress`  
 【인】 모듈의 기본 주소를 나타내는 [CORDB_ADDRESS](../../../../docs/framework/unmanaged-api/common-data-types-unmanaged-api-reference.md) 값입니다.  
  
 `ppSymProvider`  
 【아웃】 [ICorDebugSymbol공급자](icordebugsymbolprovider-interface.md) 개체의 주소에 대한 포인터입니다.  
