...
## <a name="remarks"></a>설명  
 이 열거형은 [ICorDebugProcess6:GetExportStepInfo](../../../../docs/framework/unmanaged-api/debugging/icordebugprocess6-getexportstepinfo-method.md) 메서드에서 관리되는 코드를 단계별로 단계별로 처리하는 데 사용됩니다.  
