...
## <a name="remarks"></a>주의  
 이 메서드는 공용 언어 런타임이 초기화 될 때까지 호출 되지 않습니다. 대부분의 [ICorDebug](../../../../docs/framework/unmanaged-api/debugging/icordebug-interface.md) 메서드는 `CreateProcess` 콜백 전에 CORDBG_E_NOTREADY를 반환 합니다.  
