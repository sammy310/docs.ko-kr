...
|메서드|설명|  
|------------|-----------------|  
|[Next 메서드](../../../../docs/framework/unmanaged-api/debugging/icorpublishappdomainenum-next-method.md)|지정 된 수를 가져옵니다 `ICorPublishAppDomain` 현재 위치부터 컬렉션의 인스턴스.|  
  
## <a name="remarks"></a>설명  
 합니다 `ICorPublishAppDomainEnum` 추상 인터페이스의 메서드를 구현 하는 인터페이스 [ICorPublishEnum](../../../../docs/framework/unmanaged-api/debugging/icorpublishenum-interface.md)합니다.  
