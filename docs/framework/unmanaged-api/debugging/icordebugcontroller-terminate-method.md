...
> [!NOTE]
> 이 메서드는 Win32 `TerminateProcess` 함수에 대 한 래퍼입니다. 따라서는 `Terminate` Win32 `TerminateProcess` 함수에서 사용 하는 것과 동일한 방식으로 종료 코드를 사용 합니다.  
