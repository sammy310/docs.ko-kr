...
## <a name="remarks"></a>주의  
 [ICorDebugProcess6::D ecodeevent](../../../../docs/framework/unmanaged-api/debugging/icordebugprocess6-decodeevent-method.md) 메서드에는 디버그 이벤트에 대 한 추가 정보를 제공 하 고 해당 값이 대상 아키텍처에 따라 달라 지는 `dwFlags` 매개 변수가 포함 되어 있습니다. `CorDebugDecodeEventFlagsWindows` 열거형을 Windows 플랫폼의 디버그 이벤트와 함께 사용할 수 있습니다.  
