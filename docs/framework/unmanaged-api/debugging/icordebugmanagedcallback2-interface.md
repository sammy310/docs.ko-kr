...
## <a name="remarks"></a>주의  
 ...
 디버거는 .NET Framework 2.0 응용 프로그램을 디버깅 하는 경우 `ICorDebugManagedCallback2`를 구현 해야 합니다. `ICorDebugManagedCallback` 또는 `ICorDebugManagedCallback2`의 인스턴스는 [ICorDebug:: SetManagedHandler](icordebug-setmanagedhandler-method.md)에 콜백 개체로 전달 됩니다.  
