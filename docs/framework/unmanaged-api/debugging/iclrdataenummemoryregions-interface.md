...
|메서드|설명|  
|------------|-----------------|  
|[EnumMemoryRegions 메서드](../../../../docs/framework/unmanaged-api/debugging/iclrdataenummemoryregions-enummemoryregions-method.md)|지정 된 메모리 영역을 열거 합니다.|  
