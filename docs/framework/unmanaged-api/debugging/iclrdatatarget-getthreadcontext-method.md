...
## <a name="parameters"></a>매개 변수  
 ...
 `context` 버퍼의 데이터는 Win32 `CONTEXT` 구조 형식 이어야 합니다. 컨텍스트는 프로세서 관련 레지스터 데이터를 지정 하므로 Win32 `CONTEXT` 구조의 정의는 프로세서의 아키텍처에 따라 달라 집니다. Win32 `CONTEXT` 구조체의 정의는 Winnt.exe 헤더 파일을 참조 하세요.  
