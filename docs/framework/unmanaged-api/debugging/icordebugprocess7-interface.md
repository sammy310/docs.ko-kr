...
|메서드|설명|  
|------------|-----------------|  
|[SetWriteableMetadataUpdateMode 메서드](icordebugprocess7-setwriteablemetadataupdatemode-method.md)|대상 프로세스 내에서 디버거가 메타데이터에 대한 메모리 내 업데이트 처리 방법을 결정하는 값을 설정합니다.|  
