...
|[GetManagedCopy 메서드](icordebugobjectvalue-getmanagedcopy-method.md)|더 이상 사용되지 않습니다. 이 메서드를 호출 하지 마십시오.|  
...
|[SetFromManagedCopy 메서드](icordebugobjectvalue-setfrommanagedcopy-method.md)|더 이상 사용되지 않습니다. 이 메서드를 호출 하지 마십시오.|  
