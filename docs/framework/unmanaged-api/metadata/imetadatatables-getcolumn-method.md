...
`pVal`를 통해 반환 되는 값의 interpretion는 열의 형식에 따라 달라 집니다. 열 유형은 [IMetaDataTables. GetColumnInfo](imetadatatables-getcolumninfo-method.md)을 호출 하 여 확인할 수 있습니다.
...
| `iLONG` (98)             | Int32         |                                        | 
| `iULONG` (99)            | UInt32        |                                        |
| `iBYTE` (100)            | 바이트          | 자동으로 32 비트에 자동으로 서명 합니다.  |
