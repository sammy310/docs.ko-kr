...
|메서드|설명|  
|------------|-----------------|  
|[GetMetaDataStorage 메서드](../../../../docs/framework/unmanaged-api/metadata/imetadatatables2-getmetadatastorage-method.md)|지정된 된 섹션에 저장 된 메타 데이터의 내용을 확인 하 고 크기를 가져옵니다.|  
