...
|`tdWindowsRuntime`|<span data-ttu-id="a0a07-130">이 형식이 Windows 런타임 형식이 되도록 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="a0a07-130">Specifies that this type is a Windows Runtime type.</span></span>|  
