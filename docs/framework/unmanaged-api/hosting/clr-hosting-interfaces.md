...
## <a name="in-this-section"></a>단원 내용  
 ...
 호스트에서 Win32 `CreateMemoryResourceNotification` 함수와 비슷한 방법을 사용 하 여 메모리 압력 상태를 보고할 수 있도록 합니다.  
 ...
 호스트 컨트롤 인터페이스를 설정 하는 추가 메서드를 사용 하 여 [ICorRuntimeHost](../../../../docs/framework/unmanaged-api/hosting/icorruntimehost-interface.md)와 유사한 기능을 제공 합니다.  
 ...
 [SetGCStartupLimitsEx](../../../../docs/framework/unmanaged-api/hosting/igchost2-setgcstartuplimitsex-method.md) 메서드를 제공 합니다 .이 메서드는 호스트에서 가비지 수집 세그먼트의 크기와 가비지 수집 시스템의 최대 크기를 `DWORD`보다 큰 값으로 설정할 수 있도록 합니다.  
