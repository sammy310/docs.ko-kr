...
호스트가 힙에서 지정된 양의 메모리를 할당해 달라는 요청입니다.  
...
## <a name="remarks"></a>설명  
 CLR은 `IHostMalloc` [IHostMemoryManager::CreateMalloc](../../../../docs/framework/unmanaged-api/hosting/ihostmemorymanager-createmalloc-method.md) 메서드를 호출하여 인스턴스에 대한 인터페이스 포인터를 가져옵니다.  
