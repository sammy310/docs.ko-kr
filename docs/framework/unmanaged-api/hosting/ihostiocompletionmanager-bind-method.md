...
## <a name="parameters"></a>매개 변수  
 `hPort`  
 진행 `hHandle`바인딩할 i/o 완료 포트입니다. `hPort`의 값이 null 이면 `hHandle`는 기본 i/o 완료 포트에 바인딩됩니다.  
  
 `hHandle`  
 진행 `hPort`바인딩할 운영 체제 핸들입니다.  
...
## <a name="remarks"></a>주의  
 I/o 완료 포트는 `CreateIoCompletionPort`에 대 한 호출을 사용 하 여 생성 됩니다. CLR은 `Bind`를 호출 하 여 해당 포트에 핸들을 바인딩합니다.  
