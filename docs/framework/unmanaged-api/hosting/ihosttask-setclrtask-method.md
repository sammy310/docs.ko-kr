...
## <a name="remarks"></a>설명  
 CLR 호출 `SetCLRTask` 연결 하는 `ICLRTask` 현재 인스턴스와 `IHostTask` 인스턴스를 호출 하 여 만든 [ihosttaskmanager:: Createtask](../../../../docs/framework/unmanaged-api/hosting/ihosttaskmanager-createtask-method.md)합니다.  
