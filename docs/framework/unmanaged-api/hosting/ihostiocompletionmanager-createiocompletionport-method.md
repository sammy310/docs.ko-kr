...
## <a name="remarks"></a>설명  
 CLR에서는 `CreateIoCompletionPort` 만들도록 새 I/O 완료 포트를 호스트에 요청 하는 방법입니다. I/O 작업에 대 한 호출을 통해이 포트에 바인딩되기는 [ihostiocompletionmanager:: Bind](../../../../docs/framework/unmanaged-api/hosting/ihostiocompletionmanager-bind-method.md) 메서드. 호스트 상태를 보고 다시 CLR에 호출한 [iclriocompletionmanager:: Oncomplete](../../../../docs/framework/unmanaged-api/hosting/iclriocompletionmanager-oncomplete-method.md)합니다.  
