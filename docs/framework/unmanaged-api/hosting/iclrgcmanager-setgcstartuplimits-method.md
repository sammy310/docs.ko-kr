...
> [!IMPORTANT]
> .NET Framework 4.5부터 [ICLRGCManager2:: SetGCStartupLimitsEx](../../../../docs/framework/unmanaged-api/hosting/iclrgcmanager2-setgcstartuplimitsex-method.md) 메서드를 사용 하 여 세그먼트 크기와 최대 0 세대 크기를 `DWORD` 보다 큰 값으로 설정할 수 있습니다.  
...
## <a name="remarks"></a>주의  
 `SetGCStartupLimits` 설정 하는 값은 한 번만 지정할 수 있습니다. `SetGCStartupLimits`에 대 한 이후 호출은 무시 됩니다.  
