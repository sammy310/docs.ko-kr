...
CLR (공용 언어 런타임)에서 [ICLRSyncManager:: CreateRWLockOwnerIterator](../../../../docs/framework/unmanaged-api/hosting/iclrsyncmanager-createrwlockowneriterator-method.md)를 호출 하 여 만든 반복기를 소멸 시 키 지 않도록 요청 합니다.  
...
## <a name="parameters"></a>매개 변수  
 `Iterator`  
 진행 `CreateRWLockOwnerIterator`에 대 한 호출을 사용 하 여 만든 반복기입니다.  
...
## <a name="remarks"></a>주의  
 호스트는이 메서드를 호출 하 고 `CreateRWLockOwnerIterator` 하 여 해당 스레딩 구현이 동기화 된 상태로 유지 되도록 할 수 있습니다.  
