...
## <a name="parameters"></a>매개 변수  
 ...
 `ulAppDomainId`  
 진행 현재 <xref:System.AppDomain>의 식별자입니다.  
  
 `ulFlags`  
 진행 수행 해야 하는 유효성 검사의 종류를 나타내는 [ValidatorFlags](../../../../docs/framework/unmanaged-api/hosting/validatorflags-enumeration.md) 값의 조합입니다.  
