...
## <a name="parameters"></a>매개 변수  
 ...
 `option`  
 진행 이 작업이 차단 되는 경우 호스트에서 수행할 작업을 나타내는 [WAIT_OPTION](../../../../docs/framework/unmanaged-api/hosting/wait-option-enumeration.md) 열거형 값 중 하나입니다.  
...
## <a name="remarks"></a>주의  
 일반적으로 CLR은 사용자 코드에서 <xref:System.Threading.Thread.Sleep%2A?displayProperty=nameWithType>를 호출할 때 `IHostTaskManager::Sleep`를 호출 합니다.  
