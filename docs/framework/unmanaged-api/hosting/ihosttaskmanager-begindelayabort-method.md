...
관리 코드는 호스트는 현재 작업 중단할 수 없는 기간이 시작 됨을 알립니다.  
...
## <a name="remarks"></a>설명  
 호스트 될 때까지 현재 작업을 중단 하지 해야 `EndDelayAbort` 라고 합니다. 다시 호출 하는 경우 `BeginDelayAbort` 에 대 한 중간 호출 없이 이루어집니다 `EndDelayAbort`, 호스트에서 E_UNEXPECTED를 반환 해야 `BeginDelayAbort`, 어떠한 작업도 해야 합니다.  
