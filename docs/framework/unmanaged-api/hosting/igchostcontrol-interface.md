---
description: '자세히 알아보기: IGCHostControl 인터페이스'
...
|메서드|설명|  
|------------|-----------------|  
|[RequestVirtualMemLimit 메서드](igchostcontrol-requestvirtualmemlimit-method.md)|가상 메모리의 한도를 변경 하도록 호스트에 요청 합니다.|  
