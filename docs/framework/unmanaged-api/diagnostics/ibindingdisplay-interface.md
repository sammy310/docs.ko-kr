...
|메서드|설명|  
|------------|-----------------|  
|[GetCurrentDisplay 메서드](../../../../docs/framework/unmanaged-api/diagnostics/ibindingdisplay-getcurrentdisplay-method.md)|Returns the current binding display information.|  
