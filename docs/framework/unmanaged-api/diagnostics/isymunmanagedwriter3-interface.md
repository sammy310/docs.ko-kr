...
|메서드|설명|  
|------------|-----------------|  
|[Commit 메서드](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedwriter3-commit-method.md)|지금까지 작성 된 변경 내용을 스트림에 커밋합니다.|  
|[OpenMethod2 메서드](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedwriter3-openmethod2-method.md)|메서드를 열고 이미지의 실제 섹션 오프셋을 제공 합니다.|  
