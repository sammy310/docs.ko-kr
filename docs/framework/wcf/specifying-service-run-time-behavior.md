...
## <a name="overview"></a>개요  
 ...
 이 항목에서는 <xref:System.ServiceModel.ServiceBehaviorAttribute> 및 <xref:System.ServiceModel.OperationBehaviorAttribute> 특성의 개요를 제공 하 고, 동작이 작동할 수 있는 다양 한 범위를 설명 하 고, WCF에 관심을 가질 수 있는 다양 한 범위에서 시스템에서 제공 하는 여러 동작에 대 한 간략 한 설명을 제공 합니다. 가.  
