...
### <a name="enabling-wcf-diagnostics-settings"></a>WCF 진단 설정 사용  
 WCF 진단은 \<System.servicemodel >\<진단 > 구성 섹션에서 사용할 수 있습니다.  
...
### <a name="channels"></a>채널  
 ...
 [!INCLUDE[netfx_current_short](../../../../../includes/netfx-current-short-md.md)] WCF의 분석 추적 기능은 Microsoft-Windows 응용 프로그램-서버-응용 프로그램 채널에 기록 합니다. 이 채널은 프로덕션 환경에서 WCF 서비스의 상태를 모니터링 하려는 사용자를 위해 특별히 설계 되었습니다. 이 채널에는 다양한 상태 모니터링 및 문제 해결 시나리오에서 사용할 수 있는 작은 이벤트 집합이 정의됩니다.  
