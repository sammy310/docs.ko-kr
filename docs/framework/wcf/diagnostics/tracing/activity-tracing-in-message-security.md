...
## <a name="negotiationsct-exchange"></a>협상/SCT 교환  
 협상/s c T 교환 단계에서는 두 활동 유형에 클라이언트에서 생성 됩니다. "Set up Secure Session" 및 "Close Secure Session." "Set up Secure Session"은 RST/RSTR/SCT 메시지 교환에 대한 추적을 포함하고, "Close Secure Session"은 취소 메시지에 대한 추적을 포함합니다.  
