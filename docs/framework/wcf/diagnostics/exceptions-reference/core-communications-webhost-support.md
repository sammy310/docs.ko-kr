...
|Hosting_ProcessNotExecutingUnderHostedContext|지정 된 호스팅 프로세스는 현재 호스팅 환경 내에서 호출할 수 없습니다. 이 API는 IIS(인터넷 정보 서비스) 또는 Windows Process Activation Service에서 호스팅되는 호출 애플리케이션이 필요합니다.|
