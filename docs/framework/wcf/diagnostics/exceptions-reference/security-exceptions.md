...
|CannotPerformS4UImpersonationOnPlatform|지정 된 계약에 대해 지정 된 바인딩은 Windows Server 2003 및 최신 버전의 Windows 에서만 가장을 지원 합니다. 취소를 사용하도록 설정된 보안 대화와 함께 SspiNegotiated 인증 및 바인딩을 사용하십시오.|
