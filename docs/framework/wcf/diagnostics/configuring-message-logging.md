...
|-|------------------|---------------------|----------------|-------------------|
|서비스 모델 계층|서비스<br /><br /> Level<br /><br /> 보내기<br /><br /> 요청|서비스<br /><br /> Level<br /><br /> 수신<br /><br /> 요청|서비스<br /><br /> Level<br /><br /> 보내기<br /><br /> 회신|서비스<br /><br /> Level<br /><br /> 수신<br /><br /> 회신|
|전송 계층|전송<br /><br /> 보내기|전송<br /><br /> 수신|전송<br /><br /> 보내기|전송<br /><br /> 수신|

단방향 요청의 경우

||요청 보내기|요청 받기|
|-|------------------|---------------------|
|서비스 모델 계층|서비스<br /><br /> Level<br /><br /> 보내기<br /><br /> 데이터그램|서비스<br /><br /> Level<br /><br /> 수신<br /><br /> 데이터그램|
|전송 계층|전송<br /><br /> 보내기|전송<br /><br /> 수신|
