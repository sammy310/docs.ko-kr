...
3. 추적 수준 링크를 클릭 하 여 추적 수준을 조정 합니다. 다음과 같은 6 가지 추적 수준이 있습니다. Off, Critical, Error, Warning, Information 및 Verbose를 표시 합니다. **활동 추적** 및 **전파 활동** 옵션을 사용 하면 WCF 활동 추적 기능을 사용할 수 있습니다.  
