...
|허용됨|true|WS-AT|트랜잭션이 상호 운용할 수 있는 WS-AT 형식으로 이동할 수 있습니다.|  
|허용됨|true|OleTransactions|트랜잭션은 WCF OleTransactions 형식으로 이동 될 수 있습니다.|  
|허용됨|false|어떤 값|트랜잭션이 이동하지 않습니다.|  
...
|트랜잭션이 예상 프로토콜 형식과 일치하지 않습니다.|허용됨|`MustUnderstand`가 `false`와 같습니다.|헤더를 인식할 수 없으므로 거부되었습니다.|  
