...
## <a name="msmq-addressing"></a>MSMQ 주소 지정  
 ...
 MSMQ 경로 및 형식 이름에 대 한 자세한 내용은 [메시지 큐 정보](/previous-versions/windows/desktop/legacy/ms706032(v=vs.85))를 참조 하세요.  
...
|`Net.msmq://<machine-name>/private/abc`|참|네이티브|`PUBLIC=some-guid` (큐의 GUID)|  
...
## <a name="msmqintegrationbinding-and-service-addressing"></a>MsmqIntegrationBinding 및 서비스 주소 지정  
 ...
 MSMQ 형식의 이름은 MSMQ에서 [메시지 큐에 대해](/previous-versions/windows/desktop/legacy/ms706032(v=vs.85))지정 하는 형식입니다.  
