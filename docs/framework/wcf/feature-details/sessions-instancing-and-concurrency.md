...
>  둘 이상의 스레드를 안전하게 사용하는 코드를 이해하고 개발하기는 쉽지 않습니다. <xref:System.ServiceModel.ConcurrencyMode.Multiple> 또는 <xref:System.ServiceModel.ConcurrencyMode.Reentrant> 값을 사용하기 전에 이러한 모드에 대해 해당 서비스가 적절하게 디자인되었는지 확인합니다. 자세한 내용은 <xref:System.ServiceModel.ServiceBehaviorAttribute.ConcurrencyMode%2A>을 참조하세요.  
 ...
 동시성 사용은 인스턴스 만들기 모드와 관련됩니다. <xref:System.ServiceModel.InstanceContextMode.PerCall> 인스턴스 만들기에서는 동시성이 관련 되지 않습니다, 새 각 메시지를 처리 하므로 <xref:System.ServiceModel.InstanceContext> 이며, 따라서 둘 이상의 스레드가 활성화는 <xref:System.ServiceModel.InstanceContext>합니다.  
...
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|  
|PerCall|-세션 채널 동작: 세션 및 <xref:System.ServiceModel.InstanceContext> 각 호출에 대 한 합니다.<br />-세션 없는 채널 동작: 예외가 throw됩니다.|-세션 채널 동작: 세션 및 <xref:System.ServiceModel.InstanceContext> 각 호출에 대 한 합니다.<br />-세션 없는 채널 동작: <xref:System.ServiceModel.InstanceContext> 각 호출에 대 한 합니다.|-세션 채널 동작: 예외가 throw됩니다.<br />-세션 없는 채널 동작: <xref:System.ServiceModel.InstanceContext> 각 호출에 대 한 합니다.|  
|PerSession|-세션 채널 동작: 세션 및 <xref:System.ServiceModel.InstanceContext> 각 채널에 대 한 합니다.<br />-세션 없는 채널 동작: 예외가 throw됩니다.|-세션 채널 동작: 세션 및 <xref:System.ServiceModel.InstanceContext> 각 채널에 대 한 합니다.<br />-세션 없는 채널 동작: <xref:System.ServiceModel.InstanceContext> 각 호출에 대 한 합니다.|-세션 채널 동작: 예외가 throw됩니다.<br />-세션 없는 채널 동작: <xref:System.ServiceModel.InstanceContext> 각 호출에 대 한 합니다.|  
|Single|-세션 채널 동작: 세션 및 하나의 <xref:System.ServiceModel.InstanceContext> 모든 호출에 대 한 합니다.<br />-세션 없는 채널 동작: 예외가 throw됩니다.|-세션 채널 동작: 세션 및 <xref:System.ServiceModel.InstanceContext> 만들거나 사용자 지정 singleton에 대 한 합니다.<br />-세션 없는 채널 동작: <xref:System.ServiceModel.InstanceContext> 만들거나 사용자 지정 singleton에 대 한 합니다.|-세션 채널 동작: 예외가 throw됩니다.<br />-세션 없는 채널 동작: <xref:System.ServiceModel.InstanceContext> 각 만들어진된 singleton 또는 사용자 지정 singleton에 대 한 합니다.|  
