...
-   <xref:System.ServiceModel.WSHttpBinding> 사용 하 여 합니다 <xref:System.ServiceModel.NonDualMessageSecurityOverHttp.EstablishSecurityContext%2A> 속성이 설정 `false`합니다.  
