...
|--------------------|-----------------|  
|보안 모드|메시지|  
|상호 운용성|Windows Communication Foundation (WCF)만 합니다.|  
...
|바인딩|<xref:System.ServiceModel.WSHttpBinding> and <xref:System.ServiceModel.NetTcpBinding>[\<wsFederationHttpBinding>](../../../../docs/framework/configure-apps/file-schema/wcf/wsfederationhttpbinding.md)|  
...
### <a name="configuration"></a>구성  
 다음 구성에서는 구성을 사용하여 동일한 엔드포인트를 설정합니다. 두 개의 바인딩 note: 하나는 신뢰할 수 있는 하위 시스템에서 호스팅되는 서비스를 보호 하 고 신뢰할 수 있는 하위 시스템과 백 엔드 서비스 사이의 통신 다른 합니다.  
