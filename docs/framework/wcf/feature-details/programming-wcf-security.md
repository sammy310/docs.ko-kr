...
> [!NOTE]
>  보안 개념, WCF 위해 특히 중요 한 정보에 MSDN의 패턴 및 실습 모음 자습서 집합을 확인할 [Scenarios, Patterns, and Implementation Guidance Web Services Enhancements (WSE) 3.0](https://go.microsoft.com/fwlink/?LinkID=88250)합니다.  
  
 WCF 보안 프로그래밍는 기반으로 다음을 설정 하는 3 단계: 보안 모드, 클라이언트 자격 증명 유형 및 자격 증명 값입니다. 코드 또는 구성을 통해 이러한 단계를 수행할 수 있습니다.  
