...
1. IIS가 컴퓨터에 설치되어 실행되고 있는지 확인합니다. IIS를 설치 하 고 구성 하는 방법에 대 한 자세한 내용은 [iis 7.0 설치 및 구성을](/iis/install/installing-iis-7/installing-necessary-iis-components-on-windows-vista) 참조 하세요.  
