...
4. 서비스 구성  
    ...
    ```  
     ...
     서비스 구성 파일은 WCF의 기본 끝점에 의존합니다. `<protocolMapping>` 섹션은 생성된 기본 엔드포인트에 `NetHttpBinding`을 사용해야 함을 지정하는 데 사용됩니다.  
...
1. 콜백 계약을 구현합니다.  
    ...
    2. 클라이언트 구성  
        ...
        ```  
         ...
         클라이언트 구성에서 특별한 작업이 필요하지 않습니다. `NetHttpBinding`을 사용하여 클라이언트 측 엔드포인트를 지정하기만 하면 됩니다.  
