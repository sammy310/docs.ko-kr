...
#### <a name="2pc-protocol-binding-configuration"></a>2PC 프로토콜 바인딩 구성  
 ...
 B2131: 구현은 WCF의 2PC 메시지의 상관 관계를 얻기 위해 WS-ADDRESSING에 설명 된 대로 `wsa:ReferenceParameters`를 지원 해야 합니다.  
...
- R2002: `t:IssuedToken`의 무결성 및 기밀성이 제공되어야 합니다.  
 ...
 `wscoor:CoordinationContext` `wscoor:Identifier` 상대 URI 인 경우 트랜잭션 WCF 서비스에서 오류가 반환 됩니다.  
