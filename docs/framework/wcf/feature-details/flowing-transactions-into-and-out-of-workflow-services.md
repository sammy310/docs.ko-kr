...
11. 활동을 <xref:System.Activities.Statements.WriteLine> <xref:System.Activities.Statements.Assign> 활동 뒤로 끌어서 놓고 해당 <xref:System.Activities.Statements.WriteLine.Text%2A> 속성을 "Service:로 설정 합니다. 회신을 시작 합니다. "  
