...
## <a name="introduction-to-security-for-wcf-web-services"></a>WCF 웹 서비스 보안에 대한 소개  
 다운로드할 수 있는 WCF 보안 지침에 대 한 자세한 백서를 작성 하는 Microsoft Patterns and Practices 그룹: [WCF 보안 가이드](https://go.microsoft.com/fwlink/?LinkId=210210)합니다. 이 백서에서는 웹 서비스와 관련된 기본 보안 개념, 주요 WCF 보안 개념, 인트라넷 응용 프로그램 시나리오 및 인터넷 응용 프로그램 시나리오에 대해 설명합니다.  
