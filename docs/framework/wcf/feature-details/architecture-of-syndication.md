...
- <xref:System.ServiceModel.Syndication.SyndicationPerson>  
 ...
 배포 지원은 WCF REST 프로그래밍 모델을 정의 하는 기반으로 합니다 <xref:System.ServiceModel.WebHttpBinding> 와 함께에서 사용 되는 바인딩 <xref:System.ServiceModel.Description.WebHttpBehavior> 피드를 서비스로 사용할 수 있도록 합니다. WCF REST 프로그래밍 모델에 대 한 자세한 내용은 참조 하세요. [WCF 웹 HTTP 프로그래밍 모델 개요](../../../../docs/framework/wcf/feature-details/wcf-web-http-programming-model-overview.md)합니다.  
  
> [!NOTE]
>  Atom 1.0 사양에 따라 날짜 구문에 소수로 표시된 초를 지정할 수 있습니다. 직렬화 및 역직렬화 하는 경우 WCF 구현은 소수 자릿수 초를 무시 합니다.  
