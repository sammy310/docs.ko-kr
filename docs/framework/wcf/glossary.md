---
description: 자세한 내용은 .NET Framework 4.5에 대 한 Windows Communication Foundation 용어집을 확인 하세요.
...
|인스턴스 만들기 모델(instancing model)|서비스에는 인스턴스 만들기 모델이 포함되어 있습니다. 단일 &quot; &quot; CLR 개체가 모든 클라이언트를 서비스 하는 세 가지 인스턴스 모델 (단일)이 &quot; 있습니다. &quot; 각 클라이언트 호출을 처리 하기 위해 새 clr 개체가 생성 되는 호출과 세션당 &quot; &quot; clr 개체 집합이 각각의 개별 세션에 대해 하나씩 생성 됩니다. 인스턴스 만들기 모델은 애플리케이션 요구 사항 및 예상되는 서비스 사용 패턴에 따라 선택합니다.|
