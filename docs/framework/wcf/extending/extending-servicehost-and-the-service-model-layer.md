...
## <a name="in-this-section"></a>섹션 내용  
 ...
 를에서 설정을 변경 하거나 WCF 런타임에서 확장을 삽입 하려면 동작을 사용 합니다. WCF에는 스로틀, 인스턴스 만들기 그리고 서비스 및 작업의 여러 사항을 제어하기 위한 시스템 구현 동작이 포함되어 있습니다. 이 단원에서는 사용자 지정 동작을 만드는 방법 및 프로그램 방식과 구성 파일을 사용하여 해당 동작을 사용하는 방법에 대해 설명합니다.  
