...
2. 바인딩 요소를 엔드포인트 바인딩에 프로그래밍 방식으로 삽입하거나 응용 프로그램 구성 파일을 사용하여 삽입합니다. 다음 절차를 참조하십시오.  
