...
```  
 ...
 다음 샘플과 같이 ws-atomictransaction 프로토콜을 사용 하도록 클라이언트 및 서비스 바인딩을 구성 하 고 [\<transactionFlow >](../configure-apps/file-schema/wcf/transactionflow.md) 요소를 `true`로 설정 하 여 트랜잭션과 트랜잭션 흐름을 사용 하도록 설정할 수 있습니다. 구성.  
...
- [WS 트랜잭션 흐름](./samples/ws-transaction-flow.md)
