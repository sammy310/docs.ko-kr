...
### <a name="wcf-service-library-project-template"></a>WCF 서비스 라이브러리 프로젝트 템플릿  
 WCF 서비스 라이브러리 프로젝트 템플릿은 새 프로젝트 대화 상자에서 사용할 수 있습니다 **Visual C# \WCF** 하 고 **Visual Basic\WCF**합니다.  
...
### <a name="wcf-service-application-template"></a>WCF 서비스 응용 프로그램 템플릿  
 새 프로젝트 대화 상자의 WCF 서비스 응용 프로그램 템플릿에 사용할 수 있습니다 **Visual C# \WCF** 하 고 **Visual Basic\WCF**합니다.  
...
### <a name="wcf-web-site-template"></a>WCF 웹 사이트 템플릿  
 새 프로젝트 대화 상자의 WCF 웹 사이트 템플릿에 사용할 수 있습니다 **Visual C# site\wcf Service** 하 고 **Visual Basic\Web Site\WCF Service**합니다. 이 템플릿은 WCF 서비스 응용 프로그램 템플릿과 같은 파일을 만들지만 ASP.NET 웹 사이트인 것처럼 정리합니다. App_Code 및 App_Data 폴더가 생성됩니다.  
  
### <a name="wcf-service-item-template"></a>WCF 서비스 항목 템플릿  
 WCF 서비스 항목 템플릿을 기존 Visual Studio 프로젝트에 WCF 서비스를 추가 하는 빠른 방법을 제공 하는 사용자 지정 템플릿인 경우  
  
 이 템플릿을 사용 하려면로 이동 합니다 **솔루션 탐색기** 창에서 프로젝트 이름을 마우스 오른쪽 단추로 클릭을 가리킵니다 **추가**, 클릭 하 고 **새 항목** 시작 하는 **새로 추가 항목** 대화 상자.  
...
### <a name="wcf-syndication-service-library-template"></a>WCF 배포 서비스 라이브러리 템플릿  
 이 서식 파일을 사용 하면 WCF 서비스로 RSS 또는 ATOM 형식의 피드를 노출할 수 있습니다. 자세한 내용은 [WCF 배포](../../../docs/framework/wcf/feature-details/wcf-syndication.md)합니다.  
  
#### <a name="changing-the-address-of-the-feed"></a>피드의 주소 변경  
 배포 템플릿은 실행 중에 Internet Explorer를 사용합니다. 프로젝트를 마우스 오른쪽 단추로 클릭할 때 **솔루션 탐색기** Visual Studio에서 선택 **속성**을 선택한 후는 **디버그** 탭의 기본 주소를 볼 수는 템플릿입니다. Internet Explorer는 이 주소에서 피드를 열려고 합니다.  
  
 피드의 주소를 변경 하는 경우 또한에서 주소를 변경 해야 합니다 **디버그** 탭 합니다. 이와 같이 하지 않으면 Internet Explorer는 기본 주소에서 피드를 열려고 시도한 다음 실패합니다.  
  
### <a name="ajax-enabled-wcf-service-item-template"></a>AJAX 사용 WCF 서비스 항목 템플릿  
 이 템플릿은 WCF 서비스로 AJAX 컨트롤을 표시합니다. AJAX 컨트롤에 대 한 자세한 내용은 참조는 [AJAX 컨트롤 설명서](https://go.microsoft.com/fwlink/?LinkId=96717)합니다.  
  
### <a name="silverlight-enabled-wcf-service-item-template"></a>Silverlight 사용 WCF 서비스 항목 템플릿  
 이 템플릿은 Silverlight 클라이언트 또는 프런트 엔드에 데이터를 제공하는 웹 서비스를 만듭니다. Silverlight 클라이언트와 통신을 지원 하는 서비스 코드 및 구성을 포함 하는 WCF 서비스를 만드는 웹 사이트 또는 웹 응용 프로그램 프로젝트에 템플릿을 추가할 수 있습니다. 사용할 수 있습니다 **서비스 참조 추가** 클라이언트에 서비스의 클라이언트 프록시를 추가 하 고 Silverlight 클라이언트와 Silverlight 사용 WCF 서비스 간에 데이터를 교환 합니다.  
  
 이 서식 파일에 액세스 하려면 웹 사이트 또는 웹 응용 프로그램 프로젝트에서 마우스 오른쪽 단추로 클릭 **솔루션 탐색기**, 클릭 **새 항목 추가**를 클릭 하 고 **Silverlight 사용 WCF 서비스**합니다.  
