...
>  ComSvcConfig.exe를 사용하려면 로컬 컴퓨터의 관리자여야 합니다.  
 ...
 ComSvcConfig.exe에 대 한 자세한 내용은 참조 하세요. [방법: COM + 서비스 모델 구성 도구를 사용 하 여](../../../docs/framework/wcf/feature-details/how-to-use-the-com-service-model-configuration-tool.md)입니다.  
