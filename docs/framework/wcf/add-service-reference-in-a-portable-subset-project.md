...
10. 어셈블리 및 코드 생성기의 버전을 식별 하는 파일의 맨 위에 있는 주석 삽입 됩니다.`// This code was auto-generated by Microsoft.VisualStudio.Portable.AddServiceReference, version 1.0.0.0`  
...
14. <xref:System.ServiceModel.MessageContractAttribute.IsWrapped%2A> 이식 가능한 하위 집합 프로젝트에서 지원 되지 않습니다.  
