...
## <a name="remarks"></a>설명  
 이 명령줄 도구는 로컬 컴퓨터에서만 기본 WS-AT 설정을 구성하는 데 사용할 수 있습니다. 에 설명 된 대로 MMC 스냅인을 사용 해야 로컬 및 원격 컴퓨터에서 설정을 구성 해야 할 경우 [Ws-atomic Transaction 지원 구성](../../../docs/framework/wcf/feature-details/configuring-ws-atomic-transaction-support.md)합니다.  
  
 명령줄 도구는 Windows SDK 설치 위치에 있습니다.  
  
 %SystemRoot%\Microsoft.Net\Framework\v3.0\Windows Communication Foundation\wsatConfig.exe  
  
 [!INCLUDE[wxp](../../../includes/wxp-md.md)] 또는 [!INCLUDE[ws2003](../../../includes/ws2003-md.md)]을 실행 중인 경우 WsatConfig.exe를 실행하기 전에 업데이트를 다운로드해야 합니다. 이 업데이트에 대 한 자세한 내용은 참조 하십시오 [Commerce Server 2007 (KB912817)에 대 한 업데이트](https://go.microsoft.com/fwlink/?LinkId=95340) 하 고 [가용성의 Windows XP COM + 핫픽스 롤업 패키지 13](https://go.microsoft.com/fwlink/?LinkId=95341)합니다.  
