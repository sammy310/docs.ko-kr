...
## <a name="remarks"></a>설명  
 ...
 명령줄 도구는 Windows SDK 설치 위치 (특히)에서 찾을 수 있습니다.  
...
|-네트워크: 사용 하지&#124;않도록 설정\<>|WS-AtomicTransaction 네트워크 지원을 사용하거나 사용하지 않습니다.|  
...
|-traceActivity:\<사용&#124;안 함 > 사용|동작 이벤트의 추적을 사용하거나 사용하지 않습니다.|  
|-traceLevel:&#124;\<오류&#124;위험&#124;경고&#124;정보&#124; 자세한&#124;정보 표시 모든 >}|추적 수준을 지정합니다.|  
|-tracePII:\<사용&#124;안 함 >|개인적으로 식별할 수 있는 정보의 추적을 사용하거나 사용하지 않습니다.|  
|-traceProp:\<사용&#124;안 함 > 사용|전파 이벤트의 추적을 사용하거나 사용하지 않습니다.|  
