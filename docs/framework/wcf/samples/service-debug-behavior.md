...
```  
 ...
 servicedebug >는 서비스 디버그 동작 속성을 변경할 수 있도록 하는 구성 요소입니다. [ \<](../../../../docs/framework/configure-apps/file-schema/wcf/servicedebug.md) 사용자는 이 동작을 수정하여 다음을 수행할 수 있습니다.  
