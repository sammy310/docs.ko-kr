...
## <a name="in-this-section"></a>섹션 내용
 ...
 일반적으로 "POX" (Plain Old XML) 서비스 – WCF 웹 HTTP 프로그래밍 모델을 사용 하 라고 하는 HTTP 기반, RPC 기반 서비스를 구현 하는 방법에 설명 합니다.
  
 [SOAP 및 HTTP 엔드포인트](../../../../docs/framework/wcf/samples/soap-and-http-endpoints.md)  
 RPC 기반 서비스를 구현 하 고 SOAP 형식 및 WCF 웹 HTTP 프로그래밍 모델을 사용 하 여 "Plain Old XML" (POX) 형식으로 노출 하는 방법을 보여 줍니다.  
