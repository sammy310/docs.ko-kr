...
## <a name="in-this-section"></a>섹션 내용  
 ...
 비 메타 데이터 교환 바인딩 중 하나를 사용 하는 보안 메타 데이터 끝점이 있는 서비스를 구현 하는 방법 및 구성 하는 방법을 보여 줍니다 [ServiceModel Metadata 유틸리티 도구 (Svcutil.exe)](../../../../docs/framework/wcf/servicemodel-metadata-utility-tool-svcutil-exe.md) 또는 메타 데이터를 인출 하는 클라이언트 이러한 메타 데이터 끝점입니다.  
