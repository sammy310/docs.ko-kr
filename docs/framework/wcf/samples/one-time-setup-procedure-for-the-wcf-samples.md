...
1. ASP.NET가 설정 되어 있는지 확인 합니다. ASP.NET을 설정 하는 방법에 대 한 자세한 내용은 참조 하세요. [인터넷 정보 서비스 호스팅 지침](../../../../docs/framework/wcf/samples/internet-information-service-hosting-instructions.md)합니다.  
