...
>  이 샘플의 설치 절차 및 빌드 지침은 이 문서의 끝부분에 나와 있습니다.  
 ...
 이 샘플에서는 요청-회신 통신 패턴을 정의하는 계약을 구현하는 서비스를 보여 줍니다. Windows Forms 응용 프로그램 (.exe) 클라이언트와 인터넷 정보 서비스 (IIS)에서 호스트 되는 WCF 서비스의 샘플 구성 됩니다.  
