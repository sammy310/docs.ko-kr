...
## <a name="in-this-section"></a>섹션 내용  
 ...
 로컬 채널을 동일한 응용 프로그램 도메인 내에서 통신에 사용 되는 WCF 전송 채널을 보여 줍니다.  
  
 [신뢰할 수 있는 보안 프로필](../../../../docs/framework/wcf/samples/reliable-secure-profile.md)  
 WCF 및 신뢰할 수 있는 보안 프로필 (RSP)을 작성 하는 방법을 보여 줍니다.  
 ...
 WCF를 사용 하 여 전송 하는 큰 메시지를 버퍼링 하는 데 사용 되는 메모리의 양을 제한 하는 방법에 설명 합니다.
