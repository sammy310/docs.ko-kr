...
>  이 샘플의 설치 절차 및 빌드 지침은 이 항목의 끝부분에 나와 있습니다.  
 ...
 에 대 한 기본 보안을 [ \<wsHttpBinding >](../../../../docs/framework/configure-apps/file-schema/wcf/wshttpbinding.md) 는 Windows 인증을 사용 하 여 메시지 보안입니다. 이 샘플의 구성 파일을 명시적으로 설정 합니다 `mode` 특성을 [ \<보안 >](../../../../docs/framework/configure-apps/file-schema/wcf/security-of-wshttpbinding.md) 에 `Message` 및 `clientCredentialType` 특성을 `Windows`. 이러한 값은 이 바인딩의 기본값이지만 다음 샘플 구성에서와 같이 실제 사용을 보여 주기 위해 명시적으로 구성되었습니다.  
