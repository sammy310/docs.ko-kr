...
## <a name="to-set-up-build-and-run-the-sample"></a><span data-ttu-id="70673-132">샘플을 설치, 빌드 및 실행하려면</span><span class="sxs-lookup"><span data-stu-id="70673-132">To set up, build, and run the sample</span></span>
