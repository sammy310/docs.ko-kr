...
4. 단일 또는 다중 컴퓨터 구성에서 샘플을 실행 하려면의 지침을 따릅니다 [Windows Communication Foundation 샘플 실행](../../../../docs/framework/wcf/samples/running-the-samples.md)합니다.  
    ...
    > [!IMPORTANT]
    >  다중 컴퓨터 구성에서 클라이언트를 실행 하는 경우 대체 해야 둘 다에서 "localhost"를 `address` 특성을 [ \<끝점 >](../../../../docs/framework/configure-apps/file-schema/wcf/endpoint-element.md) 요소 및 `clientBaseAddress` 특성은 [ \<compositeDuplex >](../../../../docs/framework/configure-apps/file-schema/wcf/compositeduplex.md) 를 다음 예와에서 같이 해당 컴퓨터의 이름입니다.  
