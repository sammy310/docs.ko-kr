...
```  
 ...
 HTTP GET을 사용 하 여 서비스의 메타 데이터에 액세스 하려면 브라우저 `http://localhost/servicemodelsamples/service.svc?wsdl`에서를 가리킵니다.  
