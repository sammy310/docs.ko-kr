...
클라이언트 구현에서도 복소수가 사용됩니다. 서비스 계약과 데이터 계약은 서비스 메타 데이터에서 [ServiceModel Metadata 유틸리티 도구 (Svcutil.exe)](../servicemodel-metadata-utility-tool-svcutil-exe.md) 에 의해 생성 되는 소스 파일 generatedClient.cs에 정의 됩니다.
