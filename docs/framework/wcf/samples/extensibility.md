...
## <a name="in-this-section"></a>섹션 내용  
 ...
 Windows Communication Foundation (WCF) 끝점에 메시지를 디스패치할 때 사용 하는 메시지 필터를 대체 하는 방법에 설명 합니다.  
 ...
 오류 처리 및 오류 보고 사용 하 여 WCF 서비스에 대 한 제어를 확장 하는 방법에 설명 합니다 <xref:System.ServiceModel.Dispatcher.IErrorHandler> 인터페이스입니다.  
