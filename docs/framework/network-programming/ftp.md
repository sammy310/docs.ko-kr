...
자세한 내용은 [방법: FTP를 사용하여 파일 다운로드](how-to-download-files-with-ftp.md), [방법: FTP를 사용하여 파일 업로드](how-to-upload-files-with-ftp.md) 및 [방법: FTP로 디렉터리 내용 나열](how-to-list-directory-contents-with-ftp.md) 항목을 참조하세요.
