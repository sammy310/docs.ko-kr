...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [HttpListener ASPX Host Application Sample](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2008/dd767375(v%3dvs.90)) (HttpListener ASPX 호스트 애플리케이션 샘플)  
 <xref:System.Net.HttpListener?displayProperty=nameWithType> 클래스의 기능을 사용하여 호스팅된 ASP.NET 애플리케이션에 호출을 라우팅하는 HTTP 서버를 만드는 방법을 보여 줍니다.
