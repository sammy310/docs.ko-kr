...
|아니요|yes|IPv6 주소를 구문 분석할 수 있습니다.|  
|yes|아니요|IPv6 주소를 구문 분석하고 사용되지 않음으로 표시된 이름 확인 메서드로 IPv6 주소를 확인할 수 있습니다.|  
|yes|yes|사용되지 않음으로 표시된 항목이 포함된 모든 메서드를 사용하여 IPv6 주소를 구문 분석 및 확인할 수 있습니다.|  
 ...
 컴퓨터 구성 파일 *machine.config*를 수정하여 IPv6 지원을 사용하는 방법의 예제는 [방법: IPv6 지원을 사용하도록 컴퓨터 구성 파일 수정](how-to-modify-the-computer-configuration-file-to-enable-ipv6-support.md)을 참조하세요. 또한 운영 체제에 대한 IPv6 지원이 사용하도록 설정되어 있는지 확인합니다.  
