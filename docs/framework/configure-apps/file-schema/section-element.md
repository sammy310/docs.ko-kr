...
|                     | Description |
| ------------------- | ----------- |
| **allowDefinition** | 섹션을 사용할 수 있는 구성 파일을 지정 합니다. 다음 값 중 하나를 사용합니다.<br><br>**모든 범위**<br>섹션을 모든 구성 파일에서 사용할 수 있습니다. 기본값입니다.<br>**MachineOnly**<br>*컴퓨터 구성 파일 (machine.config*) 에서만 섹션을 사용할 수 있습니다.<br>**MachineToApplication**<br>컴퓨터 구성 파일 또는 응용 프로그램 구성 파일에서 섹션을 사용할 수 있습니다. |
