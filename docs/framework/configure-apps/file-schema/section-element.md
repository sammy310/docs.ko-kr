...
| **allowLocation**   | **\<location >** 요소 내에서 섹션을 사용할 수 있는지 여부를 확인 합니다. 다음 값 중 하나를 사용합니다.<br><br>**true**<br>**\<location >** 요소 내에 섹션을 사용할 수 있습니다. 기본값입니다.<br>**false**<br>에서는 **\<location >** 요소 내에서 섹션을 사용 하는 것을 허용 하지 않습니다. |
