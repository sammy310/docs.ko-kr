...
---
# <a name="filter-element-for-add-for-sharedlisteners"></a>\<sharedListeners에 대 한 >를 추가 \<에 대 한 필터 > 요소를 \<
...
## <a name="example"></a>예제  
 다음 예제에서는 `<filter>` 요소를 사용 하 여 `sharedListeners` 컬렉션의 `console` 추적 수신기에 필터를 추가 하는 방법을 보여 줍니다.  
