...
---
# <a name="listeners-element-for-source"></a>\<소스에 대 한 \<listeners > 요소 >
<xref:System.Diagnostics.TraceSource>에 대 한 <xref:System.Diagnostics.TraceSource.Listeners%2A> 컬렉션에서 수신기를 추가 하거나 제거 합니다. 수신기는 추적 출력을 로그, 창 또는 텍스트 파일과 같은 적절 한 대상으로 보냅니다.  
