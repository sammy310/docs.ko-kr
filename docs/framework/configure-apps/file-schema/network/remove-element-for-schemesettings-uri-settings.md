...
---
# <a name="remove-element-for-schemesettings-uri-settings"></a>\<제거 > schemeSettings (Uri 설정)에 대 한
스키마 이름에 대 한 스키마 설정을 제거합니다.  
...
## <a name="example"></a>예제  
 다음 예제에서 사용 하는 구성을 보여 줍니다는 <xref:System.Uri> http 체계에 대 한 스키마 설정을 제거 하는 클래스입니다.  
