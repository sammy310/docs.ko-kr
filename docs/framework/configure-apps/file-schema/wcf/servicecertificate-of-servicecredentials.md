...
---
# <a name="servicecertificate-of-servicecredentials"></a>\<serviceCredentials의 \<serviceCertificate > >
...
## <a name="remarks"></a>설명  
 ...
 요소를 사용 하는 방법에 대 한 [자세한 내용은 방법: 클라이언트 자격 증명 값](../../../wcf/how-to-specify-client-credential-values.md)을 지정 합니다.  
