...
---
# <a name="transport-of-nethttpbinding"></a>\<전송 > \<netHttpBinding >
...
|Basic|기본 인증을 지정 합니다.|  
|Digest|다이제스트 인증을 지정 합니다.|  
|Ntlm|Windows 인증이 실패할 경우 가능하면 NTLM 인증을 지정합니다.|  
|창|Windows 통합 인증을 지정합니다.|  
...
|요소|설명|  
|-------------|-----------------|  
|[\<security >](security-of-nethttpbinding.md)|[\<netHttpBinding >](nethttpbinding.md)에 대 한 보안 기능을 정의 합니다.|  
