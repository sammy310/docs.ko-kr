...
---
# <a name="transport-of-nethttpbinding"></a>\<전송 >의 \<netHttpBinding >
...
|요소|설명|  
|-------------|-----------------|  
|[\<security>](../../../../../docs/framework/configure-apps/file-schema/wcf/security-of-nethttpbinding.md)|에 대 한 보안 기능을 정의 합니다 [ \<netHttpBinding >](../../../../../docs/framework/configure-apps/file-schema/wcf/nethttpbinding.md)합니다.|  
