...
---
# <a name="message-of-wsdualhttpbinding"></a>\<wsDualHttpBinding>의 \<message>

에 대 한 메시지 수준 보안을 정의 [\<wsDualHttpBinding>](wsdualhttpbinding.md) 합니다.  
...
|요소|설명|  
|-------------|-----------------|  
|[\<security>](security-of-wsdualhttpbinding.md)|의 보안 기능을 정의 합니다 [\<wsDualHttpBinding>](wsdualhttpbinding.md) .|  
