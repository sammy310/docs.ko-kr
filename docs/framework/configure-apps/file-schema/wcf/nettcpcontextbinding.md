...
|contextProtectionLevel|컨텍스트 정보를 전파하는 데 사용되는 SOAP 헤더의 원하는 보호 수준을 지정하는 유효한 <xref:System.Net.Security.ProtectionLevel> 값입니다.  기본값은 <xref:System.Net.Security.ProtectionLevel.Sign>여야 합니다.|  
...
|요소|설명|  
|-------------|-----------------|  
|[\<보안 >](security-of-nettcpbinding.md)|바인딩에 대한 보안 설정을 정의합니다. 이 요소는 <xref:System.ServiceModel.Configuration.NetTcpSecurityElement> 형식입니다.|  
