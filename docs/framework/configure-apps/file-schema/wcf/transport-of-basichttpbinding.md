...
---
# <a name="transport-of-basichttpbinding"></a>\<basicHttpBinding>의 \<transport>
...
|요소|설명|  
|-------------|-----------------|  
|[\<security>](security-of-basichttpbinding.md)|의 보안 기능을 정의 합니다 [\<basicHttpBinding>](basichttpbinding.md) .|  
