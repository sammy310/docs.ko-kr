...
---
# <a name="assemblybinding-element-for-runtime"></a>\<런타임에 대 한 assemblyBinding > 요소를 \<
...
|특성|설명|  
|---------------|-----------------|  
|**x**|필수 특성입니다.<br /><br /> 어셈블리 바인딩에 필요한 XML 네임스페이스를 지정합니다. 문자열 string "urn:schemas-microsoft-com:asm.v1"을 값으로 사용합니다.|  
