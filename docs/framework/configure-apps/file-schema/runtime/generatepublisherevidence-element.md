...
> [!NOTE]
> .NET Framework 4 이상에서는 이 요소가 어셈블리 로드 시간에 영향을 주지 않습니다. 자세한 내용은 [보안 변경의](https://docs.microsoft.com/previous-versions/dotnet/framework/security/security-changes)"보안 정책 단순화" 섹션을 참조하십시오.  
