...
## <a name="remarks"></a>주의  
 ...
 기본 응용 프로그램 도메인이 로드 될 때 [\<appDomainManagerAssembly >](appdomainmanagerassembly-element.md) 요소로 지정 된 어셈블리에 지정 된 형식이 없는 경우 <xref:System.TypeLoadException>이 throw 됩니다. 그리고 프로세스가 시작 되지 않습니다.  
