...
Visual Studio에서 Windows Forms 디자이너는 호스트 Windows Forms 컨트롤을 최적화 하는 동안에 Windows Forms에서 ActiveX 컨트롤을 배치할 수 있습니다.
...
## <a name="add-an-activex-control-to-your-windows-form"></a>Windows 폼에 ActiveX 컨트롤 추가

Windows 폼에 ActiveX 컨트롤을 추가 하려면 도구 상자에 컨트롤을 두 번 클릭 합니다.
