...
Windows Forms `WebBrowser` 컨트롤은 웹 페이지를 호스팅하고 응용 프로그램에 웹 검색 기능을 제공 합니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 <xref:System.Windows.Forms.WebBrowser> 컨트롤에서 호스팅하는 HTML 페이지를 조작 하거나 만드는 방법을 설명 하는 항목을 제공 합니다.  
