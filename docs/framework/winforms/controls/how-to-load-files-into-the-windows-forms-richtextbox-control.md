...
1. <xref:System.Windows.Forms.OpenFileDialog> 구성 요소를 사용하여 열 파일의 경로를 확인합니다. 개요를 보려면 [OpenFileDialog 구성 요소 개요](openfiledialog-component-overview-windows-forms.md)합니다.  
