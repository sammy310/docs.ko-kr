...
## <a name="in-this-section"></a>섹션 내용  
 ...
 <xref:System.Windows.Forms.ToolStripItem>에서 <xref:System.Windows.Forms.ToolStrip>을 정렬하는 다양한 방법을 설명합니다.  
 ...
 <xref:System.Windows.Forms.MonthCalendar>에서 <xref:System.Windows.Forms.ToolStripControlHost> 컨트롤을 호스트하는 방법을 보여 줍니다.  
 ...
 <xref:System.Windows.Forms.ToolStripButton>의 맨 왼쪽 또는 맨 오른쪽에 <xref:System.Windows.Forms.ToolStrip>을 배치하는 방법을 설명합니다.  
 ...
 <xref:System.Windows.Forms.ToolStripProfessionalRenderer> 클래스를 사용 하 여 Microsoft® Outlook®에서 제공 하는 **탐색 창** 과 비슷한 복합 컨트롤을 만드는 방법을 설명 합니다.  
  
 [방법: 사용자 지정 ToolStripRenderer 구현](how-to-implement-a-custom-toolstriprenderer.md)  
 <xref:System.Windows.Forms.ToolStrip>에서 파생된 클래스를 구현하여 <xref:System.Windows.Forms.ToolStripRenderer> 컨트롤의 모양을 사용자 지정하는 방법을 설명합니다.  
  
- [방법: 디자이너를 사용 하 여 표준 항목을 포함 하는 기본 Windows Forms ToolStrip 만들기](create-a-basic-wf-toolstrip-with-standard-items-using-the-designer.md)  
