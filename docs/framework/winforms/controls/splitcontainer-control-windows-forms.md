...
> [!NOTE]
> **도구 상자**에서이 컨트롤은 이전 버전의 Visual Studio에 있던 <xref:System.Windows.Forms.Splitter> 컨트롤을 대체 합니다. `SplitContainer` 컨트롤이 <xref:System.Windows.Forms.Splitter> 컨트롤보다 훨씬 선호됩니다. 기존 애플리케이션과의 호환성을 위해 <xref:System.Windows.Forms.Splitter> 클래스도 .NET Framework에 여전히 포함되어 있지만 새 프로젝트에는 `SplitContainer` 컨트롤을 사용하는 것이 좋습니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 또한 [방법: 디자이너를 사용 하 여 창을 가로로 분할](how-to-split-a-window-horizontally-using-the-designer.md), 방법: windows [Form에서 Windows 탐색기 스타일 인터페이스 만들기](how-to-create-a-windows-explorer-style-interface-on-a-windows-form.md), [방법: 디자이너를 사용 하 여 Windows Forms를 사용 하 여 다중 창 사용자 인터페이스 만들기](create-a-multipane-user-interface-with-wf-using-the-designer.md)를 참조 하세요.  
