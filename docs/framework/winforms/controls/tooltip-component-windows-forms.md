...
Windows Forms <xref:System.Windows.Forms.ToolTip> 구성 요소는 사용자가 컨트롤을 가리킬 때 텍스트를 표시합니다. 도구 설명은 모든 컨트롤에 연결될 수 있습니다. 이 컨트롤의 사용 예: 폼에서 공간을 절약 하기 위해 단추에 작은 아이콘을 표시할 수 있으며 도구 설명을 사용 하 여 단추의 기능을 설명 키를 누릅니다.  
