...
컨트롤에 대 한 특별 한 아이콘을 **도구 상자**에 표시 하려면를 사용 하 <xref:System.Drawing.ToolboxBitmapAttribute>여 특정 이미지를 지정 하면 됩니다. 이 클래스는 *특성*이라는 다른 클래스에 연결할 수 있는 특수한 유형의 클래스입니다. 특성에 대 한 자세한 내용은 Visual Basic 또는 [특성C#](../../../csharp/programming-guide/concepts/attributes/index.md) 에 대 한 [특성 개요 (Visual Basic)](../../../visual-basic/programming-guide/concepts/attributes/index.md) 를 참조 C#하세요.  
