...
1. <xref:System.Windows.Forms.DataGridViewCellStyle> 속성을 통해 검색된 <xref:System.Windows.Forms.DataGridView.DefaultCellStyle%2A?displayProperty=nameWithType>의 속성을 설정합니다.  
