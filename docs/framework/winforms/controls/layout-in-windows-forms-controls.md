...
[여백 및 안쪽 여백 Windows Forms 컨트롤](../../../../docs/framework/winforms/controls/margin-and-padding-in-windows-forms-controls.md)\
...
[방법: Windows Forms 주위에 테두리 만들기 패딩을 사용 하 여 제어 합니다.](../../../../docs/framework/winforms/controls/how-to-create-a-border-around-a-windows-forms-control-using-padding.md)\
