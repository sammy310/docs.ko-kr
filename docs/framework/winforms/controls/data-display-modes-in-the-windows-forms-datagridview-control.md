...
## <a name="virtual"></a>Virtual  
 ...
 가상 모드에 대 한 자세한 내용은 참조 하세요. [Windows Forms DataGridView 컨트롤에서 가상 모드](virtual-mode-in-the-windows-forms-datagridview-control.md)합니다. 가상 모드 이벤트를 사용 하는 방법을 보여 주는 예제는 [연습: Windows Forms DataGridView 컨트롤에서 가상 모드 구현](implementing-virtual-mode-wf-datagridview-control.md)을 참조 하세요.  
