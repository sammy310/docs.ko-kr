...
## <a name="in-this-section"></a>섹션 내용  
 ...
 또한 [방법: 디자이너를 사용 하 여 Windows Forms TabControl에서 탭 추가 및 제거](add-and-remove-tabs-with-wf-tabcontrol-using-the-designer.md), [방법: 디자이너를 사용 하 여 탭 페이지에 컨트롤 추가](how-to-add-a-control-to-a-tab-page-using-the-designer.md) 를 참조 하세요.  
