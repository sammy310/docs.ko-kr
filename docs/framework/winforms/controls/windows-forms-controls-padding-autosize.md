...
1. Visual Studio에서 만들기를 **Windows 응용 프로그램** 라는 프로젝트 `LayoutExample`합니다. 자세한 내용은 [방법: Windows Forms 응용 프로그램 프로젝트 만들기](/visualstudio/ide/step-1-create-a-windows-forms-application-project) 합니다.
...
### <a name="arrange-controls-on-your-form-using-the-margin-property"></a>Margin 속성을 사용 하 여 폼에서 컨트롤 정렬
...
### <a name="arrange-controls-on-your-form-using-padding"></a>안쪽 여백을 사용 하 여 폼에서 컨트롤 정렬
...
### <a name="arrange-controls-on-your-form-using-the-autosize-property"></a>AutoSize 속성을 사용 하 여 폼에서 컨트롤 정렬
