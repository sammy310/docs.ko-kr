...
ms.locfileid: "79142370"
---
# <a name="colordialog-component-windows-forms"></a>ColorDialog 구성 요소(Windows Forms)
Windows Forms <xref:System.Windows.Forms.ColorDialog> 구성 요소는 사용자가 팔레트에서 색상을 선택하고 해당 팔레트에 사용자 지정 색상을 추가할 수 있도록 미리 구성된 대화 상자입니다. 이 구성 요소는 다른 Windows 기반 애플리케이션에서 색상 선택하는 데 사용하는 대화 상자와 동일합니다. 고유한 대화 상자를 구성하는 대신 Windows 기반 애플리케이션 내에서 간단한 솔루션으로 사용합니다.  
  
## <a name="in-this-section"></a>섹션 내용  
 [ColorDialog 구성 요소 개요](colordialog-component-overview-windows-forms.md)  
 <xref:System.Windows.Forms.ColorDialog> 사용자가 팔레트에서 색상을 선택하는 데 사용할 수 있는 미리 구성된 대화 상자를 표시할 수 있는 구성 요소의 일반적인 개념을 소개합니다.  
 ...
 <xref:System.Windows.Forms.ColorDialog> 구성 요소의 인스턴스를 사용하여 런타임에 색상을 선택하는 방법을 설명합니다.  
