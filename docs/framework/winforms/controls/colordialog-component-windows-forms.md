...
## <a name="in-this-section"></a>섹션 내용  
 ...
 사용자가 색상표에서 색을 선택 하는 데 사용할 수 있는 미리 구성 된 대화 상자를 표시할 수 있는 <xref:System.Windows.Forms.ColorDialog> 구성 요소의 일반적인 개념을 소개 합니다.  
 ...
 <xref:System.Windows.Forms.ColorDialog> 구성 요소의 인스턴스를 통해 런타임에 색을 선택 하는 방법에 대해 설명 합니다.  
