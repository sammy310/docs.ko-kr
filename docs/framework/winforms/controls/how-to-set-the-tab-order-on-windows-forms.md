...
3. 완료 되 면 **보기** 메뉴에서 **탭 순서** 를 다시 클릭 하 여 탭 순서 모드를 유지 합니다.
...
1. 속성 창에서 컨트롤의 <xref:System.Windows.Forms.Control.TabStop%2A> 속성을 `false` 로 설정 합니다.
