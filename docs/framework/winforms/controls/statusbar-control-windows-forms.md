...
>  <xref:System.Windows.Forms.ToolStripStatusLabel> 컨트롤은 <xref:System.Windows.Forms.StatusBar> 컨트롤을 대체하고 여기에 다른 기능을 추가하여 새로 도입된 컨트롤이지만 이전 버전과의 호환성 및 이후 사용 가능성을 고려하여 <xref:System.Windows.Forms.StatusBar> 컨트롤을 계속 유지하도록 선택할 수 있습니다.  
 ...
 Windows Forms <xref:System.Windows.Forms.StatusBar> 컨트롤은 폼에서 응용 프로그램이 다양한 종류의 상태 정보를 표시할 수 있는, 대개 창 아래쪽에 표시되는 영역으로 사용됩니다. <xref:System.Windows.Forms.StatusBar> 컨트롤 상태 또는 애니메이션에서 프로세스 중인; 나타내는 아이콘이 나타내는 아이콘을 표시 하는 상태 표시줄 패널에 있을 수 있습니다. 예를 들어 나타내는 Microsoft Word 문서는 저장 됩니다.  
  
## <a name="in-this-section"></a>섹션 내용  
 [StatusBar 컨트롤 개요](statusbar-control-overview-windows-forms.md)  
 일반적인 개념을 소개 합니다 <xref:System.Windows.Forms.StatusBar> 컨트롤에 포커스가 있는 컨트롤에 대 한 관련 정보를 확인할 수 있습니다.  
  
 [방법: StatusBar 컨트롤에 패널 추가](how-to-add-panels-to-a-statusbar-control.md)  
 프로그래밍 가능한 패널을 추가 하는 방법에 설명 합니다 <xref:System.Windows.Forms.StatusBar> 제어 합니다.  
  
 [방법: Windows Forms StatusBar 컨트롤에서 패널 클릭 확인](determine-which-panel-wf-statusbar-control-was-clicked.md)  
 처리 하는 방법에 설명 <xref:System.Windows.Forms.Control.Click> 에서 이벤트 발생을 <xref:System.Windows.Forms.StatusBar> 컨트롤입니다.  
...
## <a name="reference"></a>참조  
 ...
 대체 하 고 기능을 추가 합니다 <xref:System.Windows.Forms.StatusBar> 제어 합니다.  
