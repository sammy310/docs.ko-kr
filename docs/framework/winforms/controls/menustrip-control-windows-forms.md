...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [방법: ToolStripMenuItems에 향상 된 기능 추가](how-to-add-enhancements-to-toolstripmenuitems.md)  
 ...
 [방법: MDI 드롭 다운 메뉴에서 ToolStripMenuItem 제거](how-to-remove-a-toolstripmenuitem-from-an-mdi-drop-down-menu-windows-forms.md)  
 MDI 부모 메뉴의 드롭다운 부분에서 메뉴 항목을 제거하도록 여러 가지 속성을 설정하는 방법을 설명합니다.  
  
 [방법: 구성 MenuStrip 선택 여백 및 이미지 여백](how-to-configure-menustrip-check-margins-and-image-margins.md)  
