...
## <a name="in-this-section"></a>섹션 내용  
 ...
 사용 하는 방법에 설명 합니다 **열 추가** 및 **열 편집** 채우고 열 컬렉션을 수정 하려면 대화 상자.  
  
 [방법: 디자이너를 사용 하 여 Windows Forms DataGridView 컨트롤에 데이터 바인딩](bind-data-to-the-datagrid-using-the-designer.md)  
 사용 하는 방법에 설명 합니다 **데이터 소스 선택** 데이터에 연결 하는 컨트롤의 스마트 태그 옵션입니다.  
 ...
 사용 하는 방법에 설명 합니다 **열 편집** 열 다시 정렬 하려면 대화 상자.  
  
 [방법: 디자이너를 사용 하 여 Windows Forms Datagridview 컨트롤의 형식 변경](change-the-type-of-a-wf-datagridview-column-using-the-designer.md)  
 사용 하는 방법에 설명 합니다 **열 편집** 열 유형을 변경 하려면 대화 상자.  
  
 [방법: 디자이너를 사용 하 여 Windows Forms DataGridView 컨트롤에서 열 다시 정렬 사용](enable-column-reordering-in-the-datagrid-using-the-designer.md)  
 컨트롤의 스마트 태그를 사용 하 여 사용자가 열을 다시 정렬할 수 있도록 하는 방법에 설명 합니다.  
  
 [방법: 디자이너를 사용 하 여 Windows Forms DataGridView 컨트롤에서 열 고정](freeze-columns-in-the-datagrid-using-the-designer.md)  
 사용 하는 방법에 설명 합니다 **열 편집** 스크롤에서 특정 열을 방지 하기 위해 대화 상자.  
  
 [방법: 디자이너를 사용 하 여 Windows Forms DataGridView 컨트롤에서 열 숨기기](hide-columns-in-the-datagrid-using-the-designer.md)  
 사용 하는 방법에 설명 합니다 **열 편집** 특정 열을 숨기는 대화 상자.  
 ...
 사용 하는 방법에 설명 합니다 **열 편집** 특정 열에 값을 편집 하지 못하게 하려면 대화 상자.  
 ...
 컨트롤의 스마트 태그를 사용 하 여 사용자가 행 추가 또는 삭제 하지 못하도록 하는 방법에 설명 합니다.  
 ...
 사용 하는 방법에 설명 합니다 **CellStyle 작성기** 대화 상자 컨트롤에는 장부를 만듭니다.  
  
 [방법: 디자이너를 사용 하 여 Windows Forms DataGridView 컨트롤에 대 한 기본 셀 스타일 및 데이터 형식 설정](default-cell-styles-datagridview.md)  
 사용 하는 방법에 설명 합니다 **CellStyle 작성기** 기본 모양 및 데이터 표시를 설정 하려면 대화 상자 컨트롤에 대 한 형식입니다.  
