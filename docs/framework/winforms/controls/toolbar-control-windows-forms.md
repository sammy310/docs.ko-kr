...
## <a name="in-this-section"></a>섹션 내용  
 ...
 또한 참조 [방법: 디자이너를 사용 하 여 도구 모음 단추의 아이콘 정의](how-to-define-an-icon-for-a-toolbar-button-using-the-designer.md), [방법: 디자이너를 사용 하 여 ToolBar 컨트롤에 단추 추가](how-to-add-buttons-to-a-toolbar-control-using-the-designer.md)합니다.  
