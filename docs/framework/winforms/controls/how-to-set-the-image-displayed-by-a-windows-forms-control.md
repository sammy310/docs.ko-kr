...
## <a name="to-set-the-image-displayed-by-a-control"></a>컨트롤에 표시 되는 이미지를 설정 하려면

1. 컨트롤의 `Image` 또는 `BackgroundImage` 속성을 형식의 <xref:System.Drawing.Image>개체로 설정 합니다. 일반적으로 메서드를 <xref:System.Drawing.Image.FromFile%2A> 사용 하 여 파일에서 이미지를 로드 합니다.
