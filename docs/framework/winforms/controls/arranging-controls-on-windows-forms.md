...
## <a name="in-this-section"></a>섹션 내용
 ...
 사용 하 여 폼에 컨트롤을 배치 하는 방법을 설명 합니다는 <xref:System.Windows.Forms.Control.Margin%2A>, <xref:System.Windows.Forms.Control.Padding%2A>, 및 <xref:System.Windows.Forms.Control.AutoSize%2A> 내의 속성을 **Forms 디자이너** Visual Studio에서.
