...
## <a name="related-sections"></a>관련 단원  
 ...
 [Windows Forms/MFC 프로그래밍 차이점](/cpp/dotnet/windows-forms-mfc-programming-differences)  
 ...
 [먼저 Visual Studio의 배포 살펴보기](/visualstudio/deployment/deploying-applications-services-and-components)  
 다른 컴퓨터에 설치할 완성된 애플리케이션 또는 구성 요소를 배포하는 프로세스를 설명합니다.  
  
 [콘솔 애플리케이션 빌드](../../standard/building-console-apps.md)  
