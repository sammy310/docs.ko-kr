...
---
# <a name="how-to-copy-and-paste-an-elementhost-control-at-design-time"></a>방법: 복사 하 고 디자인 타임에 ElementHost 컨트롤을 붙여 넣습니다.
...
7.  
  `elementHost1`을 선택하고 Ctrl+C를 눌러 클립보드에 복사합니다.  
