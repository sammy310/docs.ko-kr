...
이 예제에서는 개체를 만들고 그린 <xref:System.Drawing.Bitmap> 다음 기존 Windows Forms 컨트롤에 표시 <xref:System.Windows.Forms.PictureBox> 합니다.  
...
- 시스템, 시스템 Drawing 및 system.xml 어셈블리를 가져오는 Windows 폼입니다.  
