---
title: '방법: 상속 선택 대화 상자를 사용 하 여 폼 상속'
ms.date: 03/30/2017
helpviewer_keywords:
...
ms.locfileid: "57719361"
---
# <a name="how-to-inherit-forms-using-the-inheritance-picker-dialog-box"></a>방법: 상속 선택 대화 상자를 사용 하 여 폼 상속
...
6.  구성 요소를 선택합니다.  
     ...
     **솔루션 탐색기**에서 구성 요소가 프로젝트에 추가됩니다. UI가 있는 경우 상속된 양식의 일부인 컨트롤에 문자 모양(![VisualBasicInheritanceSymbol screenshot](./media/vbinheritanceglyph.gif "vbInheritanceGlyph"))이 표시되고, 선택하면 슈퍼클래스로 지정된 양식에서 컨트롤이 보유한 보안 수준을 나타내는 테두리가 포함됩니다. 다른 보안 수준에 해당하는 동작은 아래 표에 나열되어 있습니다.  
