...
---
# <a name="how-to-manually-render-buffered-graphics"></a>방법: 버퍼링 된 그래픽 수동 렌더링
...
1.  
  <xref:System.Drawing.BufferedGraphicsContext> 클래스의 인스턴스에 대한 참조를 가져옵니다. 자세한 내용은 [방법: 버퍼링 된 그래픽 수동 관리](how-to-manually-manage-buffered-graphics.md)합니다.  
...
3.  
  <xref:System.Drawing.BufferedGraphics.Graphics%2A> 속성을 설정하여 그래픽 버퍼에 그래픽을 그립니다. 예를 들어:  
