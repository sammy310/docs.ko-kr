...
|ClickOnce 호스트|ClickOnce 애플리케이션을 시작합니다.|[!INCLUDE[net_v45](../../../includes/net-v45-md.md)]부터 .NET Framework 버전이 없는 경우 표시됩니다.|아니요|
|XBAP 호스트|WPF XBAP 애플리케이션을 시작합니다.|[!INCLUDE[net_v45](../../../includes/net-v45-md.md)]부터 .NET Framework 버전이 없는 경우 표시됩니다.|아니요|
...
[!INCLUDE[net_v45](../../../includes/net-v45-md.md)]부터 CLR 활성화 로깅이 초기화 오류 메시지가 표시되는 시기 및 이유를 기록하는 로그 항목을 포함하도록 향상되었습니다. 자세한 내용은 [방법: CLR 활성화 문제 디버깅](../../../docs/framework/deployment/how-to-debug-clr-activation-issues.md).
