...
ms.locfileid: "91609592"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-461"></a><span data-ttu-id="ba265-103">.NET Framework 4.5에서 4.6.1로 마이그레이션에 대한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="ba265-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="ba265-104">.NET Framework 4.5에서 4.6.1로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="ba265-104">If you are migrating from the .NET Framework 4.5 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="ba265-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="ba265-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="ba265-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ba265-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ba265-107">코어</span><span class="sxs-lookup"><span data-stu-id="ba265-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="ba265-108">데이터</span><span class="sxs-lookup"><span data-stu-id="ba265-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="ba265-109">디버거</span><span class="sxs-lookup"><span data-stu-id="ba265-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="ba265-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="ba265-110">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="ba265-111">네트워킹</span><span class="sxs-lookup"><span data-stu-id="ba265-111">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="ba265-112">Serialization</span><span class="sxs-lookup"><span data-stu-id="ba265-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="ba265-113">설치 및 배포</span><span class="sxs-lookup"><span data-stu-id="ba265-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="ba265-114">도구</span><span class="sxs-lookup"><span data-stu-id="ba265-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ba265-115">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="ba265-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ba265-116">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="ba265-116">Windows Presentation Foundation (WPF)</span></span>
