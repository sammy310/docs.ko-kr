...
ms.locfileid: "85620121"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-452"></a><span data-ttu-id="f210b-102">.NET Framework 4.0에서 4.5.2로 마이그레이션에 대한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="f210b-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="f210b-103">.NET Framework 4.0에서 4.5.2로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="f210b-103">If you are migrating from the .NET Framework 4.0 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="f210b-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="f210b-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="f210b-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="f210b-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="f210b-106">코어</span><span class="sxs-lookup"><span data-stu-id="f210b-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="f210b-107">데이터</span><span class="sxs-lookup"><span data-stu-id="f210b-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="f210b-108">디버거</span><span class="sxs-lookup"><span data-stu-id="f210b-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="f210b-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="f210b-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="f210b-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="f210b-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="f210b-111">MEF(Managed Extensibility Framework)</span><span class="sxs-lookup"><span data-stu-id="f210b-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="f210b-112">네트워킹</span><span class="sxs-lookup"><span data-stu-id="f210b-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="f210b-113">인쇄</span><span class="sxs-lookup"><span data-stu-id="f210b-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="f210b-114">Serialization</span><span class="sxs-lookup"><span data-stu-id="f210b-114">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="f210b-115">웹 애플리케이션</span><span class="sxs-lookup"><span data-stu-id="f210b-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f210b-116">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="f210b-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="f210b-117">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="f210b-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f210b-118">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="f210b-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="f210b-119">Windows WF(Workflow Foundation)</span><span class="sxs-lookup"><span data-stu-id="f210b-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="f210b-120">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="f210b-120">XML, XSLT</span></span>
