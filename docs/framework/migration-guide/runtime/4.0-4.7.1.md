...
ms.locfileid: "58760107"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-471"></a><span data-ttu-id="e059c-102">.NET Framework 4.0에서 4.7.1로 마이그레이션에 대한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="e059c-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="e059c-103">.NET Framework 4.0에서 4.7.1로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="e059c-103">If you are migrating from the .NET Framework 4.0 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="e059c-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="e059c-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="e059c-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e059c-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="e059c-106">코어</span><span class="sxs-lookup"><span data-stu-id="e059c-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="e059c-107">데이터</span><span class="sxs-lookup"><span data-stu-id="e059c-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e059c-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e059c-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="e059c-109">전역화</span><span class="sxs-lookup"><span data-stu-id="e059c-109">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="e059c-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="e059c-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="e059c-111">MEF(Managed Extensibility Framework)</span><span class="sxs-lookup"><span data-stu-id="e059c-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="e059c-112">네트워킹</span><span class="sxs-lookup"><span data-stu-id="e059c-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="e059c-113">인쇄</span><span class="sxs-lookup"><span data-stu-id="e059c-113">Printing</span></span>
...
## <a name="security"></a><span data-ttu-id="e059c-114">보안</span><span class="sxs-lookup"><span data-stu-id="e059c-114">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="e059c-115">Serialization</span><span class="sxs-lookup"><span data-stu-id="e059c-115">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="e059c-116">설치 및 배포</span><span class="sxs-lookup"><span data-stu-id="e059c-116">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="e059c-117">도구</span><span class="sxs-lookup"><span data-stu-id="e059c-117">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="e059c-118">웹 애플리케이션</span><span class="sxs-lookup"><span data-stu-id="e059c-118">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e059c-119">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="e059c-119">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="e059c-120">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="e059c-120">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e059c-121">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="e059c-121">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="e059c-122">Windows WF(Workflow Foundation)</span><span class="sxs-lookup"><span data-stu-id="e059c-122">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="e059c-123">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="e059c-123">XML, XSLT</span></span>
