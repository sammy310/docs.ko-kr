...
ms.locfileid: "59185992"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="c3fdf-102">.NET Framework 4.5에서 4.7로 마이그레이션에 대한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="c3fdf-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="c3fdf-103">.NET Framework 4.5에서 4.7로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="c3fdf-103">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="c3fdf-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="c3fdf-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="c3fdf-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c3fdf-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="c3fdf-106">코어</span><span class="sxs-lookup"><span data-stu-id="c3fdf-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="c3fdf-107">데이터</span><span class="sxs-lookup"><span data-stu-id="c3fdf-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="c3fdf-108">디버거</span><span class="sxs-lookup"><span data-stu-id="c3fdf-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c3fdf-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c3fdf-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="c3fdf-110">전역화</span><span class="sxs-lookup"><span data-stu-id="c3fdf-110">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="c3fdf-111">JIT</span><span class="sxs-lookup"><span data-stu-id="c3fdf-111">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="c3fdf-112">네트워킹</span><span class="sxs-lookup"><span data-stu-id="c3fdf-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="c3fdf-113">보안</span><span class="sxs-lookup"><span data-stu-id="c3fdf-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="c3fdf-114">Serialization</span><span class="sxs-lookup"><span data-stu-id="c3fdf-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="c3fdf-115">설치 및 배포</span><span class="sxs-lookup"><span data-stu-id="c3fdf-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="c3fdf-116">도구</span><span class="sxs-lookup"><span data-stu-id="c3fdf-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c3fdf-117">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="c3fdf-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c3fdf-118">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="c3fdf-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="c3fdf-119">Windows WF(Workflow Foundation)</span><span class="sxs-lookup"><span data-stu-id="c3fdf-119">Windows Workflow Foundation (WF)</span></span>
