...
ms.locfileid: "66379631"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="c0b41-102">.NET Framework 4.0에서 4.5로 마이그레이션에 대한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="c0b41-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="c0b41-103">.NET Framework 4.0에서 4.5로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="c0b41-103">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c0b41-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c0b41-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="c0b41-105">코어</span><span class="sxs-lookup"><span data-stu-id="c0b41-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="c0b41-106">데이터</span><span class="sxs-lookup"><span data-stu-id="c0b41-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="c0b41-107">디버거</span><span class="sxs-lookup"><span data-stu-id="c0b41-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c0b41-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c0b41-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="c0b41-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="c0b41-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="c0b41-110">MEF(Managed Extensibility Framework)</span><span class="sxs-lookup"><span data-stu-id="c0b41-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="c0b41-111">네트워킹</span><span class="sxs-lookup"><span data-stu-id="c0b41-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="c0b41-112">인쇄</span><span class="sxs-lookup"><span data-stu-id="c0b41-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="c0b41-113">Serialization</span><span class="sxs-lookup"><span data-stu-id="c0b41-113">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="c0b41-114">웹 애플리케이션</span><span class="sxs-lookup"><span data-stu-id="c0b41-114">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c0b41-115">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="c0b41-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="c0b41-116">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="c0b41-116">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c0b41-117">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="c0b41-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="c0b41-118">Windows WF(Workflow Foundation)</span><span class="sxs-lookup"><span data-stu-id="c0b41-118">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="c0b41-119">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="c0b41-119">XML, XSLT</span></span>
