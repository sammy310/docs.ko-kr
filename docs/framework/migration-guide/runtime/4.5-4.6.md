...
ms.locfileid: "66379360"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="c58c9-102">.NET Framework 4.5에서 4.6으로 마이그레이션에 대한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="c58c9-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="c58c9-103">.NET Framework 4.5에서 4.6으로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="c58c9-103">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="c58c9-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="c58c9-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="c58c9-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c58c9-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="c58c9-106">코어</span><span class="sxs-lookup"><span data-stu-id="c58c9-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="c58c9-107">데이터</span><span class="sxs-lookup"><span data-stu-id="c58c9-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="c58c9-108">디버거</span><span class="sxs-lookup"><span data-stu-id="c58c9-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c58c9-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c58c9-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="c58c9-110">네트워킹</span><span class="sxs-lookup"><span data-stu-id="c58c9-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="c58c9-111">Serialization</span><span class="sxs-lookup"><span data-stu-id="c58c9-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="c58c9-112">설치 및 배포</span><span class="sxs-lookup"><span data-stu-id="c58c9-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c58c9-113">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="c58c9-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c58c9-114">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="c58c9-114">Windows Presentation Foundation (WPF)</span></span>
