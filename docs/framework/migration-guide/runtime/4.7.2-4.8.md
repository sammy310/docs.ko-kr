...
ms.locfileid: "67802674"
---
# <a name="runtime-changes-for-migration-from-net-framework-472-to-48"></a><span data-ttu-id="d16c0-102">.NET Framework 4.7.2에서 4.8로 마이그레이션에 대한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="d16c0-102">Runtime Changes for Migration from .NET Framework 4.7.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="d16c0-103">.NET Framework 4.7.2에서 4.8로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="d16c0-103">If you are migrating from the .NET Framework 4.7.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="d16c0-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="d16c0-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="d16c0-105">코어</span><span class="sxs-lookup"><span data-stu-id="d16c0-105">Core</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="d16c0-106">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="d16c0-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="d16c0-107">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="d16c0-107">Windows Presentation Foundation (WPF)</span></span>
