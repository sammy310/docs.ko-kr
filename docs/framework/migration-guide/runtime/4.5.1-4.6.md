...
ms.locfileid: "59172733"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="8a7cc-102">.NET Framework 4.5.1에서 4.6으로 마이그레이션에 대한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="8a7cc-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="8a7cc-103">.NET Framework 4.5.1에서 4.6으로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="8a7cc-103">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="8a7cc-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="8a7cc-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="8a7cc-105">코어</span><span class="sxs-lookup"><span data-stu-id="8a7cc-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="8a7cc-106">데이터</span><span class="sxs-lookup"><span data-stu-id="8a7cc-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="8a7cc-107">디버거</span><span class="sxs-lookup"><span data-stu-id="8a7cc-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="8a7cc-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="8a7cc-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="8a7cc-109">네트워킹</span><span class="sxs-lookup"><span data-stu-id="8a7cc-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="8a7cc-110">Serialization</span><span class="sxs-lookup"><span data-stu-id="8a7cc-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="8a7cc-111">설치 및 배포</span><span class="sxs-lookup"><span data-stu-id="8a7cc-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="8a7cc-112">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="8a7cc-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="8a7cc-113">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="8a7cc-113">Windows Presentation Foundation (WPF)</span></span>
