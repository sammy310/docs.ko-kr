...
ms.locfileid: "91609371"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-472"></a><span data-ttu-id="7899b-103">.NET Framework 4.0에서 4.7.2로 마이그레이션에 대한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="7899b-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="7899b-104">.NET Framework 4.0에서 4.7.2로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="7899b-104">If you are migrating from the .NET Framework 4.0 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="7899b-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="7899b-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="7899b-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="7899b-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="7899b-107">코어</span><span class="sxs-lookup"><span data-stu-id="7899b-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="7899b-108">데이터</span><span class="sxs-lookup"><span data-stu-id="7899b-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="7899b-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="7899b-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="7899b-110">전역화</span><span class="sxs-lookup"><span data-stu-id="7899b-110">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="7899b-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="7899b-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="7899b-112">MEF(Managed Extensibility Framework)</span><span class="sxs-lookup"><span data-stu-id="7899b-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="7899b-113">네트워킹</span><span class="sxs-lookup"><span data-stu-id="7899b-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="7899b-114">인쇄</span><span class="sxs-lookup"><span data-stu-id="7899b-114">Printing</span></span>
...
## <a name="runtime"></a><span data-ttu-id="7899b-115">런타임</span><span class="sxs-lookup"><span data-stu-id="7899b-115">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="7899b-116">보안</span><span class="sxs-lookup"><span data-stu-id="7899b-116">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="7899b-117">Serialization</span><span class="sxs-lookup"><span data-stu-id="7899b-117">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="7899b-118">설치 및 배포</span><span class="sxs-lookup"><span data-stu-id="7899b-118">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="7899b-119">도구</span><span class="sxs-lookup"><span data-stu-id="7899b-119">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="7899b-120">웹 애플리케이션</span><span class="sxs-lookup"><span data-stu-id="7899b-120">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="7899b-121">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="7899b-121">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="7899b-122">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="7899b-122">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7899b-123">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="7899b-123">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="7899b-124">Windows WF(Workflow Foundation)</span><span class="sxs-lookup"><span data-stu-id="7899b-124">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="7899b-125">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="7899b-125">XML, XSLT</span></span>
