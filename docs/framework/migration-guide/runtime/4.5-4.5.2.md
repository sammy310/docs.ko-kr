...
ms.locfileid: "91609761"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="889ec-103">.NET Framework 4.5에서 4.5.2로 마이그레이션에 대한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="889ec-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="889ec-104">.NET Framework 4.5에서 4.5.2로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="889ec-104">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="889ec-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="889ec-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="889ec-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="889ec-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="889ec-107">코어</span><span class="sxs-lookup"><span data-stu-id="889ec-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="889ec-108">데이터</span><span class="sxs-lookup"><span data-stu-id="889ec-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="889ec-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="889ec-109">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="889ec-110">Serialization</span><span class="sxs-lookup"><span data-stu-id="889ec-110">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="889ec-111">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="889ec-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="889ec-112">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="889ec-112">Windows Presentation Foundation (WPF)</span></span>
