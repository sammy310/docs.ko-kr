...
ms.locfileid: "73196399"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="7a480-102">.NET Framework 4.6.1에서 4.7로 마이그레이션에 대한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="7a480-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="7a480-103">.NET Framework 4.6.1에서 4.7로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="7a480-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="7a480-104">data</span><span class="sxs-lookup"><span data-stu-id="7a480-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="7a480-105">전역화</span><span class="sxs-lookup"><span data-stu-id="7a480-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="7a480-106">JIT</span><span class="sxs-lookup"><span data-stu-id="7a480-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="7a480-107">보안</span><span class="sxs-lookup"><span data-stu-id="7a480-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="7a480-108">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="7a480-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7a480-109">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="7a480-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="7a480-110">Windows WF(Workflow Foundation)</span><span class="sxs-lookup"><span data-stu-id="7a480-110">Windows Workflow Foundation (WF)</span></span>
