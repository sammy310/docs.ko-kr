...
ms.locfileid: "95729592"
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-48"></a><span data-ttu-id="5c0eb-103">.NET Framework 4.6에서 4.8로 마이그레이션에 대한 대상 다시 지정 변경 내용</span><span class="sxs-lookup"><span data-stu-id="5c0eb-103">Retargeting Changes for Migration from .NET Framework 4.6 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="5c0eb-104">.NET Framework 4.6에서 4.8로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="5c0eb-104">If you are migrating from the .NET Framework 4.6 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="5c0eb-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="5c0eb-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="5c0eb-106">코어</span><span class="sxs-lookup"><span data-stu-id="5c0eb-106">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="5c0eb-107">네트워킹</span><span class="sxs-lookup"><span data-stu-id="5c0eb-107">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="5c0eb-108">보안</span><span class="sxs-lookup"><span data-stu-id="5c0eb-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="5c0eb-109">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="5c0eb-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="5c0eb-110">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="5c0eb-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="5c0eb-111">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="5c0eb-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="5c0eb-112">Windows WF(Workflow Foundation)</span><span class="sxs-lookup"><span data-stu-id="5c0eb-112">Windows Workflow Foundation (WF)</span></span>
