...
ms.locfileid: "95733089"
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-48"></a><span data-ttu-id="23d7d-103">.NET Framework 4.7.1에서 4.8로 마이그레이션에 대한 대상 다시 지정 변경 내용</span><span class="sxs-lookup"><span data-stu-id="23d7d-103">Retargeting Changes for Migration from .NET Framework 4.7.1 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="23d7d-104">.NET Framework 4.7.1에서 4.8로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="23d7d-104">If you are migrating from the .NET Framework 4.7.1 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="23d7d-105">코어</span><span class="sxs-lookup"><span data-stu-id="23d7d-105">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="23d7d-106">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="23d7d-106">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="23d7d-107">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="23d7d-107">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="23d7d-108">Windows WF(Workflow Foundation)</span><span class="sxs-lookup"><span data-stu-id="23d7d-108">Windows Workflow Foundation (WF)</span></span>
