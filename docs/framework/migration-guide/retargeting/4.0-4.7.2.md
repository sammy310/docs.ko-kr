...
ms.locfileid: "85620952"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-472"></a><span data-ttu-id="cfebc-102">.NET Framework 4.0에서 4.7.2로 마이그레이션에 대한 대상 다시 지정 변경 내용</span><span class="sxs-lookup"><span data-stu-id="cfebc-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="cfebc-103">.NET Framework 4.0에서 4.7.2로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="cfebc-103">If you are migrating from the .NET Framework 4.0 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="cfebc-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="cfebc-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="cfebc-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="cfebc-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="cfebc-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="cfebc-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="cfebc-107">코어</span><span class="sxs-lookup"><span data-stu-id="cfebc-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="cfebc-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="cfebc-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="cfebc-109">JIT</span><span class="sxs-lookup"><span data-stu-id="cfebc-109">JIT</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="cfebc-110">MSBuild</span><span class="sxs-lookup"><span data-stu-id="cfebc-110">MSBuild</span></span>
...
## <a name="networking"></a><span data-ttu-id="cfebc-111">네트워킹</span><span class="sxs-lookup"><span data-stu-id="cfebc-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="cfebc-112">보안</span><span class="sxs-lookup"><span data-stu-id="cfebc-112">Security</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="cfebc-113">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="cfebc-113">Visual Basic .NET</span></span>

[!INCLUDE[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="cfebc-114">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="cfebc-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="cfebc-115">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="cfebc-115">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="cfebc-116">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="cfebc-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="cfebc-117">Windows WF(Workflow Foundation)</span><span class="sxs-lookup"><span data-stu-id="cfebc-117">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="cfebc-118">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="cfebc-118">XML, XSLT</span></span>
