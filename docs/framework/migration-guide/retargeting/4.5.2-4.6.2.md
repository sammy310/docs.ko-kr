...
ms.locfileid: "67859457"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-462"></a><span data-ttu-id="68921-102">.NET Framework 4.5.2에서 4.6.2로 마이그레이션에 대한 대상 다시 지정 변경 내용</span><span class="sxs-lookup"><span data-stu-id="68921-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="68921-103">.NET Framework 4.5.2에서 4.6.2로 마이그레이션하려는 경우에는 앱에 영향을 줄 수 있는 애플리케이션 호환성 문제에 대해 다음 항목을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="68921-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="68921-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="68921-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="68921-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="68921-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="68921-106">코어</span><span class="sxs-lookup"><span data-stu-id="68921-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="68921-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="68921-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="68921-108">JIT</span><span class="sxs-lookup"><span data-stu-id="68921-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="68921-109">네트워킹</span><span class="sxs-lookup"><span data-stu-id="68921-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="68921-110">보안</span><span class="sxs-lookup"><span data-stu-id="68921-110">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="68921-111">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="68921-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="68921-112">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="68921-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="68921-113">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="68921-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="68921-114">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="68921-114">XML, XSLT</span></span>
