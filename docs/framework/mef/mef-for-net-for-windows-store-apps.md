...
- <xref:System.Composition.Hosting.Core?displayProperty=nameWithType>은 컴포지션 엔진에서 내부적으로 사용되는 MEF 형식을 제공합니다.  
 ...
 Windows 8.x 스토어 앱용.NET 및 여기에 포함된 네임스페이스 및 형식 목록에 대한 자세한 내용은 [Windows 스토어 앱용 .NET 개요](https://docs.microsoft.com/previous-versions/br230302(v=vs.110))를 참조하세요.
