...
이 새로운 동작은 인트라넷 어셈블리에 대한 기본값입니다. 컴퓨터의 모든 애플리케이션에 적용되는 레지스트리 키를 설정하여 <xref:System.Security.SecurityZone.Intranet> 증거를 제공하는 이전 동작으로 되돌릴 수 있습니다. 이 프로세스는 32비트 컴퓨터와 64비트 컴퓨터에서 다릅니다.
