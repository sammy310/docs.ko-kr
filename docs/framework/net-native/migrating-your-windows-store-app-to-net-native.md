 ...
 **사용되지 않는 API**
 ...
 사용 되지 않는 Api에 대 한 `VARIANT` 마샬링 포함 됩니다.
...
기본 COM 이벤트에 대 한 사용 되지 않는 Api는 다음과 같습니다.

- <xref:System.Runtime.InteropServices.ComEventsHelper?displayProperty=nameWithType>
- <xref:System.Runtime.InteropServices.ComSourceInterfacesAttribute>

사용 되지 않는 Api에는 <xref:System.Runtime.InteropServices.ICustomQueryInterface?displayProperty=nameWithType> .NET 네이티브에서는 지원 되지 않음, 인터페이스를 포함 합니다.

- <xref:System.Runtime.InteropServices.ICustomQueryInterface?displayProperty=nameWithType> (모든 members)
- <xref:System.Runtime.InteropServices.CustomQueryInterfaceMode?displayProperty=nameWithType> (모든 members)
- <xref:System.Runtime.InteropServices.CustomQueryInterfaceResult?displayProperty=nameWithType> (모든 members)
- <xref:System.Runtime.InteropServices.Marshal.GetComInterfaceForObject%28System.Object%2CSystem.Type%2CSystem.Runtime.InteropServices.CustomQueryInterfaceMode%29?displayProperty=fullName>

다른 지원 되지 않는 interop 기능은 다음과 같습니다.

- <xref:System.Runtime.InteropServices.ICustomAdapter?displayProperty=nameWithType> (모든 members)
- <xref:System.Runtime.InteropServices.SafeBuffer?displayProperty=nameWithType> (모든 members)
...
형식에는 <xref:System.ComponentModel.DataAnnotations> 고 <xref:System.ComponentModel.DataAnnotations.Schema> 네임 스페이스는.NET 네이티브에서 지원 되지 않습니다. Windows 스토어 앱 용.NET Windows 8에 있는 형식은 다음과 같습니다.
...
형식에는 [namespaces](xref:System.ServiceModel) .NET 네이티브에서 지원 되지 않습니다. 여기에는 다음과 같은 형식이 포함됩니다.
