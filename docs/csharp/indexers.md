...
### <a name="arrays-and-vectors"></a><span data-ttu-id="cd108-133">배열 및 벡터</span><span class="sxs-lookup"><span data-stu-id="cd108-133">Arrays and Vectors</span></span>
