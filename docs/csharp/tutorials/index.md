...
## <a name="numbers-in-cintro-to-csharpnumbers-in-csharpyml"></a>[C#의 숫자](intro-to-csharp/numbers-in-csharp.yml)
...
## <a name="branches-and-loopsintro-to-csharpbranches-and-loopsyml"></a>[분기 및 루프](intro-to-csharp/branches-and-loops.yml)
...
## <a name="string-interpolationintro-to-csharpinterpolated-stringsyml"></a>[문자열 보간](intro-to-csharp/interpolated-strings.yml)

[문자열 보간](intro-to-csharp/interpolated-strings.yml) 자습서에서는 문자열에 값을 삽입하는 방법을 보여 줍니다. 포함된 C# 식을 사용하여 보간된 문자열을 만드는 방법과 결과 문자열에서 식 결과의 텍스트 모양을 제어하는 방법을 설명합니다. 이 자습서는 [머신에서 로컬로 실행](intro-to-csharp/interpolated-strings-local.md)할 수도 있습니다.

## <a name="list-collectionintro-to-csharplist-collectionyml"></a>[목록 컬렉션](intro-to-csharp/list-collection.yml)
...
## <a name="introduction-to-c----work-locallyintro-to-csharplocal-environmentmd"></a>[C# 소개 - 로컬에서 작업](intro-to-csharp/local-environment.md)
