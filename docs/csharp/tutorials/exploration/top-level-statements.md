...
## <a name="build-a-magic-net-answer-machine"></a><span data-ttu-id="5177a-127">매직 .NET 응답 머신 빌드</span><span class="sxs-lookup"><span data-stu-id="5177a-127">Build a magic .NET answer machine</span></span>
