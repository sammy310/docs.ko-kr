...
## <a name="example"></a>예제  
 ...
 다음 예제에서는 .NET 5.0에 도입된 <xref:System.Convert.ToHexString%2A?displayProperty=nameWithType> 메서드를 호출하여 [byte](../../language-reference/builtin-types/integral-numeric-types.md) 배열을 16진수 문자열로 변환하는 방법을 보여 줍니다.
