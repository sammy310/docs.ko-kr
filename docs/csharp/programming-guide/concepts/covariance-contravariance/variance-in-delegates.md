...
### <a name="generic-delegates-that-have-variant-type-parameters-in-net"></a>.NET에 Variant 형식 매개 변수를 가지고 있는 제네릭 대리자
...
- [대리자를 결합하는 방법(멀티캐스트 대리자)](../../delegates/how-to-combine-delegates-multicast-delegates.md)
