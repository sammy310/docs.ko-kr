...
ms.locfileid: "66483799"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="02997-102">샘플 XML 파일: 네임스페이스의 Customers 및 Orders</span><span class="sxs-lookup"><span data-stu-id="02997-102">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="02997-103">다음 XML 파일은 [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] 설명서의 다양한 예제에서 사용됩니다.</span><span class="sxs-lookup"><span data-stu-id="02997-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="02997-104">이 파일에는 고객과 주문이 포함되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="02997-104">This file contains customers and orders.</span></span> <span data-ttu-id="02997-105">XML은 네임스페이스에 있습니다.</span><span class="sxs-lookup"><span data-stu-id="02997-105">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="02997-106">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="02997-106">CustomersOrdersInNamespace.xml</span></span>  
