---
title: LINQ 쿼리 소개(C#)
description: LINQ는 다양한 데이터 원본 및 형식의 데이터 쿼리에 대한 일관된 모델을 제공합니다. LINQ 쿼리에서는 항상 개체를 사용합니다.
ms.date: 07/20/2015
helpviewer_keywords:
