...
많은 파일 시스템 작업은 기본적으로 쿼리이므로 LINQ 접근 방식에 적합합니다.  
 ...
 [지정된 특성 또는 이름을 갖는 파일을 쿼리하는 방법(C#)](./how-to-query-for-files-with-a-specified-attribute-or-name.md)\
 ...
 [디렉터리 트리의 중복 파일을 쿼리하는 방법(LINQ)(C#)](./how-to-query-for-duplicate-files-in-a-directory-tree-linq.md)\
