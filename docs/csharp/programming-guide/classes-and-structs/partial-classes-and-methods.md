...
- 정의 및 구현된 부분 메서드(Partial Method)에 대한 [대리자](../../language-reference/builtin-types/reference-types.md)는 만들 수 있지만 정의만 된 부분 메서드(Partial Method)에 대한 대리자는 만들 수 없습니다.
