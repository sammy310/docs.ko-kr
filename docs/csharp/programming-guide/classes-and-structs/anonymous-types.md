...
```  
 ...
 일반적으로 무명 형식은 소스 시퀀스에 있는 각 개체의 속성 하위 집합을 반환하기 위해 쿼리 식의 [select](../../language-reference/keywords/select-clause.md) 절에 사용됩니다. 쿼리에 대한 자세한 내용은 [C#의 LINQ](../../linq/index.md)를 참조하세요.  
