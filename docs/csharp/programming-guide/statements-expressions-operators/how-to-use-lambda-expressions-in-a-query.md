...
## <a name="compiling-the-code"></a>코드 컴파일  
 이 코드를 실행하려면 메서드를 복사하고 `StudentClass`개체 컬렉션 쿼리[에 제공된 ](../../linq/query-a-collection-of-objects.md)에 붙여넣은 다음 `Main` 메서드에서 호출합니다.
