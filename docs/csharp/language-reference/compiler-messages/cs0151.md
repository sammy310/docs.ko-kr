...
[switch](../builtin-types/void.md) 일치 식에서 [void](../keywords/switch.md) 메서드 호출은 CS0151을 생성합니다. [int](../builtin-types/integral-numeric-types.md) 또는 [long](../builtin-types/integral-numeric-types.md)과 같은 정수 형식을 반환하는 메서드를 대신 호출하면 오류를 해결할 수 있습니다.
