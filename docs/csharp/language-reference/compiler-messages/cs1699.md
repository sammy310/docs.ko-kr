...
"attribute_name" 대신 "compiler_option" 명령줄 옵션 또는 적절한 프로젝트 설정을 사용하세요.  
 ...
 어셈블리에 서명하려면 키 파일을 지정해야 합니다. C# 2.0 이전에는 소스 코드의 CLR 특성을 사용하여 키 파일을 지정했습니다. 이러한 특성은 이제 사용되지 않습니다.  
  
 C# 2.0부터 키 파일을 지정하려면 어셈블리 링커 또는 **프로젝트 디자이너**의 **서명 페이지**를 사용해야 합니다.  
 ...
 **프로젝트 디자이너**의 **서명 페이지**가 기본 설정 방법입니다. 자세한 내용은 [프로젝트 디자이너, 서명 페이지](/visualstudio/ide/reference/signing-page-project-designer) 및 [어셈블리 및 매니페스트 서명 관리](/visualstudio/ide/managing-assembly-and-manifest-signing)를 참조하세요.  
 ...
 [방법: 강력한 이름으로 어셈블리 서명](../../../standard/assembly/sign-strong-name.md)에서는 다음 컴파일러 옵션을 사용합니다.  
  
- <xref:System.Reflection.AssemblyKeyFileAttribute> 특성 대신 [-keyfile(C# 컴파일러 옵션)](../compiler-options/keyfile-compiler-option.md) 사용  
  
- <xref:System.Reflection.AssemblyKeyNameAttribute> 대신 [-keycontainer(C# 컴파일러 옵션)](../compiler-options/keycontainer-compiler-option.md) 사용  
  
- <xref:System.Reflection.AssemblyDelaySignAttribute> 대신 [/delaysign(C# 컴파일러 옵션)](../compiler-options/delaysign-compiler-option.md) 사용  
