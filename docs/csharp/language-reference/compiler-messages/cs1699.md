...
- [ 특성 대신 ](../compiler-options/keyfile-compiler-option.md)-keyfile(C# 컴파일러 옵션)<xref:System.Reflection.AssemblyKeyFileAttribute> 사용  
  
- [ 대신 ](../compiler-options/keycontainer-compiler-option.md)-keycontainer(C# 컴파일러 옵션)<xref:System.Reflection.AssemblyKeyNameAttribute> 사용  
  
- [ 대신 ](../compiler-options/delaysign-compiler-option.md)delaysign(C# 컴파일러 옵션)<xref:System.Reflection.AssemblyDelaySignAttribute> 사용  
