...
- 형식 정의가 포함된 어셈블리가 컴파일에서 참조되지 않았습니다. [-reference(메타데이터 가져오기)](../../../csharp/language-reference/compiler-options/reference-compiler-option.md)를 사용하여 어셈블리를 지정합니다.  
  
- [typeof](../../../csharp/language-reference/operators/type-testing-and-conversion-operators.md#typeof-operator) 연산자에 변수 이름을 전달했습니다.  
