...
‘assembly’ 어셈블리에 서명하는 동안 암호화 오류 발생 — ‘reason’  
 ...
 자세한 내용은 [방법: 강력한 이름으로 어셈블리 서명](../../../framework/app-domains/how-to-sign-an-assembly-with-a-strong-name.md), [/keyfile(C# 컴파일러 옵션)](../compiler-options/keyfile-compiler-option.md) 및 [/delaysign(C# 컴파일러 옵션)](../compiler-options/delaysign-compiler-option.md)을 참조하세요.  
