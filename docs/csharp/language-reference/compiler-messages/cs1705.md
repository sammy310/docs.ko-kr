...
- 다음 명령으로 컴파일하여 CS1705d.cs에 DLL 버전 2.0에 대한 참조를 추가합니다.  
     ...
     이 명령을 사용할 때 프로그램이 컴파일되더라도 프로그램이 실행되지는 않습니다. 프로그램이 실행되게 하려면 [\<assemblyIdentity&gt;](../../../framework/configure-apps/file-schema/runtime/dependentassembly-element.md) 및 [\<codeBase&gt;](../../../framework/configure-apps/file-schema/runtime/assemblyidentity-element-for-runtime.md) 자식 요소를 사용하는 [\<dependentAssembly&gt; 요소](../../../framework/configure-apps/file-schema/runtime/codebase-element.md)를 포함하여 DLL 버전 1.0의 위치를 지정하는 애플리케이션 구성 파일을 제공합니다. 구성 파일에 대한 자세한 내용은 [앱 구성](../../../framework/configure-apps/index.md)을 참조하세요.  
