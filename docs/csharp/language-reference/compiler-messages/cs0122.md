...
보호 수준 때문에 ‘member’에 액세스할 수 없습니다.  
 ...
 이 오류의 원인 중 하나(아래 샘플에 표시되지 않음)는 friend 어셈블리의 대상에서 **/out** 컴파일러 플래그를 생략했기 때문일 수 있습니다. 자세한 내용은 [Friend 어셈블리](../../../standard/assembly/friend-assemblies.md) 및 [/out(C# 컴파일러 옵션)](../compiler-options/out-compiler-option.md)을 참조하세요.  
