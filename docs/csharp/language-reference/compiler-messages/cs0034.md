...
‘operator’ 연산자가 모호하여 ‘type1’ 및 ‘type2’ 형식의 피연산자에 사용할 수 없습니다.  
 ...
 두 개체에서 한 연산자가 사용되었으며, 컴파일러에서 둘 이상의 변환을 발견했습니다. 변환은 고유해야 하므로 캐스트를 수행하거나 변환 중 하나를 명시적으로 설정해야 합니다. 자세한 내용은 [사용자 정의 변환 연산자](../../../csharp/language-reference/operators/user-defined-conversion-operators.md)를 참조하세요.  
