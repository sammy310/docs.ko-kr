...
자세한 내용은 [C# 언어 사양](../language-specification/index.md)의 [switch 문](~/_csharplang/spec/statements.md#the-switch-statement)을 참조하세요. C# 언어 사양은 C# 구문 및 사용법에 대한 신뢰할 수 있는 소스입니다.
