...
모듈을 빌드하는 동안 'file' 리소스 파일을 링크할 수 없습니다.  
 ...
 [-linkresource](../language-reference/compiler-options/linkresource-compiler-option.md) 가 [/target: module](../language-reference/compiler-options/target-module-compiler-option.md)과 동일한 컴파일에서 사용 되었으며이는 허용 되지 않습니다. 예를 들어 다음 옵션은 CS1507을 생성하지 않습니다.  
