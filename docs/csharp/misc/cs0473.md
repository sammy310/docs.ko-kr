...
이 오류를 해결 하려면 명시적 구현을 제거 하 고 암시적 구현 `public int TestMethod(int)`에서 두 인터페이스 메서드를 모두 구현 합니다.
...
- [재미있는 코딩 탐험](https://blogs.msdn.microsoft.com/ericlippert/2006/04/06/odious-ambiguous-overloads-part-two/)
