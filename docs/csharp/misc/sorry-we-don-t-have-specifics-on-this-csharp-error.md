...
죄송 하지만이 오류에 대 한 특정 정보가 없습니다. 오류 번호와 메시지 텍스트를 검색하여 웹에서 정보를 찾을 수 있습니다. 또는 다음 중 하나를 사용 하 여 다른 개발자에 게 요청할 수 있습니다.
  
 [Msdn 포럼-Visual C #](https://social.msdn.microsoft.com/Forums/vstudio/home?forum=csharpgeneral)  
 다른 포럼에서 다루지 않는 Visual c # 관련 질문과 문제에 대 한 포럼을 제공 합니다.  
