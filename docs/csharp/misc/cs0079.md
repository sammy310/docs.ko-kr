...
'event' 이벤트는 += 또는 -=의 왼쪽에만 올 수 있습니다.  
 ...
 [이벤트](../../csharp/language-reference/keywords/event.md) 를 잘못 호출했습니다. 자세한 내용은 [이벤트](../../csharp/programming-guide/events/index.md) 하 고 [대리자](../../csharp/programming-guide/delegates/index.md)합니다.  
