...
as 연산자는 참조 형식 또는 nullable 형식과 함께 사용해야 합니다. 'int'는 null을 허용하지 않는 값 형식입니다.  
 ...
 [as](../language-reference/operators/type-testing-and-cast.md#as-operator) 연산자가 [값 형식](../language-reference/keywords/value-types.md)으로 전달되었습니다. `as` 는 [null](../language-reference/keywords/null.md)을 반환할 수 있기 때문에 [참조 형식](../language-reference/keywords/reference-types.md) 또는 nullable 형식만 전달할 수 있습니다. Nullable 형식에 대 한 자세한 내용은 [Nullable 형식](../programming-guide/nullable-types/index.md)을 참조 하세요.  
