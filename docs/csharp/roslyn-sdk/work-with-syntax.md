...
각 노드에는 <xref:Microsoft.CodeAnalysis.Text.TextSpan> 및 <xref:Microsoft.CodeAnalysis.SyntaxNode.Span%2A>이라는 두 가지 <xref:Microsoft.CodeAnalysis.SyntaxNode.FullSpan%2A> 속성이 있습니다.
