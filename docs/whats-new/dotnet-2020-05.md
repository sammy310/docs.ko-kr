...
5 월 2020에 대 한 .NET 문서의 새로운 기능에 오신 것을 환영 합니다. 해당 기간 동안 이루어진 문서의 주요 변경 사항을 소개합니다.
...
- CentOS 8 패키지 관리자-.NET Core 설치-CentOS 8에 대 한 설치 지침 추가
- Fedora 32 패키지 관리자 - .NET Core 설치
...
- [방법: 응용 프로그램 지역화](/dotnet/desktop/wpf/advanced/how-to-localize-an-application) -기타 수정
...
: octocat: .NET 문서에 참여 하 시겠습니까? [기여자 가이드](/contribute/dotnet/dotnet-contribute)를 참조하세요.
