...
- [문자열에서 요소 추출](../standard/base-types/parse-strings.md) -대체 대체 (reference) `String.Split`
...
- [SYSLIB0004: 제약이 있는 실행 영역 (CER) 기능은 지원 되지 않음](../core/compatibility/syslib0004.md) -해결 방법이 있는 SYSLIB0004 문서 업데이트
