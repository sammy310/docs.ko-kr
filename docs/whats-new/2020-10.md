...
- [SYSLIB0001: utf-7 인코딩은 안전 하지 않습니다](../core/compatibility/syslib0001.md) -SYSLIB reference
- [SYSLIB0002: PrincipalPermissionAttribute는 사용 되지 않음](../core/compatibility/syslib0002.md) -SYSLIB reference
- [SYSLIB0003: 코드 액세스 보안이 지원 되지 않음](../core/compatibility/syslib0003.md) -SYSLIB reference
- [SYSLIB0004: CER(제약이 있는 실행 영역) 기능이 지원되지 않음](../core/compatibility/syslib0004.md)
  - 해결 방법으로 syslib0004 문서 업데이트
  - SYSLIB 참조
- [SYSLIB0005: GAC (전역 어셈블리 캐시)는 지원 되지 않습니다.](../core/compatibility/syslib0005.md) -SYSLIB reference
- [SYSLIB0006: Thread. Abort는 지원 되지 않습니다.](../core/compatibility/syslib0006.md) -SYSLIB reference
- [SYSLIB0007: 암호화 알고리즘의 기본 구현이 지원 되지 않음](../core/compatibility/syslib0007.md) -SYSLIB reference
- [SYSLIB0008: CreatePdbGenerator는 지원 되지 않습니다.](../core/compatibility/syslib0008.md) -SYSLIB reference
- [SYSLIB0009: AuthenticationManager authentication 및 PreAuthenticate 메서드는 지원 되지 않습니다.](../core/compatibility/syslib0009.md) -SYSLIB reference
- [SYSLIB0010: 지원 되지 않는 원격 api](../core/compatibility/syslib0010.md) -SYSLIB reference
- [SYSLIB0011: BinaryFormatter 직렬화는 사용 되지 않습니다.](../core/compatibility/syslib0011.md) SYSLIB reference
- [SYSLIB0012: EscapedCodeBase 및 assembly.](../core/compatibility/syslib0012.md) SYSLIB reference
...
- [패턴 일치를 사용 하 여 ' is ' 검사 다음에 캐스트 (IDE0020)](../fundamentals/code-analysis/style-rules/ide0020.md) -포트에서 문서화 된 나머지 c # 코드 스타일 규칙을 새 형식으로 유지 합니다.
...
- [병합 식 사용 (IDE0029)](../fundamentals/code-analysis/style-rules/ide0029.md) -몇 가지 코드 스타일 규칙을 사용 하 여 문서 분리
...
- [복합 할당 (IDE0054)을 사용 하 여](../fundamentals/code-analysis/style-rules/ide0054.md) 문서를 구분 하는 몇 가지 코드 스타일 규칙 리팩터링
