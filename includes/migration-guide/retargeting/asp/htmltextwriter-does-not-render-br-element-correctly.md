...
|   |   |
|---|---|
|세부 정보|.NET Framework 4.6부터 <xref:System.Web.UI.HtmlTextWriter.RenderBeginTag(System.String)> 요소로 <xref:System.Web.UI.HtmlTextWriter.RenderEndTag> 및 <code>&lt;BR /&gt;</code>를 호출하면 (두 개가 아닌) 단 하나의 <code>&lt;BR /&gt;</code>만 올바르게 삽입합니다.|
