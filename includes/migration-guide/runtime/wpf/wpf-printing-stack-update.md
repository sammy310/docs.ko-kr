...
|제안 해결 방법|Windows 10 크리에이터스 업데이트에서 이전 스택을 사용하려면 <code>UseXpsOMPrinting</code> 레지스트리 키의 <code>HKEY_CURRENT_USER\Software\Microsoft\.NETFramework\Windows Presentation Foundation\Printing</code> REG_DWORD 값을 <code>1</code>로 설정합니다.|
|범위|가장자리|
|Version|4.7|
|형식|런타임|
